...
function EnumValuesEditor(props) {
    function renderItem(enumValue, index, onEnumValueChange) {
        return React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 2fr" } },
            React.createElement(bootstrap_1.TextInput, { value: enumValue.id, onChange: id => { onEnumValueChange({ ...enumValue, id: id || "" }); } }),
            React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: enumValue.name, onChange: name => { onEnumValueChange({ ...enumValue, name: name }); }, locale: "en" }));
    }
