    ...
    WidgetEditor.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Variables", hint: "Define data sources (rowsets or rows)" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.props.widgetDef, onChange: this.props.onWidgetDefChange, property: "privateContextVars" }, function (value, onChange) { return React.createElement(ContextVarsEditor, { contextVars: value || [], onChange: onChange, contextVarValues: _this.props.widgetDef.privateContextVarValues || {}, onContextVarValuesChange: _this.handlePrivateContextVarValuesChange, schema: _this.props.designCtx.schema, dataSource: _this.props.designCtx.dataSource }); })),
            React.createElement(propertyEditors_1.LabeledProperty, { label: "External Variables", hint: "These are passed in to the widget from its parent. Values for preview only" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.props.widgetDef, onChange: this.props.onWidgetDefChange, property: "contextVars" }, function (value, onChange) { return React.createElement(ContextVarsEditor, { contextVars: value, onChange: onChange, contextVarValues: _this.props.widgetDef.contextVarPreviewValues, onContextVarValuesChange: _this.handleContextVarPreviewValues, schema: _this.props.designCtx.schema, dataSource: _this.props.designCtx.dataSource }); })),
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Global Variables", hint: "Values for preview only" }, (this.props.designCtx.globalContextVars || []).map(function (contextVar) {
                return React.createElement("div", { key: contextVar.id, style: { paddingBottom: 10 } },
                    React.createElement("div", null,
                        contextVar.name,
                        ":"),
                    React.createElement(ContextVarValueEditor, { contextVar: contextVar, contextVarValues: _this.props.widgetDef.contextVarPreviewValues, onContextVarValuesChange: _this.handleContextVarPreviewValues, schema: _this.props.designCtx.schema, dataSource: _this.props.designCtx.dataSource }));
            })),
...
var ContextVarsEditor = function (props) {
    ...
    return (React.createElement("div", null,
        React.createElement(ListEditor_1.default, { items: props.contextVars, onItemsChange: props.onChange }, function (contextVar, onContextVarChange) { return (React.createElement("div", null,
            ...
            React.createElement(ContextVarValueEditor, { contextVar: contextVar, contextVarValues: props.contextVarValues, onContextVarValuesChange: props.onContextVarValuesChange, schema: props.schema, dataSource: props.dataSource }))); }),
