...
var WidgetEditor = /** @class */ (function (_super) {
    ...
    WidgetEditor.prototype.render = function () {
        ...
        var allContextVars = this.props.widgetDef.contextVars.concat(this.props.designCtx.globalContextVars || []);
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Variables" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.props.widgetDef, onChange: this.props.onWidgetDefChange, property: "contextVars" }, function (value, onChange) { return React.createElement(ContextVarsEditor, { contextVars: value, onChange: onChange, schema: _this.props.designCtx.schema }); })),
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Preview Variable Values" }, allContextVars.map(function (contextVar) {
                return React.createElement(ContextVarPreviewValue, { key: contextVar.id, contextVar: contextVar, widgetDef: _this.props.widgetDef, schema: _this.props.designCtx.schema, dataSource: _this.props.designCtx.dataSource, onWidgetDefChange: _this.props.onWidgetDefChange });
            })),
...
var ContextVarPreviewValue = /** @class */ (function (_super) {
    ...
    ContextVarPreviewValue.prototype.renderValue = function (value) {
        ...
        if (this.props.contextVar.type == "enum") {
            return React.createElement(bootstrap_1.Select, { value: value, onChange: this.handleChange, options: this.props.contextVar.enumValues.map(function (ev) { return ({ value: ev.id, label: localization_1.localize(ev.name) }); }) });
        }
