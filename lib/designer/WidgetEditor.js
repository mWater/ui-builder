...
class WidgetEditor extends React.Component {
    ...
    render() {
        ...
        const validationError = (0, widgets_1.validateWidget)(this.props.widgetDef, this.props.designCtx, false);
        return (React.createElement("div", null,
            validationError ? (React.createElement("div", { className: "text-danger" },
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Margins", hint: "Use to remove all margins from control for TOC or dashboard" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.props.widgetDef, onChange: this.props.onWidgetDefChange, property: "pageMargins" }, (value, onChange) => (React.createElement(bootstrap_1.Toggle, { value: value || "normal", onChange: onChange, size: "sm", options: [
                        { value: "normal", label: "Normal" },
                        { value: "none", label: "None" }
                    ] })))),
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Page Title", hint: "Deprecated: Prefer Page Header widget instead.", help: "If present, will add a title at top with a back button if applicable. Can be overridden with open page action." },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.props.widgetDef, onChange: this.props.onWidgetDefChange, property: "title" }, (value, onChange) => (React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: this.props.designCtx.locale })))),
            this.props.widgetDef.title &&
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Page Title embedded expressions", help: "Reference in text as {0}, {1}, etc." },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.props.widgetDef, onChange: this.props.onWidgetDefChange, property: "titleEmbeddedExprs" }, (value, onChange) => (React.createElement(propertyEditors_1.EmbeddedExprsEditor, { value: value, onChange: onChange, schema: this.props.designCtx.schema, dataSource: this.props.designCtx.dataSource, contextVars: allContextVars })))),
            React.createElement(propertyEditors_1.PropertyEditor, { obj: this.props.widgetDef, onChange: this.props.onWidgetDefChange, property: "deprecated" }, (value, onChange) => (React.createElement(bootstrap_1.Checkbox, { value: value || false, onChange: onChange }, "Deprecated"))),
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Widget ID", hint: "Advanced" },
                React.createElement("input", { type: "text", value: this.props.widgetDef.id, className: "form-control form-control-sm", onFocus: ev => { ev.target.select(); } }))));
    }
}
    ...
    const renderItem = (contextVar) => {
        ...
        if (contextVar.table) {
            ...
            desc += props.schema.getTable(contextVar.table)
                ? (0, localization_1.localize)(props.schema.getTable(contextVar.table).name, "en")
                : contextVar.table;
        }
        return (React.createElement("div", null,
            React.createElement("div", null,
    ...
    return (React.createElement("div", { style: { paddingBottom: 200 } },
        ...
        React.createElement(propertyEditors_1.LabeledProperty, { label: "Type" },
            React.createElement(propertyEditors_1.PropertyEditor, { obj: props.contextVar, property: "type", onChange: props.onContextVarChange }, (value, onChange) => (React.createElement("div", null,
                ...
                value && value != "row" && value != "rowset" ? (React.createElement("div", { style: { padding: 5 } },
                    React.createElement(bootstrap_1.Select, { value: value, onChange: onChange, options: advancedTypeOptions }))) : null)))),
        props.contextVar.type == "enum" || props.contextVar.type == "enumset" ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Enum Options" },
            React.createElement(propertyEditors_1.PropertyEditor, { obj: props.contextVar, property: "enumValues", onChange: props.onContextVarChange }, (value, onChange) => React.createElement(EnumValuesEditor, { enumValues: value, onChange: onChange })))) : null,
        props.contextVar.type == "id" || props.contextVar.type == "id[]" ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Referenced Table" },
            React.createElement(propertyEditors_1.PropertyEditor, { obj: props.contextVar, property: "idTable", onChange: props.onContextVarChange }, (value, onChange) => (React.createElement(propertyEditors_1.TableSelect, { schema: props.schema, value: value || null, onChange: (t) => onChange(t || undefined), locale: props.locale }))))) : null,
...
function EnumValuesEditor(props) {
    function renderItem(enumValue, index, onEnumValueChange) {
        return (React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 2fr" } },
            React.createElement(bootstrap_1.TextInput, { value: enumValue.id, onChange: (id) => {
                    onEnumValueChange(Object.assign(Object.assign({}, enumValue), { id: id || "" }));
                } }),
            React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: enumValue.name, onChange: (name) => {
                    onEnumValueChange(Object.assign(Object.assign({}, enumValue), { name: name }));
                }, locale: "en" })));
    }
