...
var WidgetEditor = /** @class */ (function (_super) {
    ...
    WidgetEditor.prototype.render = function () {
        ...
        var allContextVars = (this.props.designCtx.globalContextVars || []).concat(this.props.widgetDef.contextVars);
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Preview Variable Values" }, allContextVars.map(function (contextVar) {
                return React.createElement("div", { style: { paddingBottom: 5 }, key: contextVar.id },
                    React.createElement(ContextVarPreviewValue, { key: contextVar.id, contextVar: contextVar, widgetDef: _this.props.widgetDef, schema: _this.props.designCtx.schema, dataSource: _this.props.designCtx.dataSource, onWidgetDefChange: _this.props.onWidgetDefChange }));
            })),
