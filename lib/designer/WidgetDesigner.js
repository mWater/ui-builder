    ...
    constructor(props) {
        ...
        this.handleSetMode = (mode) => {
            ...
            if (mode === Mode.Preview) {
                ...
                for (const childBlock of (0, blocks_1.getBlockTree)(this.props.widgetDef.blockDef, this.props.baseCtx.createBlock, contextVars)) {
    ...
    renderEditor() {
        if (this.props.widgetDef.blockDef && this.state.selectedBlockId) {
            ...
            const contextVars = (this.props.baseCtx.globalContextVars || [])
                .concat(this.props.widgetDef.contextVars)
                .concat(this.props.widgetDef.privateContextVars || []);
            const selectedBlockAncestry = (0, blocks_1.findBlockAncestry)(this.props.widgetDef.blockDef, this.props.baseCtx.createBlock, contextVars, this.state.selectedBlockId);
            // Create props
