...
var WidgetDesigner = /** @class */ (function (_super) {
    ...
    function WidgetDesigner(props) {
        ...
        _this.handleBlockDefChange = function (blockDef) {
            ...
            blockDef = _this.canonicalize(blockDef);
    ...
    WidgetDesigner.prototype.canonicalize = function (blockDef) {
        var _this = this;
        // Canonicalize
        if (blockDef) {
            // Processes entire tree, canonicalizing it
            return this.props.baseCtx.createBlock(blockDef).process(this.props.baseCtx.createBlock, function (b) {
    ...
    WidgetDesigner.prototype.renderPreview = function () {
        ...
        var contextVarValues = this.props.widgetDef.contextVarPreviewValues;
    ...
    WidgetDesigner.prototype.render = function () {
        var _this = this;
        // Check if canonical
        var canonilizedBlockDef = this.canonicalize(this.props.widgetDef.blockDef);
        if (!lodash_1.default.isEqual(canonilizedBlockDef, this.props.widgetDef.blockDef)) {
            // Is not canonical. Defer update (since we can't call directly in render)
            // and return null
            setTimeout(function () {
                _this.handleBlockDefChange(canonilizedBlockDef);
            });
            return null;
        }
