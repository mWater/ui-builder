...
class WidgetDesigner extends React.Component {
    constructor(props) {
        ...
        this.handleSetMode = (mode) => {
            ...
            if (mode === Mode.Preview) {
                for (const childBlock of blocks_1.getBlockTree(this.props.widgetDef.blockDef, this.props.createBlock, this.props.widgetDef.contextVars)) {
    ...
    renderEditor() {
        if (this.props.widgetDef.blockDef && this.state.selectedBlockId) {
            ...
            const selectedBlockAncestry = blocks_1.findBlockAncestry(this.props.widgetDef.blockDef, this.props.createBlock, contextVars, this.state.selectedBlockId);
            // Create props
    ...
    renderPreview() {
        ...
        const pageElem = React.createElement(PageStackDisplay_1.PageStackDisplay, { initialPage: page, locale: "en", schema: this.props.schema, dataSource: this.props.dataSource, createBlock: this.props.createBlock, actionLibrary: this.props.actionLibrary, widgetLibrary: this.props.widgetLibrary });
        return [
