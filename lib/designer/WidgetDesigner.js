...
var WidgetDesigner = /** @class */ (function (_super) {
    ...
    function WidgetDesigner(props) {
        ...
        _this.handleSetMode = function (mode) {
            ...
            if (mode === Mode.Preview) {
                for (var _i = 0, _a = blocks_1.getBlockTree(_this.props.widgetDef.blockDef, _this.props.baseCtx.createBlock, _this.props.widgetDef.contextVars); _i < _a.length; _i++) {
    ...
    WidgetDesigner.prototype.createDesignCtx = function () {
        ...
        var designCtx = __assign(__assign({}, this.props.baseCtx), { dataSource: this.props.dataSource, selectedId: this.state.selectedBlockId, contextVars: this.props.widgetDef.contextVars, store: store, blockPaletteEntries: this.props.blockPaletteEntries, 
            // Will be set below
            renderChildBlock: {} });
