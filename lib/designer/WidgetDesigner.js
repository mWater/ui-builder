...
class WidgetDesigner extends React.Component {
    constructor(props) {
        ...
        this.handleUndo = () => {
            ...
            this.setState({
                undoStack: lodash_1.default.initial(this.state.undoStack),
        ...
        this.handleRedo = () => {
            ...
            this.setState({
                redoStack: lodash_1.default.initial(this.state.redoStack),
        ...
        this.handleBlockDefChange = (blockDef) => {
            ...
            this.handleWidgetDefChange(Object.assign(Object.assign({}, this.props.widgetDef), { blockDef }));
        };
        this.handleUnselect = () => {
        ...
        this.handleSetMode = (mode) => {
            ...
            if (mode === Mode.Preview) {
                ...
                for (const childBlock of (0, blocks_1.getBlockTree)(this.props.widgetDef.blockDef, this.props.baseCtx.createBlock, contextVars, this.props.baseCtx.schema)) {
                    const block = this.props.baseCtx.createBlock(childBlock.blockDef);
                    // Use context vars for the block
                    const designCtx = Object.assign(Object.assign({}, this.createDesignCtx()), { contextVars: childBlock.contextVars });
    ...
    createBlockStore() {
        const alterBlock = (blockId, action, removeBlockId) => {
            ...
            newBlockDef = this.props.baseCtx
                ...
                .process(this.props.baseCtx.createBlock, (b) => (b.id === blockId ? action(b) : b));
    ...
    createDesignCtx() {
        ...
        const widgetContextVars = (this.props.baseCtx.globalContextVars || [])
            .concat(this.props.widgetDef.contextVars)
            .concat(this.props.widgetDef.privateContextVars || []);
        const designCtx = Object.assign(Object.assign({}, this.props.baseCtx), { dataSource: this.props.dataSource, selectedId: this.state.selectedBlockId, contextVars: widgetContextVars, store, blockPaletteEntries: this.props.blockPaletteEntries, 
            // Will be set below
            renderChildBlock: {} });
    ...
    renderEditor() {
        if (this.props.widgetDef.blockDef && this.state.selectedBlockId) {
            ...
            const contextVars = (this.props.baseCtx.globalContextVars || [])
                .concat(this.props.widgetDef.contextVars)
                .concat(this.props.widgetDef.privateContextVars || []);
            const selectedBlockAncestry = (0, blocks_1.findBlockAncestry)(this.props.widgetDef.blockDef, this.props.baseCtx.createBlock, contextVars, this.state.selectedBlockId, this.props.baseCtx.schema);
            // Create props
            if (selectedBlockAncestry) {
                ...
                const designCtx = Object.assign(Object.assign({}, this.createDesignCtx()), { contextVars: selectedChildBlock.contextVars });
                // Check for errors
    ...
    renderPreview() {
        ...
        const pageElem = (React.createElement(PageStackDisplay_1.PageStackDisplay, { baseCtx: Object.assign(Object.assign({}, this.props.baseCtx), { locale: this.state.locale }), initialPage: page }));
        return [
    ...
    renderPreviewLocale() {
        ...
        return (React.createElement("div", { style: { display: "inline-block", marginRight: 10 } },
            React.createElement(bootstrap_1.Select, { options: options, value: this.state.locale, onChange: (locale) => this.setState({ locale: locale }), inline: true, size: "sm" })));
    }
    render() {
        // Check if canonical
        const canonilizedBlockDef = this.canonicalize(this.props.widgetDef.blockDef);
        if ((0, canonical_json_1.default)(canonilizedBlockDef) != (0, canonical_json_1.default)(this.props.widgetDef.blockDef)) {
        ...
        return (React.createElement("div", { className: "widget-designer" },
            React.createElement("div", { className: "widget-designer-header" },
                this.state.mode == Mode.Design ? React.createElement(AddWizardPalette_1.default, { onSelect: this.handleSelect }) : null,
                React.createElement("div", { style: { float: "right" } },
                    this.state.mode == Mode.Design ? (React.createElement(ClipboardPalette_1.default, { onSelect: this.handleSelect, createBlock: this.props.baseCtx.createBlock })) : null,
                    this.state.mode == Mode.Design ? (React.createElement("button", { type: "button", className: "btn btn-link btn-sm", onClick: this.handleUndo, disabled: this.state.undoStack.length === 0 },
                        React.createElement("i", { className: "fa fa-undo" }),
                        " Undo")) : null,
                    this.state.mode == Mode.Design ? (React.createElement("button", { type: "button", className: "btn btn-link btn-sm", onClick: this.handleRedo, disabled: this.state.redoStack.length === 0 },
