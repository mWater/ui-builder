...
let WidgetDesigner = class WidgetDesigner extends React.Component {
    ...
    renderPalette() {
        return React.createElement(BlockPalette, { key: "palette", createBlock: this.props.createBlock, schema: this.props.schema, dataSource: this.props.dataSource });
    }
    renderDesignBlock() {
    ...
    renderPreview() {
        ...
        const pageElem = React.createElement(PageStackDisplay, { initialPage: page, locale: "en", schema: this.props.schema, createBlock: this.props.createBlock, actionLibrary: this.props.actionLibrary, widgetLibrary: this.props.widgetLibrary });
        return [
