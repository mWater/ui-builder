...
var WidgetDesigner = /** @class */ (function (_super) {
    ...
    function WidgetDesigner(props) {
        ...
        _this.handleSetMode = function (mode) {
            ...
            if (mode === Mode.Preview) {
                var contextVars = (_this.props.baseCtx.globalContextVars || []).concat(_this.props.widgetDef.contextVars);
    ...
    WidgetDesigner.prototype.createDesignCtx = function () {
        ...
        var designCtx = __assign(__assign({}, this.props.baseCtx), { dataSource: this.props.dataSource, selectedId: this.state.selectedBlockId, contextVars: (this.props.baseCtx.globalContextVars || []).concat(this.props.widgetDef.contextVars), store: store, blockPaletteEntries: this.props.blockPaletteEntries, 
            // Will be set below
            renderChildBlock: {} });
    ...
    WidgetDesigner.prototype.renderEditor = function () {
        if (this.props.widgetDef.blockDef && this.state.selectedBlockId) {
            ...
            var contextVars = (this.props.baseCtx.globalContextVars || []).concat(this.props.widgetDef.contextVars);
