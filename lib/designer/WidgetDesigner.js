...
export default class WidgetDesigner extends React.Component {
    constructor(props) {
        super(props);
    ...
    renderPreview() {
        ...
        let database = new DataSourceDatabase(this.props.schema, this.props.dataSource);
    ...
    render() {
        return (React.createElement(FillDownwardComponent, null,
