...
exports.defaultBlockPaletteEntries = [
    ...
    {
        title: "Tabbed",
        blockDef: { id: "", type: "tabbed", tabs: [{ id: (0, v4_1.default)(), label: { _base: "en", en: "Tab1" }, content: null }] }
    },
    {
        title: "Static Image",
    ...
    {
        title: "Tags Editor",
        blockDef: { id: "", type: "tagsEditor", rowContextVarId: null, column: null, required: false },
