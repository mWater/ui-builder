...
exports.NewTab = (props) => {
    ...
    const [collapsedGroups, setCollapsedGroups] = react_1.useState(JSON.parse(window.localStorage.getItem("UIBuilder.collapsedWidgetGroups") || "[]"));
    ...
    // Focus on load
    const searchControl = react_1.useRef(null);
    react_1.useEffect(() => {
    ...
    function renderWidgetGroupHeader(group) {
        return react_2.default.createElement("h4", { style: { cursor: "pointer" }, onClick: () => toggleGroup(group) },
    ...
    function renderWidgetGroup(group, widgets, hasGroups) {
        return (react_2.default.createElement("div", null,
            ...
            !collapsedGroups.includes(group) ?
                react_2.default.createElement("ul", { className: "list-group" }, widgets.map(widget => (react_2.default.createElement("li", { className: "list-group-item", style: { cursor: "pointer" }, key: widget.id, onClick: props.onOpenWidget.bind(null, widget.id) },
