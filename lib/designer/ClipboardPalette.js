...
const blockSourceSpec = {
    ...
    beginDrag: (props) => {
        return {
            blockDef: (0, blocks_1.duplicateBlockDef)(clipboardContents, props.createBlock)
        };
    },
...
exports.default = (0, react_dnd_1.DragSource)("ui-builder-block", blockSourceSpec, collect)(dropTarget);
