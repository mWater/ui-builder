...
class WidgetLibraryDesigner extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleTabChange = (widgetId, widgetDef) => {
            this.props.onWidgetLibraryChange(immer_1.default(this.props.baseCtx.widgetLibrary, (draft) => {
        ...
        this.handleAddWidget = (widgetDef) => {
            const widgetLibrary = immer_1.default(this.props.baseCtx.widgetLibrary, (draft) => {
        ...
        this.validateSingleWidget = (widgetDef) => {
            return widgets_1.validateWidget(widgetDef, this.props.baseCtx, true);
        };
        this.state = {
            activeTabIndex: 0
        };
