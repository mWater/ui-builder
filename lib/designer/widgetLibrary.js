...
class WidgetLibraryDesigner extends react_1.default.Component {
    ...
    renderTab(index) {
        ...
        return (react_1.default.createElement("li", { className: "nav-item", key: index },
            react_1.default.createElement("a", { className: index === this.state.activeTabIndex ? "nav-link active" : "nav-link", onClick: this.handleSelectTab.bind(null, index) },
                widgetDef.name,
                "\u00A0",
    ...
    render() {
        return (react_1.default.createElement("div", { style: { height: "100%", display: "grid", gridTemplateRows: "auto 1fr" } },
            react_1.default.createElement("ul", { className: "nav nav-tabs", style: { marginBottom: 5 } },
                ...
                react_1.default.createElement("li", { className: "nav-item", key: "new" },
                    react_1.default.createElement("a", { className: this.state.activeTabIndex >= this.props.openTabs.length ? "nav-link active" : "nav-link", onClick: this.handleSelectTab.bind(null, this.props.openTabs.length) },
