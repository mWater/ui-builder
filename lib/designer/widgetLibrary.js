...
var WidgetLibraryDesigner = /** @class */ (function (_super) {
    ...
    function WidgetLibraryDesigner(props) {
        ...
        _this.handleRemoveWidget = function (widgetId) {
            var widget = _this.props.widgetLibrary.widgets[widgetId];
        ...
        _this.validateWidget = function (widgetDef) {
            ...
            for (var _i = 0, _a = blocks_1.getBlockTree(widgetDef.blockDef, _this.props.blockFactory.createBlock, widgetDef.contextVars); _i < _a.length; _i++) {
                var childBlock = _a[_i];
                var block = _this.props.blockFactory.createBlock(childBlock.blockDef);
                var error = block.validate({
    ...
    WidgetLibraryDesigner.prototype.renderActiveTabContents = function () {
        if (this.state.activeTabIndex < this.props.openTabs.length) {
            ...
            return React.createElement(NewTab_1.NewTab, { widgetLibrary: this.props.widgetLibrary, onAddWidget: this.handleAddWidget, onOpenWidget: this.handleOpenWidget, onRemoveWidget: this.handleRemoveWidget, onDuplicateWidget: this.handleDuplicateWidget, validateWidget: this.validateWidget });
        }
    };
