...
class WidgetLibraryDesigner extends React.Component {
    constructor(props) {
        super(props);
        this.handleTabChange = (widgetId, widgetDef) => {
            this.props.onWidgetLibraryChange(immer_1.default(this.props.widgetLibrary, (draft) => {
        ...
        this.handleAddWidget = (widgetDef) => {
            const widgetLibrary = immer_1.default(this.props.widgetLibrary, (draft) => {
