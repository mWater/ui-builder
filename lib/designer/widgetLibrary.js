...
var WidgetLibraryDesigner = /** @class */ (function (_super) {
    ...
    function WidgetLibraryDesigner(props) {
        ...
        _this.validateWidget = function (widgetDef) {
            ...
            for (var _i = 0, _a = blocks_1.getBlockTree(widgetDef.blockDef, _this.props.baseCtx.createBlock, widgetDef.contextVars.concat(_this.props.baseCtx.globalContextVars || [])); _i < _a.length; _i++) {
