...
export default class BlockPalette extends React.Component {
    render() {
        ...
        return (React.createElement("div", { className: "widget-designer-palette" }, items.map((item, index) => React.createElement(BlockPaletteItem, { key: index, title: item.title, blockDef: item.blockDef, createBlock: this.props.createBlock, schema: this.props.schema, dataSource: this.props.dataSource }))));
    }
}
