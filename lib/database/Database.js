...
function performEvalQuery(options) {
    return __awaiter(this, void 0, void 0, function () {
        var query, evalRows, exprEval, exprUtils, tempRows, wherePromises, whereValues_1, selects, orderBys, _i, tempRows_1, tempRow, i, i, _a, tempRows_2, tempRow, i, _b, _c, i, _d, _e, groups, _f, _g, group, tempRow, i, i, _h, _j, group, tempRow, i, _k, _l, i, _m, _o, _loop_1, i, projectedRows, _p, tempRows_3, tempRow, projectedRow, i;
        return __generator(this, function (_q) {
            switch (_q.label) {
                case 0:
                    ...
                    wherePromises = tempRows.map(function (tempRow) { return exprEval.evaluate(query.where, { row: tempRow.row, rows: tempRows.map(function (tr) { return tr.row; }) }); });
                ...
                case 2:
                    ...
                    for (_i = 0, tempRows_1 = tempRows; _i < tempRows_1.length; _i++) {
                        ...
                        for (i = 0; i < selects.length; i++) {
                            if (!selects[i].isAggr) {
                                tempRow["s" + i] = exprEval.evaluate(selects[i].expr, { row: tempRow.row, rows: tempRows.map(function (tr) { return tr.row; }) });
                            }
                        }
                        for (i = 0; i < orderBys.length; i++) {
                            if (!orderBys[i].isAggr) {
                                tempRow["o" + i] = exprEval.evaluate(orderBys[i].expr, { row: tempRow.row, rows: tempRows.map(function (tr) { return tr.row; }) });
                            }
                        }
                    }
