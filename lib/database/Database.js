...
exports.useDatabaseChangeListener = exports.stableSort = exports.isQueryAggregate = exports.getWherePrimaryKey = exports.performEvalQuery = exports.NullDatabase = void 0;
...
function performEvalQuery(options) {
    return __awaiter(this, void 0, void 0, function () {
        var query, evalRows, exprEval, exprUtils, tempRows, contextRows_1, wherePromises, whereValues_1, selects, orderBys, contextRows, _i, tempRows_1, tempRow, i, i, _a, tempRows_2, tempRow, i, _b, _c, i, _d, _e, groups, _f, _g, group, tempRow, i, i, _h, _j, group, tempRow, i, _k, _l, i, _m, _o, tempRow, i, _p, _q, i, _r, _s, _loop_1, i, projectedRows, _t, tempRows_3, tempRow, projectedRow, i;
        return __generator(this, function (_u) {
            switch (_u.label) {
                ...
                case 22:
                    ...
                    _u.label = 23;
                case 23:
                    if (!(selects.every(function (s) { return s.isAggr; }) && orderBys.every(function (o) { return o.isAggr; }) && tempRows.length == 0)) return [3 /*break*/, 32];
                    tempRow = {};
                    i = 0;
                    _u.label = 24;
                case 24:
                    if (!(i < selects.length)) return [3 /*break*/, 27];
                    _p = tempRow;
                    _q = "s" + i;
                    return [4 /*yield*/, exprEval.evaluate(selects[i].expr, { rows: [] })];
                case 25:
                    _p[_q] = _u.sent();
                    _u.label = 26;
                case 26:
                ...
                case 27:
                    ...
                    _u.label = 28;
                case 28:
                    if (!(i < orderBys.length)) return [3 /*break*/, 31];
                    _r = tempRow;
                    _s = "o" + i;
                    return [4 /*yield*/, exprEval.evaluate(orderBys[i].expr, { rows: [] })];
                case 29:
                    _r[_s] = _u.sent();
                    _u.label = 30;
                case 30:
                ...
                case 32:
                    ...
                    projectedRows = [];
                    for (_t = 0, tempRows_3 = tempRows; _t < tempRows_3.length; _t++) {
                        tempRow = tempRows_3[_t];
                        projectedRow = {};
                        // Project each one
                        for (i = 0; i < selects.length; i++) {
...
function useDatabaseChangeListener(database) {
    var _a = react_1.useState(0), incr = _a[0], setIncr = _a[1];
    var listener = react_1.useCallback(function () {
        setIncr(function (cur) { return cur + 1; });
    }, []);
