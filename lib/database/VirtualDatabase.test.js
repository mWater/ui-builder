...
test("shouldIncludeColumn includes regular columns and joins without inverse", () => {
    ...
    expect(vdb.shouldIncludeColumn({
        id: "text",
        type: "text",
        name: { _base: "en" },
...
describe("select, order, limit", () => {
    ...
    test("id join", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const rows = yield performQuery({ t1: [{ id: "a", text: "a", number: 1 }], t2: [{ id: 1, text: "a", number: 1, id1: "a" }] }, qopts);
    ...
    test("n-1 scalar", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const rows = yield performQuery({ t1: [{ id: 1, text: "abc" }], t2: [{ id: 101, id1: 1 }] }, qopts);
        expect(rows).toEqual([{ x: "abc" }]);
    }));
    ...
    describe("transactions", () => {
        ...
        test("reorders in case of wrong topological order", () => __awaiter(void 0, void 0, void 0, function* () {
            // Create changes
            const txn = vdb.transaction();
            const pk1 = yield txn.addRow("t2", {});
            const pk2 = yield txn.addRow("t1", { number: 1 });
            yield txn.updateRow("t2", pk1, { "2-1": pk2 });
            yield txn.commit();
            // Mock underlying transaction
            const mockTransaction = {
                addRow: jest.fn(),
