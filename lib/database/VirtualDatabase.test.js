...
var preventPassthrough = function () {
    var tx = vdb.transaction();
...
test("queries with where clause and included columns", function () { return __awaiter(void 0, void 0, void 0, function () {
...
describe("select, order, limit", function () {
    var performQuery = function (rawRowsByTable, queryOptions) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // Set up mock database to return raw rows with c_ prefixed on column names
            // This simulates a real database call
            db.query = (function (qo) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            exprEval = new mwater_expressions_1.PromiseExprEvaluator({ schema: schema });
                            filteredRows = [];
                                    ...
                                    switch (_a.label) {
                                        case 0:
                                            evalRow = {
                                                ...
                                                followJoin: function (columnId) { return Promise.reject(new Error("Not implemented")); }
                                            };
    ...
    test("aggr count expr", function () { return __awaiter(void 0, void 0, void 0, function () {
        var qopts, rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test("count empty", function () { return __awaiter(void 0, void 0, void 0, function () {
        var qopts, rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, performQuery({ t1: [] }, qopts)];
                case 1:
                    rows = _a.sent();
                    expect(rows).toEqual([
                        { x: 0 },
    ...
    test("orderby query with limit", function () { return __awaiter(void 0, void 0, void 0, function () {
        var qopts, rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test("orderby query with capitalization", function () { return __awaiter(void 0, void 0, void 0, function () {
        var qopts, rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test("orderby query with nulls", function () { return __awaiter(void 0, void 0, void 0, function () {
        var qopts, rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test("orderby query with numbers", function () { return __awaiter(void 0, void 0, void 0, function () {
        var qopts, rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test("id join", function () { return __awaiter(void 0, void 0, void 0, function () {
        var qopts, rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test("n-1 scalar", function () { return __awaiter(void 0, void 0, void 0, function () {
        var qopts, rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test("1-n scalar", function () { return __awaiter(void 0, void 0, void 0, function () {
        var qopts, rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test("caches backend queries", function () { return __awaiter(void 0, void 0, void 0, function () {
        var qopts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test("does not query rows that are not yet added", function () { return __awaiter(void 0, void 0, void 0, function () {
        var tx, pk, qopts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    tx = vdb.transaction();
                    return [4 /*yield*/, tx.addRow("t1", {})];
                case 1:
                    pk = _a.sent();
    ...
    describe("transactions", function () {
        ...
        test("waits until transaction committed", function () { return __awaiter(void 0, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test("insert relevant row", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txn, rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        txn = vdb.transaction();
                        return [4 /*yield*/, txn.addRow("t1", { number: 6 })];
                    case 1:
                        _a.sent();
        ...
        test("insert irrelevant rows", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txn, rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, txn.addRow("t2", { number: 6 })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, txn.commit()];
                    case 3:
        ...
        test("update relevant row", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txn, rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test("update relevant row to become irrelevant", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txn, rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test("update irrelevant row to become relevant", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txn, rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        txn.updateRow("t1", 1, { number: 7 });
                        txn.commit();
                        return [4 /*yield*/, performQuery({ t1: [{ id: 1, number: 2 }, { id: 2, number: 6 }] }, qopts)];
                    case 1:
                        rows = _a.sent();
                        expect(rows).toEqual([
                            { x: 6 },
        ...
        test("remove relevant row", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txn, rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test("notifies change listener", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        test("commits changes", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        pk = _a.sent();
                        return [4 /*yield*/, txn.removeRow("t1", 1)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, txn.commit()
        ...
        test("shortcuts updating inserted row", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txn, pk;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        test("shortcuts updating row", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txn;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        txn = vdb.transaction();
                        return [4 /*yield*/, txn.updateRow("t1", 1, { number: 2 })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, txn.updateRow("t1", 1, { number: 3 })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, txn.commit()];
                    case 3:
        ...
        test("shortcuts removing inserted row", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txn, pk;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        pk = _a.sent();
                        return [4 /*yield*/, txn.removeRow("t1", pk)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, txn.commit()];
                    case 3:
        ...
        test("substitutes temporary primary keys", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        test("removes virtual rows locally", function () { return __awaiter(void 0, void 0, void 0, function () {
            var txn, pk, mockTransaction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
