...
class DataSourceDatabase {
    ...
    query(options, contextVars, filteredContextVarValues) {
        const queryCompiler = new QueryCompiler_1.QueryCompiler(this.schema, (0, blocks_1.createExprVariables)(contextVars), (0, blocks_1.createExprVariableValues)(contextVars, filteredContextVarValues));
