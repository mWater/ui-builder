...
var VirtualDatabase = /** @class */ (function () {
    ...
    VirtualDatabase.prototype.commit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var txn, pkMapping, _i, _a, mutation, _b, mappedValues, primaryKey, mappedUpdates, updatePrimaryKey, removePrimaryKey;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 8];
                    case 2:
                        mappedValues = this.replaceTempPrimaryKeys(mutation.values, function (pk) {
                            if (pkMapping[pk]) {
                                return pkMapping[pk];
                            }
                            throw new Error("Missing mapping for " + pk);
                        });
                        return [4 /*yield*/, txn.addRow(mutation.table, mappedValues)];
                    case 3:
                        primaryKey = _c.sent();
                        pkMapping[mutation.primaryKey] = primaryKey;
                        return [3 /*break*/, 8];
                    case 4:
                        mappedUpdates = this.replaceTempPrimaryKeys(mutation.updates, function (pk) {
                            if (pkMapping[pk]) {
                                return pkMapping[pk];
                            }
                            throw new Error("Missing mapping for " + pk);
                        ...
                        return [4 /*yield*/, txn.updateRow(mutation.table, updatePrimaryKey, mappedUpdates)];
                    case 5:
                        _c.sent();
                        return [3 /*break*/, 8];
                    case 6:
    ...
    VirtualDatabase.prototype.queryEvalRows = function (from, where, contextVars, contextVarValues) {
        return __awaiter(this, void 0, void 0, function () {
            var variables, exprUtils, queryOptions, updatedIds, _i, _a, column, rows;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        updatedIds = lodash_1.default.uniq(this.mutations.filter(function (m) { return m.type == "update"; }).map(function (m) { return m.primaryKey; }));
...
var VirtualDatabaseTransaction = /** @class */ (function () {
    ...
    VirtualDatabaseTransaction.prototype.commit = function () {
        var primaryKeys = this.mutations.map(function (m) { return m.type == "add" ? m.primaryKey : null; });
