...
var VirtualDatabase = /** @class */ (function () {
    ...
    VirtualDatabase.prototype.shouldIncludeColumn = function (column) {
        ...
        if (column.type == "join" && !((_a = this.schema.getTable(column.join.toTable)) === null || _a === void 0 ? void 0 : _a.primaryKey)) {
            return false;
        }
        return true;
    };
    ...
    VirtualDatabase.prototype.queryEvalRows = function (from, where, contextVars, contextVarValues) {
        return __awaiter(this, void 0, void 0, function () {
            var queryOptions, _i, _a, column, rows;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        rows = [];
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.queryCache.get({ queryOptions: queryOptions, contextVars: contextVars, contextVarValues: contextVarValues })];
                    case 2:
                        rows = _b.sent();
                        _b.label = 3;
            ...
            followJoin: function (columnId) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            column = this.schema.getColumn(from, columnId);
                            idTable = column.type == "id" ? column.idTable : column.join.toTable;
                            if (!(column.type == "join" && column.join.type === "1-n" && column.join.inverse)) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.queryEvalRows(column.join.toTable, {
                        ...
                        case 2:
                            if (!(column.type == "id" || (column.type == "join" && (column.join.type == "1-1" || column.join.type == "n-1")))) return [3 /*break*/, 4];
                        ...
                        case 4:
                            if (!(column.type == "id[]" || (column.type == "join" && (column.join.type == "1-n" || column.join.type == "n-n")))) return [3 /*break*/, 6];
                            // Short-circuit if null/undefined
