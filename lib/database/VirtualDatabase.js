...
var VirtualDatabase = /** @class */ (function () {
    ...
    VirtualDatabase.prototype.doesReferenceTempPk = function (queryOrExpr) {
        var _this = this;
        return (JSON.stringify(queryOrExpr).match(/"pk_[0-9a-zA-Z]+_temp"/g) || []).some(function (m) { return _this.tempPrimaryKeys.includes(JSON.parse(m)); });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 4];
                    case 1:
                        if (!this.doesReferenceTempPk(where)) return [3 /*break*/, 2];
