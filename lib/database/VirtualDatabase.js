...
var VirtualDatabase = /** @class */ (function () {
    function VirtualDatabase(database, schema, locale) {
        ...
        this.internalQueryEvalRows = function (options) { return __awaiter(_this, void 0, void 0, function () {
            var from, where, contextVars, contextVarValues, queryOptions, _i, _a, column, rows, queryCacheKey;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        from = options.from, where = options.where, contextVars = options.contextVars, contextVarValues = options.contextVarValues;
                        queryOptions = {
                            select: {
        ...
        this.queryEvalRowsCache = new BatchingCache_1.BatchingCache(this.internalQueryEvalRows);
    ...
    VirtualDatabase.prototype.queryEvalRows = function (from, where, contextVars, contextVarValues) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.queryEvalRowsCache.get({ from: from, where: where, contextVars: contextVars, contextVarValues: contextVarValues })];
            });
        });
    };
    ...
    VirtualDatabase.prototype.resetInternalCache = function () {
        this.queryEvalRowsCache = new BatchingCache_1.BatchingCache(this.internalQueryEvalRows);
    };
