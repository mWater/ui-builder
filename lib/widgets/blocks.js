...
class Block {
    ...
    getSubtreeInitialFilters(contextVarId, instanceCtx) {
        return __awaiter(this, void 0, void 0, function* () {
            // Get own filters
            let ownFilters = yield this.getInitialFilters(contextVarId, instanceCtx);
            // Append child ones
            for (const childBlock of this.getChildren(instanceCtx.contextVars, instanceCtx.schema)) {
                ...
                ownFilters = ownFilters.concat(yield block.getSubtreeInitialFilters(contextVarId, instanceCtx));
            }
            return ownFilters;
        });
    }
