...
var Block = /** @class */ (function () {
    ...
    Block.prototype.getInitialFilters = function (options) { return []; };
    /** Get initial filters generated by this block and any children */
    Block.prototype.getSubtreeInitialFilters = function (options) {
        // Get own filters
        var ownFilters = this.getInitialFilters(options);
        // Append child ones
        for (var _i = 0, _a = this.getChildren(options.contextVars); _i < _a.length; _i++) {
            var childBlock = _a[_i];
            var block = options.createBlock(childBlock.blockDef);
