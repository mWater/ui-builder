...
var ContextVarsInjector = /** @class */ (function (_super) {
    ...
    ContextVarsInjector.prototype.render = function () {
        ...
        var _loop_1 = function (contextVar) {
            var innerBlock = this_1.props.innerBlock ? this_1.props.createBlock(this_1.props.innerBlock) : null;
            // Get context var exprs
            var contextVarExprs = innerBlock ? innerBlock.getSubtreeContextVarExprs({
