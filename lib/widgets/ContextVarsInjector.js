...
class ContextVarsInjector extends React.Component {
    render() {
        ...
        for (const contextVar of reverseInjectedContextVars) {
            ...
            const contextVarExprs = innerBlock ? innerBlock.getSubtreeContextVarExprs(contextVar, Object.assign(Object.assign({}, this.props.instanceCtx), { contextVars: allContextVars })) : [];
            const initialFilters = innerBlock ? innerBlock.getSubtreeInitialFilters(contextVar.id, Object.assign(Object.assign({}, this.props.instanceCtx), { contextVars: allContextVars })) : [];
