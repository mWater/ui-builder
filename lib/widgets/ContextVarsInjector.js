...
var ContextVarsInjector = /** @class */ (function (_super) {
    ...
    ContextVarsInjector.prototype.render = function () {
        ...
        var _loop_1 = function (contextVar) {
            ...
            var contextVarExprs = this_1.props.innerBlock ? _.flatten(blocks_1.getBlockTree(this_1.props.innerBlock, this_1.props.createBlock, allContextVars).map(function (cb) {
