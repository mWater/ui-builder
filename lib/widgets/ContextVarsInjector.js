...
var ContextVarsInjector = /** @class */ (function (_super) {
    ...
    ContextVarsInjector.prototype.render = function () {
        ...
        var _loop_1 = function (contextVar) {
            ...
            var contextVarExprs = _.flatten(blocks_1.getBlockTree(this_1.props.innerBlock, this_1.props.createBlock, allContextVars).map(function (cb) {
                var block = _this.props.createBlock(cb.blockDef);
                return block.getContextVarExprs(contextVar, _this.props.renderInstanceProps.widgetLibrary, _this.props.renderInstanceProps.actionLibrary);
            }));
        ...
        return elem(__assign({}, this.props.renderInstanceProps, { database: this.props.database }), false, false);
    };
