...
function evalContextVarExpr(options) {
    return __awaiter(this, void 0, void 0, function () {
        var contextVar, contextVarValue, expr, ctx, table, queryOptions, contextVars, filteredContextVarValues, rows, table, aggrStatus, queryOptions, isExisting, contextVars, filteredContextVarValues, rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (contextVar == null) {
                        return [2 /*return*/, new mwater_expressions_1.PromiseExprEvaluator({
                                ...
                                variableValues: blocks_1.createExprVariableValues(ctx.contextVars, ctx.contextVarValues)
                            }).evaluateSync(expr)];
                    }
                ...
                case 2:
                    ...
                    table = contextVar.table;
                    aggrStatus = new mwater_expressions_1.ExprUtils(ctx.schema, blocks_1.createExprVariables(ctx.contextVars)).getExprAggrStatus(expr);
                    queryOptions = {
                        select: {
                            value: expr
                        },
