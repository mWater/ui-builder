...
test("inner contains extra context vars", () => {
    ...
    const x = shallow((React.createElement(ContextVarInjector, { renderInstanceProps: outerRenderProps, schema: schema, contextVar: contextVar, value: value, database: database, contextVarExprs: contextVarExprs }, (renderInstanceProps) => {
...
test("exprs are computed for row variables", (done) => {
    ...
    let innerRenderProps;
    const x = shallow((React.createElement(ContextVarInjector, { renderInstanceProps: outerRenderProps, schema: schema, database: database, contextVar: contextVar, value: value, contextVarExprs: contextVarExprs }, (renderInstanceProps) => {
        innerRenderProps = renderInstanceProps;
        return React.createElement("div", null);
    })));
...
test("exprs are computed for rowset variables, excluding non-aggregates", (done) => {
    ...
    let innerRenderProps;
    const x = shallow((React.createElement(ContextVarInjector, { renderInstanceProps: outerRenderProps, contextVar: contextVar, schema: schema, database: database, value: value, contextVarExprs: contextVarExprs }, (renderInstanceProps) => {
        innerRenderProps = renderInstanceProps;
        return React.createElement("div", null);
    })));
    // Query should have been made
...
test("filters are applied for rowset variables", (done) => {
    ...
    const x = mount((React.createElement(ContextVarInjector, { renderInstanceProps: outerRenderProps, contextVar: contextVar, value: value, schema: schema, database: database, contextVarExprs: contextVarExprs, initialFilters: initialFilters }, (renderInstanceProps, isLoading) => {
        innerRenderProps = renderInstanceProps;
