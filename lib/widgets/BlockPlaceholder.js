...
var BlockPlaceholder = /** @class */ (function (_super) {
    ...
    BlockPlaceholder.prototype.render = function () {
        return this.props.connectDropTarget(React.createElement("div", { className: this.props.isOver ? "block-placeholder drop" : "block-placeholder", onClick: this.handleNew }));
    };
