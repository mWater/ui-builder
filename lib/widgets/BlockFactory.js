...
import { DropdownFilterBlock } from './blocks/dropdownFilter/dropdownFilter';
import { RowsetBlock } from './blocks/rowset';
import { TabbedBlock } from './blocks/tabbed/tabbed';
import { ImageBlock } from './blocks/image';
import { AddRowBlock } from './blocks/addRow';
import { DatefieldBlock } from './blocks/controls/datefield';
import { ConditionalBlock } from './blocks/conditional';
    ...
    constructor() {
        this.createBlock = (blockDef) => {
            switch (blockDef.type) {
                ...
                case "conditional":
                    return new ConditionalBlock(blockDef, this.createBlock);
                case "queryTable":
                ...
                case "rowset":
                    return new RowsetBlock(blockDef, this.createBlock);
                case "addRow":
                    return new AddRowBlock(blockDef, this.createBlock);
                case "tabbed":
                    return new TabbedBlock(blockDef, this.createBlock);
                case "image":
                    return new ImageBlock(blockDef);
                case "datefield":
                    return new DatefieldBlock(blockDef);
            }
            // Use custom blocks
