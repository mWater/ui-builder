...
const variable_1 = require("./blocks/variable");
const HtmlBlock_1 = __importDefault(require("./blocks/html/HtmlBlock"));
const CodedBlock_1 = __importDefault(require("./blocks/coded/CodedBlock"));
const pageHeader_1 = require("./blocks/pageHeader");
class BlockFactory {
    constructor() {
        this.createBlock = (blockDef) => {
            switch (blockDef.type) {
                ...
                case "page-header":
                    return new pageHeader_1.PageHeaderBlock(blockDef);
                case "alert":
                ...
                case "variable":
                    return new variable_1.VariableBlock(blockDef);
                case "tagsEditor":
