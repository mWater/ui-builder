    ...
    function BlockFactory() {
        ...
        this.createBlock = function (blockDef) {
            switch (blockDef.type) {
                case "addWizard":
                    return new addWizard_1.AddWizardBlock(blockDef, _this.createBlock);
                case "horizontal":
                ...
                case "row":
                    return new row_1.RowBlock(blockDef, _this.createBlock);
                case "addRow":
                ...
                case "header":
                    return new header_1.HeaderBlock(blockDef, _this.createBlock);
                case "alert":
                    return new alert_1.AlertBlock(blockDef, _this.createBlock);
                case "validation":
                    return new validation_1.ValidationBlock(blockDef);
                case "float":
                    return new float_1.FloatBlock(blockDef, _this.createBlock);
                case "spacer":
                    return new spacer_1.SpacerBlock(blockDef);
                case "print":
                    return new print_1.PrintBlock(blockDef, _this.createBlock);
                case "queryRepeat":
                    return new queryRepeat_1.QueryRepeatBlock(blockDef, _this.createBlock);
                case "panel":
                    return new panel_1.PanelBlock(blockDef, _this.createBlock);
            }
            // Use custom blocks
