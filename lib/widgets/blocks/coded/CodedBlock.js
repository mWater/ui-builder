...
class CodedBlock extends LeafBlock_1.default {
    ...
    getInitialFilters(contextVarId, instanceCtx) {
        return __awaiter(this, void 0, void 0, function* () {
            const mod = yield evaluateModule(this.blockDef.compiledCode);
    ...
    renderDesign(ctx) {
        if (this.blockDef.editMode == "inline") {
            return react_1.default.createElement(CodedBlockEditInline, { blockDef: this.blockDef, ctx: ctx });
        }
        else {
    ...
    renderEditor(ctx) {
        return (react_1.default.createElement("div", null,
            react_1.default.createElement(__1.PropertyEditor, { obj: this.blockDef, onChange: ctx.store.replaceBlock, property: "editMode" }, (value, onChange) => (react_1.default.createElement(bootstrap_1.Toggle, { value: value || "modal", options: [
                    { value: "modal", label: "Modal" },
                    { value: "inline", label: "Inline" }
                ], onChange: onChange, size: "sm" }))),
            (this.blockDef.editMode || "modal") == "modal" && react_1.default.createElement(CodedBlockEditor, { blockDef: this.blockDef, ctx: ctx }),
...
function CodedBlockEditModal(props) {
    ...
    return (react_1.default.createElement(ModalWindowComponent_1.default, { isOpen: true, onRequestClose: handleSave }, babel != null &&
        react_1.default.createElement(CodedBlockCodeEditor, { code: code, ctx: props.ctx, onCodeChange: handleChange })));
}
...
function CodedBlockEditInline(props) {
    ...
    const saveBlock = (0, react_1.useMemo)(() => {
        function saveBlockInner(code) {
            try {
                const compiled = babel.transform(code, { plugins: ["transform-modules-commonjs", "transform-react-jsx"] }).code;
                props.ctx.store.alterBlock(props.blockDef.id, (0, immer_1.default)((b) => {
                    b.code = code;
        ...
        return lodash_1.default.debounce(saveBlockInner, 1000, { leading: false, trailing: true });
    }, [babel]);
    const handleChange = (value) => {
        setCode(value);
        saveBlock(value);
    ...
    return (react_1.default.createElement("div", { style: { marginBottom: 10 } },
        error ? react_1.default.createElement("div", { className: "text-danger" }, error) : react_1.default.createElement("div", null, "\u00A0"),
        react_1.default.createElement(FillDownwardComponent_1.default, null,
            react_1.default.createElement(CodedBlockCodeEditor, { code: code, ctx: props.ctx, onCodeChange: handleChange }))));
}
function CodedBlockCodeEditor(props) {
    ...
    return (Monaco ? (react_1.default.createElement(Monaco, { language: "javascript", height: "100%", onChange: handleChange, theme: "vs-dark", value: props.code, options: monacoOptions })) : null);
}
/** Loads a script */
