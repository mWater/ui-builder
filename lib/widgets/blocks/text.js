...
export class TextBlock extends LeafBlock {
    ...
    renderEditor(props) {
        return (React.createElement("div", null,
            ...
            React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "bold" }, (value, onChange) => React.createElement(Checkbox, { value: value, onChange: onChange }, "Bold")),
            React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "italic" }, (value, onChange) => React.createElement(Checkbox, { value: value, onChange: onChange }, "Italic")),
            React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "underline" }, (value, onChange) => React.createElement(Checkbox, { value: value, onChange: onChange }, "Underline")),
