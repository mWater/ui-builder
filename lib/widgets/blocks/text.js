            ...
            contextVar && contextVar.table
                ?
                    React.createElement(LabeledProperty, { label: "Expression" },
                        React.createElement(PropertyEditor, { obj: this.props.value, onChange: this.props.onChange, property: "expr" }, (value, onChange) => (React.createElement(ExprComponent, { value: value, onChange: onChange, schema: this.props.schema, dataSource: this.props.dataSource, aggrStatuses: ["individual", "aggregate", "literal"], table: contextVar.table }))))
                : null,
            exprType === "number" ?
