...
var TextBlock = /** @class */ (function (_super) {
    ...
    TextBlock.prototype.renderDesign = function (props) {
        ...
        return this.renderText(text ? this.processMarkdown(text) : React.createElement("span", { className: "text-muted" }, "Text"));
    };
        ...
        return (React.createElement("div", null,
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Text" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "text" }, function (value, onChange) {
                    return React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale, multiline: _this.blockDef.multiline || _this.blockDef.markdown, allowCR: _this.blockDef.multiline });
                })),
