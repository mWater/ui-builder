...
class TextualBlock extends LeafBlock_1.default {
    ...
    /** Processes HTML */
    processHTML(text) {
        return react_1.default.createElement("div", { dangerouslySetInnerHTML: { __html: (0, dompurify_1.sanitize)(text, { ADD_ATTR: ['target'] }) } });
    }
    canonicalize() {
    ...
    renderTextualEditor(props) {
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("div", null,
                !this.blockDef.html ? (react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "markdown" }, (value, onChange) => (react_1.default.createElement(bootstrap_2.Checkbox, { inline: true, value: value, onChange: onChange }, "Markdown")))) : null,
                !this.blockDef.markdown ? (react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "html" }, (value, onChange) => (react_1.default.createElement(bootstrap_2.Checkbox, { inline: true, value: value, onChange: onChange }, "HTML")))) : null,
                !this.blockDef.markdown && !this.blockDef.html ? (react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "multiline" }, (value, onChange) => (react_1.default.createElement(bootstrap_2.Checkbox, { inline: true, value: value, onChange: onChange }, "Multi-line")))) : null),
