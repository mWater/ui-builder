...
var TextualBlock = /** @class */ (function (_super) {
    ...
    /** Processes HTML */
    TextualBlock.prototype.processHTML = function (text) {
        return react_1.default.createElement("div", { dangerouslySetInnerHTML: { __html: dompurify_1.sanitize(text) } });
    };
    TextualBlock.prototype.canonicalize = function () {
        if (this.blockDef.html && this.blockDef.markdown) {
            return __assign(__assign({}, this.blockDef), { markdown: false });
        }
    ...
    TextualBlock.prototype.renderTextualEditor = function (props) {
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("div", null,
                !this.blockDef.html ?
                    react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "markdown" }, function (value, onChange) { return react_1.default.createElement(bootstrap_2.Checkbox, { inline: true, value: value, onChange: onChange }, "Markdown"); })
                    : null,
                !this.blockDef.markdown ?
                    react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "html" }, function (value, onChange) { return react_1.default.createElement(bootstrap_2.Checkbox, { inline: true, value: value, onChange: onChange }, "HTML"); })
                    : null,
                !this.blockDef.markdown && !this.blockDef.html ?
                    react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "multiline" }, function (value, onChange) { return react_1.default.createElement(bootstrap_2.Checkbox, { inline: true, value: value, onChange: onChange }, "Multi-line"); })
                    : null),
