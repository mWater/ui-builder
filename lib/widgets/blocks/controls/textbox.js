...
var TextboxBlock = /** @class */ (function (_super) {
    ...
    TextboxBlock.prototype.renderControl = function (props) {
        return React.createElement(Textbox, { value: props.value, onChange: props.onChange, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), disabled: props.disabled, numLines: this.blockDef.numLines || undefined, editOnFocus: this.blockDef.editOnFocus || false });
    };
