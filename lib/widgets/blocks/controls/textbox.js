...
export class TextboxBlock extends ControlBlock {
    renderControl(props) {
        return React.createElement(Textbox, { value: props.value, onChange: props.onChange, placeholder: localize(this.blockDef.placeholder, props.locale), disabled: props.disabled });
    }
