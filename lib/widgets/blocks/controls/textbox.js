...
var TextboxBlock = /** @class */ (function (_super) {
    ...
    TextboxBlock.prototype.renderControl = function (props) {
        return React.createElement(Textbox, { value: props.value, onChange: props.onChange ? props.onChange : function () { }, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), disabled: props.disabled || !props.onChange, numLines: this.blockDef.numLines || undefined, editOnFocus: this.blockDef.editOnFocus || false });
    };
    ...
    TextboxBlock.prototype.renderControlEditor = function (props) {
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "editOnFocus" }, function (value, onChange) { return React.createElement(bootstrap_1.Checkbox, { value: value, onChange: onChange }, "Edit On Focus"); })));
    };
...
var Textbox = /** @class */ (function (_super) {
    ...
    function Textbox(props) {
        ...
        _this.handleFocus = function () {
            ...
            _this.setState({ text: _this.props.value, focused: true });
        };
        _this.handleBlur = function (ev) {
            // Stop tracking state internally
            _this.setState({ text: null, focused: false });
        ...
        _this.state = { text: null, focused: false };
        return _this;
    }
