...
class TextboxBlock extends ControlBlock_1.ControlBlock {
    renderControl(props) {
        return React.createElement(Textbox, { value: props.value, onChange: props.onChange ? props.onChange : () => { }, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), disabled: props.disabled || !props.onChange, numLines: this.blockDef.numLines || undefined, editOnFocus: this.blockDef.editOnFocus || false });
    }
