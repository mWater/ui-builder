...
var TextboxBlock = /** @class */ (function (_super) {
    ...
    TextboxBlock.prototype.renderControl = function (props) {
        return React.createElement(Textbox, { value: props.value, onChange: props.onChange, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), disabled: props.disabled, numLines: this.blockDef.numLines });
    };
    ...
    TextboxBlock.prototype.renderControlEditor = function (props) {
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Number of lines" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "numLines" }, function (value, onChange) { return React.createElement(bootstrap_1.NumberInput, { value: value || 1, onChange: onChange, decimal: false }); }))));
    };
