...
export class DropdownBlock extends ControlBlock {
    ...
    renderId(props, column) {
        ...
        return React.createElement(IdLiteralComponent, { schema: props.schema, dataSource: props.dataSource, idTable: column.join.toTable, value: props.value, onChange: props.onChange, labelExpr: labelExpr, filter: filterExpr });
    }
        ...
        return (React.createElement("div", null,
            ...
            column && column.type === "join" ?
                React.createElement(LabeledProperty, { label: "Filter Expression" },
                    React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "idFilterExpr" }, (value, onChange) => React.createElement(FilterExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, table: column.join.toTable })))
                : null));
    }
