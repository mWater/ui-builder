...
var DropdownBlock = /** @class */ (function (_super) {
    ...
    DropdownBlock.prototype.renderId = function (props, column) {
        ...
        return React.createElement(IdDropdownComponent_1.IdDropdownComponent, { database: props.database, table: idTable, value: props.value, onChange: props.onChange, multi: false, labelExpr: this.blockDef.idLabelExpr || null, filterExpr: this.blockDef.idFilterExpr || null, contextVars: props.contextVars, contextVarValues: props.contextVarValues });
    };
    DropdownBlock.prototype.renderIds = function (props, column) {
        return React.createElement(IdDropdownComponent_1.IdDropdownComponent, { database: props.database, table: column.idTable, value: props.value, onChange: props.onChange, multi: true, labelExpr: this.blockDef.idLabelExpr || null, filterExpr: this.blockDef.idFilterExpr || null, contextVars: props.contextVars, contextVarValues: props.contextVarValues });
    };
        ...
        return (React.createElement("div", null,
            ...
            column && column.type === "join" ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Label Expression" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "idLabelExpr" }, function (value, onChange) { return React.createElement(mwater_expressions_ui_1.ExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, types: ["text"], table: column.join.toTable }); }))
                : null,
            column && column.type === "join" ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Filter Expression" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "idFilterExpr" }, function (value, onChange) { return React.createElement(mwater_expressions_ui_1.FilterExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, table: column.join.toTable }); }))
                : null,
