...
function IdDropdownInstance(props) {
    ...
    return react_1.default.createElement(IdDropdownComponent_1.IdDropdownComponent, { database: props.database, table: idTable, value: props.value, onChange: onChange, multi: false, labelEmbeddedExprs: labelEmbeddedExprs, searchExprs: searchExprs, orderBy: orderBy, filterExpr: blockDef.idFilterExpr || null, formatLabel: formatIdLabel, contextVars: contextVars, contextVarValues: contextVarValues, styles: styles });
}
function IdsDropdownInstance(props) {
    ...
    const contextVars = stabilizingHooks_1.useStabilizeValue(props.contextVars);
    const contextVarValues = stabilizingHooks_1.useStabilizeValue(props.contextVarValues);
    return react_1.default.createElement(IdDropdownComponent_1.IdDropdownComponent, { database: props.database, table: column.idTable, value: props.value, onChange: onChange, multi: true, labelEmbeddedExprs: labelEmbeddedExprs, searchExprs: searchExprs, orderBy: orderBy, filterExpr: blockDef.idFilterExpr || null, formatLabel: formatIdLabel, contextVars: contextVars, contextVarValues: contextVarValues, styles: styles });
}
