        ...
        return (React.createElement("div", null,
            ...
            column && (column.type === "enum" || column.type === "enumset") ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Include Values" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "includeValues" }, function (value, onChange) { return React.createElement(propertyEditors_1.EnumArrayEditor, { value: value, onChange: onChange, enumValues: column.enumValues }); }))
                : null,
            column && (column.type === "enum" || column.type === "enumset") ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Exclude Values" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "excludeValues" }, function (value, onChange) { return React.createElement(propertyEditors_1.EnumArrayEditor, { value: value, onChange: onChange, enumValues: column.enumValues }); }))
                : null));
    };
