...
var DropdownBlock = /** @class */ (function (_super) {
    ...
    DropdownBlock.prototype.renderControl = function (props) {
        ...
        if (!props.rowContextVar || !this.blockDef.column) {
            return React.createElement(react_select_1.default, { menuPortalTarget: document.body, classNamePrefix: "react-select-short", styles: { menuPortal: function (style) { return (__assign(__assign({}, style), { zIndex: 2000 })); } } });
        }
        // Get column
    ...
    DropdownBlock.prototype.renderEnum = function (props, column) {
        ...
        return React.createElement(react_select_1.default, { value: enumValue, onChange: handleChange, options: enumValues, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), getOptionLabel: getOptionLabel, getOptionValue: getOptionValue, isDisabled: props.disabled || !props.onChange, isClearable: true, closeMenuOnScroll: true, menuPortalTarget: document.body, classNamePrefix: "react-select-short", styles: { menuPortal: function (style) { return (__assign(__assign({}, style), { zIndex: 2000 })); } } });
    };
    DropdownBlock.prototype.renderEnumset = function (props, column) {
        ...
        return React.createElement(react_select_1.default, { value: value, onChange: handleChange, options: enumValues, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), getOptionLabel: getOptionLabel, getOptionValue: getOptionValue, isDisabled: props.disabled || !props.onChange, isClearable: true, isMulti: true, closeMenuOnScroll: true, menuPortalTarget: document.body, classNamePrefix: "react-select-short", styles: { menuPortal: function (style) { return (__assign(__assign({}, style), { zIndex: 2000 })); } } });
    };
    ...
    DropdownBlock.prototype.renderBoolean = function (props, column) {
    ...
    DropdownBlock.prototype.renderControlEditor = function (props) {
        ...
        var isIdType = column && (column.type == "id" || column.type == "id[]" || column.type == "join");
        var idMode = this.blockDef.idMode || "simple";
        var idTable = column ? column.idTable : null;
        var isBooleanType = column && column.type == "boolean";
        var handleConvertToToggle = function () {
            props.store.replaceBlock({
                id: _this.blockDef.id,
                type: "toggle",
                column: _this.blockDef.column,
                required: _this.blockDef.required,
                requiredMessage: _this.blockDef.requiredMessage,
                rowContextVarId: _this.blockDef.rowContextVarId,
                includeValues: _this.blockDef.includeValues,
                excludeValues: _this.blockDef.excludeValues
            });
        };
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(propertyEditors_1.LabeledProperty, { label: "Search expressions", key: "idSearchExprs" },
                        React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "idSearchExprs" }, function (value, onItemsChange) {
                            ...
                            return (React.createElement("div", null,
                                React.createElement(ListEditor_1.default, { items: value || [], onItemsChange: onItemsChange }, function (expr, onExprChange) { return (React.createElement(mwater_expressions_ui_1.ExprComponent, { value: expr, schema: props.schema, dataSource: props.dataSource, onChange: onExprChange, table: idTable, types: ["text", "enum", "enumset"], variables: blocks_1.createExprVariables(props.contextVars) })); }),
