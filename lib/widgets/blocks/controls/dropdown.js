...
class DropdownBlock extends ControlBlock_1.ControlBlock {
        ...
        this.formatIdLabel = (ctx, labelValues) => {
            if (this.blockDef.idMode == "advanced") {
                return (0, embeddedExprs_1.formatEmbeddedExprString)({
                    text: (0, localization_1.localize)(this.blockDef.idLabelText, ctx.locale),
                    contextVars: [],
    ...
    renderBoolean(props, column) {
        ...
        return (react_1.default.createElement(bootstrap_1.Select, { options: [
                { value: true, label: (0, localization_1.localize)(this.blockDef.trueLabel) || "Yes" },
                { value: false, label: (0, localization_1.localize)(this.blockDef.falseLabel) || "No" }
    ...
    renderControlEditor(props) {
        ...
        return (react_1.default.createElement("div", null,
            ...
            isIdType ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Mode", key: "mode" },
            ...
            isIdType && idMode == "simple" ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Label Expression", key: "idLabelExpr" },
            ...
            isIdType && idMode == "advanced" ? (react_1.default.createElement("div", null,
            ...
            isIdType ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Filter Expression", key: "idFilterExpr" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "idFilterExpr" }, (value, onChange) => (react_1.default.createElement(mwater_expressions_ui_1.FilterExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, table: idTable, variables: (0, blocks_1.createExprVariables)(props.contextVars) }))))) : null,
            column && (column.type === "enum" || column.type === "enumset") ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Include Values", key: "includeValues" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "includeValues" }, (value, onChange) => (react_1.default.createElement(propertyEditors_1.EnumArrayEditor, { value: value, onChange: onChange, enumValues: column.enumValues }))))) : null,
            column && (column.type === "enum" || column.type === "enumset") ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Exclude Values", key: "excludeValues" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "excludeValues" }, (value, onChange) => (react_1.default.createElement(propertyEditors_1.EnumArrayEditor, { value: value, onChange: onChange, enumValues: column.enumValues }))))) : null,
            !isIdType ? (react_1.default.createElement("div", { key: "convert_to_toggle" },
                react_1.default.createElement("button", { className: "btn btn-link btn-sm", onClick: handleConvertToToggle }, "Convert to Toggle"))) : null,
            isBooleanType ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Label for true", key: "trueLabel", hint: "Must be set to allow localization" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "trueLabel" }, (value, onChange) => (react_1.default.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale, placeholder: "Yes" }))))) : null,
            isBooleanType ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Label for false", key: "falseLabel", hint: "Must be set to allow localization" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "falseLabel" }, (value, onChange) => (react_1.default.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale, placeholder: "No" }))))) : null));
    }
...
const EnumDropdownInstance = (0, react_2.memo)((props) => {
    const { column, blockDef } = props;
    const enumValues = (0, react_2.useMemo)(() => {
    ...
    const handleChange = (0, react_2.useCallback)((ev) => {
        if (props.onChange) {
            props.onChange(ev ? ev.id : null);
        }
    }, [props.onChange]);
    return (react_1.default.createElement(react_select_1.default, { value: enumValue, onChange: handleChange, options: enumValues, placeholder: (0, localization_1.localize)(blockDef.placeholder, props.locale), getOptionLabel: getOptionLabel, getOptionValue: getOptionValue, isDisabled: props.disabled || !props.onChange, isClearable: true, closeMenuOnScroll: true, menuPortalTarget: document.body, classNamePrefix: "react-select-short", styles: { menuPortal: (style) => (Object.assign(Object.assign({}, style), { zIndex: 2000 })) } }));
});
const EnumsetDropdownInstance = (0, react_2.memo)((props) => {
    const { column, blockDef } = props;
    const enumValues = (0, react_2.useMemo)(() => {
        let result = column.enumValues;
        // Handle include/exclude
    ...
    const getOptionLabel = (ev) => (0, localization_1.localize)(ev.name, props.locale);
    const getOptionValue = (ev) => ev.id;
    const handleChange = (0, react_2.useCallback)((evs) => {
        if (props.onChange) {
            props.onChange(evs && evs.length > 0 ? evs.map((ev) => ev.id) : null);
        }
    }, [props.onChange]);
    return (react_1.default.createElement(react_select_1.default, { value: value, onChange: handleChange, options: enumValues, placeholder: (0, localization_1.localize)(blockDef.placeholder, props.locale), getOptionLabel: getOptionLabel, getOptionValue: getOptionValue, isDisabled: props.disabled || !props.onChange, isClearable: true, isMulti: true, closeMenuOnScroll: true, menuPortalTarget: document.body, classNamePrefix: "react-select-short", styles: { menuPortal: (style) => (Object.assign(Object.assign({}, style), { zIndex: 2000 })) } }));
});
function IdDropdownInstance(props) {
    const { column, blockDef } = props;
    const labelEmbeddedExprs = (0, react_2.useMemo)(() => {
        return blockDef.idMode == "advanced"
            ? (blockDef.idLabelEmbeddedExprs || []).map((ee) => ee.expr)
            : [blockDef.idLabelExpr];
    }, [blockDef]);
    const searchExprs = (0, react_2.useMemo)(() => {
        return blockDef.idMode == "advanced" ? blockDef.idSearchExprs || [] : [blockDef.idLabelExpr];
    }, [blockDef]);
    const orderBy = (0, react_2.useMemo)(() => {
        return blockDef.idMode == "advanced" ? blockDef.idOrderBy || [] : [{ expr: blockDef.idLabelExpr, dir: "asc" }];
    }, [blockDef]);
    // Dropdowns support n-1 and 1-1 joins as well as id columns
    const idTable = column.type == "join" ? column.join.toTable : column.idTable;
    const styles = (0, react_2.useMemo)(() => {
    ...
    const formatIdLabel = (0, hooks_1.useStabilizeFunction)(props.formatIdLabel);
    const contextVars = (0, hooks_1.useStabilizeValue)(props.contextVars);
    const contextVarValues = (0, hooks_1.useStabilizeValue)(props.contextVarValues);
    const value = (0, hooks_1.useStabilizeValue)(props.value);
