...
var DropdownBlock = /** @class */ (function (_super) {
    ...
    DropdownBlock.prototype.renderEnum = function (props, column) {
        ...
        if (this.blockDef.includeEnumValues && this.blockDef.includeEnumValues.length > 0) {
            enumValues = enumValues.filter(function (ev) { return _this.blockDef.includeEnumValues.includes(ev.id); });
        }
        if (this.blockDef.excludeEnumValues && this.blockDef.excludeEnumValues.length > 0) {
            enumValues = enumValues.filter(function (ev) { return !_this.blockDef.excludeEnumValues.includes(ev.id); });
        }
        // Lookup enumvalue
        ...
        return React.createElement(react_select_1.default, { value: enumValue, onChange: handleChange, options: enumValues, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), getOptionLabel: getOptionLabel, getOptionValue: getOptionValue, isDisabled: props.disabled, isClearable: true, styles: {
    ...
    DropdownBlock.prototype.renderEnumset = function (props, column) {
        ...
        return React.createElement(react_select_1.default, { value: value, onChange: handleChange, options: enumValues, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), getOptionLabel: getOptionLabel, getOptionValue: getOptionValue, isDisabled: props.disabled, isClearable: true, isMulti: true, styles: {
                // Keep menu above other controls
                menu: function (style) { return (__assign(__assign({}, style), { zIndex: 2000 })); }
            } });
    };
    DropdownBlock.prototype.renderId = function (props, column) {
        ...
        return React.createElement(mwater_expressions_ui_1.IdLiteralComponent, { schema: props.schema, dataSource: props.dataSource, idTable: idTable, value: props.value, onChange: props.onChange, labelExpr: labelExpr, filter: filterExpr });
    };
    DropdownBlock.prototype.renderIds = function (props, column) {
        ...
        // TODO Should use a local implementation that uses database, not dataSource for data. This one will not 
        // pick up any changes in a virtual database
        return React.createElement(mwater_expressions_ui_1.IdLiteralComponent, { schema: props.schema, dataSource: props.dataSource, idTable: column.idTable, value: props.value, onChange: props.onChange, multi: true, labelExpr: labelExpr, filter: filterExpr });
    };
        ...
        return (React.createElement("div", null,
            ...
            column && (column.type === "enum" || column.type === "enumset") ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Include Values" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "includeEnumValues" }, function (value, onChange) { return React.createElement(propertyEditors_1.EnumArrayEditor, { value: value, onChange: onChange, enumValues: column.enumValues }); }))
                : null,
            column && (column.type === "enum" || column.type === "enumset") ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Exclude Values" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "excludeEnumValues" }, function (value, onChange) { return React.createElement(propertyEditors_1.EnumArrayEditor, { value: value, onChange: onChange, enumValues: column.enumValues }); }))
                : null));
    };
