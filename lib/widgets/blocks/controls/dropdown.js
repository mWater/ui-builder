        ...
        return (React.createElement("div", null,
            ...
            isIdType && idMode == "simple" ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Label Expression" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "idLabelExpr" }, function (value, onChange) { return React.createElement(mwater_expressions_ui_1.ExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, types: ["text"], table: idTable }); }))
                : null,
