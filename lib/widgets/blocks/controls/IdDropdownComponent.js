...
function IdDropdownComponent(props) {
    ...
    var loadOptions = react_1.useCallback(function (input, callback) {
        ...
        if (input) {
            var orFilter = {
                type: "op", table: props.table, op: "or", exprs: props.searchExprs.map(function (se) { return ({ type: "op", table: props.table, op: "~*", exprs: [
                        se,
