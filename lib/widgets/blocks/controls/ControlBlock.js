...
function ControlInstance(props) {
    ...
    const stableValue = stabilizingHooks_1.useStabilizeValue(localValue);
    // Provide stable onChange function
    const stableOnChange = stabilizingHooks_1.useStabilizeFunction((newValue) => __awaiter(this, void 0, void 0, function* () {
