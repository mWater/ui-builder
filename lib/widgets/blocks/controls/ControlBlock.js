...
class ControlBlock extends LeafBlock_1.default {
    ...
    renderEditor(props) {
        ...
        return (react_1.default.createElement("div", null,
            ...
            contextVar ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Column" },
            ...
            this.blockDef.required ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Required Message" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "requiredMessage" }, (value, onChange) => (react_1.default.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale }))))) : null,
...
function ControlInstance(props) {
    ...
    const [requiredError, setRequiredError] = (0, react_1.useState)(null);
    function getValue() {
    ...
    function validate(isFirstError) {
        ...
        if (getValue() == null && blockDef.required) {
            setRequiredError(blockDef.requiredMessage ? (0, localization_1.localize)(blockDef.requiredMessage, instanceCtx.locale) : "");
            ...
            if (isFirstError && controlRef.current && controlRef.current.scrollIntoView) {
                ...
                // Add some padding
                const scrollParent = (0, scrolling_1.getScrollParent)(controlRef.current);
                if (scrollParent)
    ...
    const stableValue = (0, hooks_1.useStabilizeValue)(localValue);
    // Provide stable onChange function
    const stableOnChange = (0, hooks_1.useStabilizeFunction)((newValue) => __awaiter(this, void 0, void 0, function* () {
    ...
    return (react_1.default.createElement("div", null,
        ...
        requiredError ? (react_1.default.createElement("div", { key: "error", className: "text-danger" }, requiredError)) : null));
}
