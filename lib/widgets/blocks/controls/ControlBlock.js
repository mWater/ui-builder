...
function ControlInstance(props) {
    ...
    const stableValue = hooks_1.useStabilizeValue(localValue);
    // Provide stable onChange function
    const stableOnChange = hooks_1.useStabilizeFunction((newValue) => __awaiter(this, void 0, void 0, function* () {
