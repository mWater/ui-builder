...
var ControlBlock = /** @class */ (function (_super) {
    ...
    ControlBlock.prototype.renderEditor = function (props) {
        ...
        var handleColumnChanged = function (blockDef) {
            props.onChange(_this.processColumnChanged(blockDef));
        };
        return (React.createElement("div", null,
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Context Variable" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "rowContextVarId" }, function (value, onChange) { return React.createElement(propertyEditors_1.ContextVarPropertyEditor, { value: value, onChange: onChange, contextVars: props.contextVars, types: ["row"] }); })),
            contextVar ?
                ...
                : null,
            React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "required" }, function (value, onChange) { return React.createElement(bootstrap_1.Checkbox, { value: value, onChange: onChange }, "Required"); }),
            this.blockDef.required ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Required Message" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "requiredMessage" }, function (value, onChange) { return React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale }); }))
                : null,
...
var ControlInstance = /** @class */ (function (_super) {
    ...
    function ControlInstance(props) {
        ...
        _this.validate = function () {
            ...
            if (_this.getValue() == null && _this.props.block.blockDef.required) {
                return localization_1.localize(_this.props.block.blockDef.requiredMessage, _this.props.renderInstanceProps.locale);
            }
            return null;
        };
        _this.handleChange = function (newValue) { return __awaiter(_this, void 0, void 0, function () {
            var renderInstanceProps, blockDef, contextVar, id, txn, err_1;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        contextVar = renderInstanceProps.contextVars.find(function (cv) { return cv.id === blockDef.rowContextVarId; });
                        id = renderInstanceProps.getContextVarExprValue(blockDef.rowContextVarId, { type: "id", table: contextVar.table });
                        // Update database
                        this.setState({ updating: true });
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 4, 5, 6]);
                        txn = this.props.renderInstanceProps.database.transaction();
    ...
    ControlInstance.prototype.getValue = function () {
        var renderInstanceProps = this.props.renderInstanceProps;
        var blockDef = this.props.block.blockDef;
        var contextVar = renderInstanceProps.contextVars.find(function (cv) { return cv.id === blockDef.rowContextVarId; });
        // Get current value
    ...
    ControlInstance.prototype.render = function () {
        ...
        var blockDef = this.props.block.blockDef;
        var contextVar = renderInstanceProps.contextVars.find(function (cv) { return cv.id === blockDef.rowContextVarId; });
        var id = renderInstanceProps.getContextVarExprValue(blockDef.rowContextVarId, { type: "id", table: contextVar.table });
        var renderControlProps = {
            value: this.getValue(),
