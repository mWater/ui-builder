...
var TagEditorInstance = /** @class */ (function (_super) {
    ...
    TagEditorInstance.prototype.render = function () {
        ...
        return react_1.default.createElement(async_creatable_1.default, { cacheOptions: true, defaultOptions: true, loadOptions: this.getOptions, styles: styles, value: this.props.value ? this.props.value.map(function (v) { return ({ value: v, label: v }); }) : null, classNamePrefix: "react-select-short", menuPortalTarget: document.body, isMulti: true, onChange: this.handleChange, isDisabled: this.props.disabled || !this.props.onChange });
    };
