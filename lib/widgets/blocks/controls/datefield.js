...
var Datefield = /** @class */ (function (_super) {
    ...
    function Datefield() {
        ...
        _this.handleChange = function (value) {
            if (_this.props.datetime) {
                ...
                _this.props.onChange(value ? moment_1.default(value).format("YYYY-MM-DD") : null);
            }
        };
        return _this;
    }
    Datefield.prototype.render = function () {
        ...
        var dateFormat = this.props.format;
        ...
        return (React.createElement(react_datepicker_1.default, { placeholderText: this.props.placeholder, disabled: this.props.disabled, selected: this.props.value ? new Date(this.props.value) : null, onChange: this.handleChange, showTimeSelect: this.props.datetime, timeFormat: "HH:mm", dateFormat: dateFormat, className: "form-control" }));
    };
    return Datefield;
}(React.Component));
