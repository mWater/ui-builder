...
var DatefieldBlock = /** @class */ (function (_super) {
    ...
    DatefieldBlock.prototype.processColumnChanged = function (blockDef) {
        return __assign({}, blockDef, { format: null });
    };
...
var Datefield = /** @class */ (function (_super) {
    ...
    Datefield.prototype.render = function () {
        return (React.createElement(react_datepicker_1.default, { placeholderText: this.props.placeholder, disabled: this.props.disabled, selected: this.props.value ? moment_1.default(this.props.value, moment_1.default.ISO_8601) : null, onChange: this.handleChange, showTimeSelect: this.props.datetime, timeFormat: "HH:mm", dateFormat: this.props.format, className: "form-control" }));
    };
    return Datefield;
}(React.Component));
