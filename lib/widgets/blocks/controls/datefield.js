...
class DatefieldBlock extends ControlBlock_1.ControlBlock {
    renderControl(props) {
        ...
        return React.createElement(Datefield, { value: props.value, onChange: props.onChange, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), disabled: props.disabled || !props.onChange, datetime: datetime, format: format });
    }
...
class Datefield extends React.Component {
    ...
    render() {
        return (React.createElement(react_datepicker_1.default, { isClearable: true, placeholderText: this.props.placeholder, disabled: this.props.disabled || !this.props.onChange, selected: this.props.value ? moment_1.default(this.props.value, moment_1.default.ISO_8601) : null, onChange: this.handleChange, showTimeSelect: this.props.datetime, timeFormat: "HH:mm", dateFormat: this.props.format, className: "form-control", popperContainer: createPopperContainer, showMonthDropdown: true, showYearDropdown: true }));
    }
}
