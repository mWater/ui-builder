...
class NumberboxBlock extends ControlBlock_1.ControlBlock {
    renderControl(props) {
        return (React.createElement(bootstrap_1.NumberInput, { value: props.value, onChange: props.onChange, style: { maxWidth: this.blockDef.width || "12em", width: "100%" }, placeholder: (0, localization_1.localize)(this.blockDef.placeholder, props.locale), decimal: this.blockDef.decimal, decimalPlaces: this.blockDef.decimalPlaces != null ? this.blockDef.decimalPlaces : undefined }));
    }
    ...
    renderControlEditor(props) {
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Width" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "width" }, (value, onChange) => React.createElement(bootstrap_1.Select, { value: value || "12em", onChange: onChange, options: [
                        { value: "8em", label: "8em" },
