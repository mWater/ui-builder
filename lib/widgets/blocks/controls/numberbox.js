...
var NumberboxBlock = /** @class */ (function (_super) {
    ...
    NumberboxBlock.prototype.renderControl = function (props) {
        return React.createElement(bootstrap_1.NumberInput, { value: props.value, onChange: props.onChange, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), decimal: this.blockDef.decimal, decimalPlaces: this.blockDef.decimalPlaces });
    };
