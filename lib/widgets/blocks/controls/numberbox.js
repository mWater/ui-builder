...
class NumberboxBlock extends ControlBlock_1.ControlBlock {
    renderControl(props) {
        return React.createElement(bootstrap_1.NumberInput, { value: props.value, onChange: props.onChange, style: { maxWidth: "12em", width: "100%" }, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), decimal: this.blockDef.decimal, decimalPlaces: this.blockDef.decimalPlaces != null ? this.blockDef.decimalPlaces : undefined });
    }
    ...
    renderControlEditor(props) {
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "decimal" }, (value, onChange) => React.createElement(bootstrap_1.Checkbox, { value: value, onChange: onChange }, " Decimal Number")),
            this.blockDef.decimal ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Decimal Places" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "decimalPlaces" }, (value, onChange) => React.createElement(bootstrap_1.NumberInput, { value: value, onChange: onChange, decimal: false })))
                : null));
    }
