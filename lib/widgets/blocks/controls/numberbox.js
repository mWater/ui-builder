...
var NumberboxBlock = /** @class */ (function (_super) {
    ...
    NumberboxBlock.prototype.renderControl = function (props) {
        return React.createElement(bootstrap_1.NumberInput, { value: props.value, onChange: props.onChange, style: { width: "12em" }, placeholder: localization_1.localize(this.blockDef.placeholder, props.locale), decimal: this.blockDef.decimal, decimalPlaces: this.blockDef.decimalPlaces });
    };
    ...
    NumberboxBlock.prototype.renderControlEditor = function (props) {
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "decimal" }, function (value, onChange) { return React.createElement(bootstrap_1.Checkbox, { value: value, onChange: onChange }, " Decimal Number"); }),
            this.blockDef.decimal ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Decimal Places" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "decimalPlaces" }, function (value, onChange) { return React.createElement(bootstrap_1.NumberInput, { value: value, onChange: onChange, decimal: false }); }))
                : null));
    };
