...
var ToggleBlock = /** @class */ (function (_super) {
    ...
    ToggleBlock.prototype.renderEnumset = function (props, column) {
        ...
        return React.createElement("div", { className: "btn-group" }, enumValues.map(function (option) {
            return React.createElement("button", { key: option.id, type: "button", disabled: props.disabled || !props.onChange, className: (props.value || []).includes(option.id) ? "btn btn-primary active" : "btn btn-default", onClick: handleToggle.bind(null, option.id) }, localization_1.localize(option.name, props.locale));
        }));
    };
    ToggleBlock.prototype.renderBoolean = function (props, column) {
        return React.createElement("div", { className: "btn-group" },
            React.createElement("button", { key: "true", type: "button", disabled: props.disabled || !props.onChange, className: props.value == true ? "btn btn-primary active" : "btn btn-default", onClick: props.onChange ? function () { return props.onChange(props.value === true ? null : true); } : undefined }, localization_1.localize(this.blockDef.trueLabel, props.locale) || "Yes"),
            React.createElement("button", { key: "false", type: "button", disabled: props.disabled || !props.onChange, className: props.value == false ? "btn btn-primary active" : "btn btn-default", onClick: props.onChange ? function () { return props.onChange(props.value === false ? null : false); } : undefined }, localization_1.localize(this.blockDef.falseLabel, props.locale) || "No"));
    };
