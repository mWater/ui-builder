...
class ToggleBlock extends ControlBlock_1.ControlBlock {
    ...
    renderBoolean(props, column) {
        return React.createElement("div", { className: "btn-group" },
            React.createElement("button", { key: "true", type: "button", disabled: props.disabled || !props.onChange, className: props.value == true ? "btn btn-primary active" : "btn btn-default", onClick: props.onChange ? () => props.onChange(props.value === true ? null : true) : undefined }, localization_1.localize(this.blockDef.trueLabel, props.locale) || "Yes"),
            React.createElement("button", { key: "false", type: "button", disabled: props.disabled || !props.onChange, className: props.value == false ? "btn btn-primary active" : "btn btn-default", onClick: props.onChange ? () => props.onChange(props.value === false ? null : false) : undefined }, localization_1.localize(this.blockDef.falseLabel, props.locale) || "No"));
    }
