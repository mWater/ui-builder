...
class ToggleBlock extends ControlBlock_1.ControlBlock {
    renderControl(props) {
        ...
        const defaultControl = (React.createElement("div", { className: "btn-group" },
            ...
            React.createElement("button", { key: "2", type: "button", className: "btn btn-secondary" }, "Option 2")));
    ...
    renderEnum(props, column) {
        ...
        return (React.createElement("div", { className: "btn-group" }, enumValues.map((option) => {
            return (React.createElement("button", { key: option.id, type: "button", disabled: props.disabled || !props.onChange, className: props.value == option.id ? "btn btn-primary active" : "btn btn-outline-primary", onClick: props.onChange != null ? () => props.onChange(option.id == props.value ? null : option.id) : undefined }, (0, localization_1.localize)(option.name, props.locale)));
        })));
    }
    renderEnumset(props, column) {
        ...
        return (React.createElement("div", { className: "btn-group" }, enumValues.map((option) => {
            return (React.createElement("button", { key: option.id, type: "button", disabled: props.disabled || !props.onChange, className: (props.value || []).includes(option.id) ? "btn btn-primary active" : "btn btn-outline-primary", onClick: handleToggle.bind(null, option.id) }, (0, localization_1.localize)(option.name, props.locale)));
        })));
    }
    renderBoolean(props, column) {
        return (React.createElement("div", { className: "btn-group" },
            React.createElement("button", { key: "true", type: "button", disabled: props.disabled || !props.onChange, className: props.value == true ? "btn btn-primary active" : "btn btn-outline-primary", onClick: props.onChange ? () => props.onChange(props.value === true ? null : true) : undefined }, (0, localization_1.localize)(this.blockDef.trueLabel, props.locale) || "Yes"),
            React.createElement("button", { key: "false", type: "button", disabled: props.disabled || !props.onChange, className: props.value == false ? "btn btn-primary active" : "btn btn-outline-primary", onClick: props.onChange ? () => props.onChange(props.value === false ? null : false) : undefined }, (0, localization_1.localize)(this.blockDef.falseLabel, props.locale) || "No")));
    }
