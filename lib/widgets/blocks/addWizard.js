...
var AddWizardPane = function (props) {
    ...
    var displayAndFilterEntries = function (entries) {
        ...
        return React.createElement("div", null, visibleEntries.map(function (entry, index) {
            return React.createElement(PaletteItem, { entry: entry, key: index, createBlock: props.createBlock, schema: props.schema, dataSource: props.dataSource, contextVars: props.contextVars, onSelect: function () { return props.onSelect(typeof entry.blockDef == "function" ? entry.blockDef(props.contextVars) : entry.blockDef); } });
        }));
    };
    return React.createElement("div", null,
...
var PaletteItem = /** @class */ (function (_super) {
    ...
    PaletteItem.prototype.renderContents = function () {
        ...
        var block = this.props.createBlock(typeof entry.blockDef == "function" ? entry.blockDef(this.props.contextVars) : entry.blockDef);
