...
var AddWizardBlock = /** @class */ (function (_super) {
    ...
    AddWizardBlock.prototype.renderDesign = function (props) {
        ...
        var handleSet = function (newBlockDef) {
            if (newBlockDef) {
                props.store.alterBlock(_this.blockDef.id, function (bd) { return blocks_1.duplicateBlockDef(newBlockDef, _this.createBlock); });
            }
            else {
...
var AddWizardPane = function (props) {
    ...
    return React.createElement("div", null,
        ...
        React.createElement(TabbedComponent_1.default, { initialTabId: "palette", tabs: [
