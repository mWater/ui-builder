...
var AddWizardPane = function (props) {
    ...
    var displayAndFilterEntries = function (entries) {
        ...
        return React.createElement("div", null, visibleEntries.map(function (entry) {
            return React.createElement(PaletteItem, { entry: entry, createBlock: props.createBlock, schema: props.schema, dataSource: props.dataSource, contextVars: props.contextVars, onSelect: function () { return props.onSelect(typeof entry.blockDef == "function" ? entry.blockDef(props.contextVars) : entry.blockDef); } });
        }));
    };
    return React.createElement("div", null,
