...
var AddWizardPane = function (props) {
    ...
    var _c = react_1.useState("plain"), expressionMode = _c[0], setExpressionMode = _c[1];
    // Focus on load
        ...
        var wrapBlockDef = function (label, blockDef) {
            if (expressionMode == "plain") {
                ...
                return {
                    ...
                    items: [
                        { id: uuid(), type: "text", text: appendStr(label, ":"), bold: true },
                        blockDef
                    ]
                };
            }
    ...
    var renderExpressionOptions = function () {
        return React.createElement("div", { style: { float: "right", paddingRight: 10 } },
            React.createElement(bootstrap_1.Toggle, { value: expressionMode, onChange: setExpressionMode, size: "sm", options: [
