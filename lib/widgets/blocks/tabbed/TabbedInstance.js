...
function TabbedInstance(props) {
     ...
     */
    const [openTabIndexes, setOpenTabIndexes] = (0, react_1.useState)([0]);
    ...
    function renderTab(tab, index) {
        const labelText = (0, localization_1.localize)(tab.label, props.instanceCtx.locale);
        return (react_1.default.createElement("li", { className: "nav-item", key: index },
            react_1.default.createElement("a", { className: activeIndex === index ? "nav-link active" : "nav-link", onClick: handleSelectTab.bind(null, index), style: { cursor: "pointer" } }, labelText)));
    }
    ...
    if (props.blockDef.alwaysCollapse ||
        (props.blockDef.collapseWidth != null && pageWidth <= props.blockDef.collapseWidth)) {
        function getTabLabel(tab) {
            return (0, localization_1.localize)(tab.label, props.instanceCtx.locale);
        }
        ...
        return (react_1.default.createElement("div", { style: { paddingTop: 5, paddingBottom: 5 } },
            react_1.default.createElement("div", { className: "btn-group", key: "selector", style: { marginBottom: 10 } },
                react_1.default.createElement("button", { type: "button", className: "btn btn-secondary dropdown-toggle", "data-bs-toggle": "dropdown" }, labelText),
                react_1.default.createElement("ul", { className: "dropdown-menu" }, props.blockDef.tabs.map((tab, index) => {
                    return (react_1.default.createElement("li", { key: index },
                        react_1.default.createElement("a", { className: "dropdown-item", onClick: handleSelectTab.bind(null, index) }, getTabLabel(tab))));
                }))),
