...
class TabbedDesigner extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleAddContent = (tabIndex, addedBlockDef) => {
            this.props.designCtx.store.alterBlock(this.props.tabbedBlockDef.id, immer_1.default((b) => {
    ...
    renderTab(tab, index) {
        const labelText = localization_1.localize(tab.label, this.props.designCtx.locale);
