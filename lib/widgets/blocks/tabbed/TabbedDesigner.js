...
class TabbedDesigner extends react_1.default.Component {
    ...
    renderTab(tab, index) {
        ...
        return (react_1.default.createElement("li", { className: "nav-item", key: index },
            react_1.default.createElement("a", { className: this.state.activeIndex === index ? "nav-link active" : "nav-link", onClick: this.handleSelectTab.bind(null, index) }, labelText)));
    }
    render() {
