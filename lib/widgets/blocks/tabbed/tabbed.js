...
class TabbedBlock extends blocks_1.Block {
    ...
    renderEditor(props) {
        ...
        return (react_1.default.createElement("div", null,
            ...
            !this.blockDef.alwaysCollapse ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Collapse Below Width" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "collapseWidth" }, (value, onChange) => react_1.default.createElement(propertyEditors_1.ResponsiveWidthSelector, { value: value, onChange: onChange })))) : null));
    }
}
