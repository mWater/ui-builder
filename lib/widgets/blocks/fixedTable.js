...
var FixedTableBlock = /** @class */ (function (_super) {
    ...
    FixedTableBlock.prototype.renderDesign = function (props) {
        ...
        return (React.createElement("table", { className: this.blockDef.cellPadding === "condensed" ? "table table-bordered table-condensed" : "table table-bordered" },
            React.createElement("tbody", null, this.blockDef.rows.map(function (row, rowIndex) { return (React.createElement("tr", null, row.cells.map(function (cell, columnIndex) { return React.createElement("td", { key: "index" }, props.renderChildBlock(props, cell.content, handleSet.bind(null, rowIndex, columnIndex))); }))); }))));
    };
    FixedTableBlock.prototype.renderInstance = function (props) {
        return (React.createElement("table", { className: this.blockDef.cellPadding === "condensed" ? "table table-bordered table-condensed" : "table table-bordered" },
            React.createElement("tbody", null, this.blockDef.rows.map(function (row, rowIndex) { return (React.createElement("tr", null, row.cells.map(function (cell, columnIndex) { return React.createElement("td", { key: "index" }, props.renderChildBlock(props, cell.content)); }))); }))));
    };
