...
var SearchBlockInstance = /** @class */ (function (_super) {
    ...
    function SearchBlockInstance(props) {
        ...
        _this.handleChange = function (value) {
            ...
            // Set filter 
            _this.props.instanceCtx.setFilter(blockDef.rowsetContextVarId, _this.createFilter(value));
        };
    ...
    SearchBlockInstance.prototype.createFilter = function (searchText) {
        ...
        // Get table
        var table = this.props.instanceCtx.contextVars.find(function (cv) { return cv.id === _this.props.blockDef.rowsetContextVarId; }).table;
        if (searchText) {
    ...
    SearchBlockInstance.prototype.createExprFilter = function (expr, searchText, table) {
        ...
        var exprUtils = new mwater_expressions_1.ExprUtils(this.props.instanceCtx.schema, blocks_1.createExprVariables(this.props.instanceCtx.contextVars));
        ...
        if (exprType === "enum") {
            // Find matching enums
            var enumValues = exprUtils.getExprEnumValues(expr).filter(function (ev) { return localization_1.localize(ev.name, _this.props.instanceCtx.locale).toLowerCase().includes(searchText.toLowerCase()); });
    ...
    SearchBlockInstance.prototype.render = function () {
        return React.createElement(SearchControl, { value: this.state.searchText, onChange: this.handleChange, placeholder: localization_1.localize(this.props.blockDef.placeholder, this.props.instanceCtx.locale) });
    };
...
var SearchControl = /** @class */ (function (_super) {
    ...
    SearchControl.prototype.render = function () {
        return (React.createElement("div", { style: { position: "relative", display: "inline-block", margin: 5 } },
            ...
            React.createElement("input", { type: "text", ref: this.inputRef, className: "form-control", style: { maxWidth: "20em" }, value: this.props.value, onChange: this.handleChange, placeholder: this.props.placeholder })));
    };
