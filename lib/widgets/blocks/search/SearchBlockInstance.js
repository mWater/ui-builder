...
export class SearchControl extends React.Component {
    ...
    render() {
        return (React.createElement("div", { style: { position: "relative", display: "inline-block", pointerEvents: "none" } },
            React.createElement("i", { className: "fa fa-search", style: { position: "absolute", right: 8, top: 10, color: "#AAA" } }),
