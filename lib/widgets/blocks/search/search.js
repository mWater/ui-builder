            ...
            rowsetCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Search expressions" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "searchExprs" }, function (value, onItemsChange) {
                        ...
                        return (React.createElement("div", null,
                            React.createElement(ListEditor_1.default, { items: value, onItemsChange: onItemsChange }, function (expr, onExprChange) { return (React.createElement(mwater_expressions_ui_1.ExprComponent, { value: expr, schema: props.schema, dataSource: props.dataSource, onChange: onExprChange, table: rowsetCV.table, types: ["text", "enum", "enumset"], variables: blocks_1.createExprVariables(props.contextVars) })); }),
