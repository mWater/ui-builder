    ...
    renderEditor(props) {
        function renderSearchTarget(searchTarget, onSearchTargetChange) {
            ...
            return (React.createElement("div", null,
                ...
                rowsetCV ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Search expressions" },
        ...
        return (React.createElement("div", null,
            ...
            this.blockDef.rowsetContextVarId && this.blockDef.searchExprs.length > 0 ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Additional searches on other rowsets" },
