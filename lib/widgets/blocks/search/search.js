...
export class SearchBlock extends LeafBlock {
    ...
    renderDesign(props) {
        return (React.createElement("div", { className: "input-group", style: { padding: 5 } },
            ...
            React.createElement("input", { type: "text", className: "form-control input-sm", style: { maxWidth: "20em" }, placeholder: localize(this.blockDef.placeholder, props.locale) })));
    }
            ...
            rowsetCV ?
                React.createElement(LabeledProperty, { label: "Search expressions" },
                    React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "searchExprs" }, (value, onItemsChange) => {
                        ...
                        return (React.createElement("div", null,
                            React.createElement(ListEditor, { items: value, onItemsChange: onItemsChange }, (expr, onExprChange) => (React.createElement(ExprComponent, { value: expr, schema: props.schema, dataSource: props.dataSource, onChange: onExprChange, table: rowsetCV.table, types: ["text"] }))),
