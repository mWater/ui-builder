...
var WidgetBlock = /** @class */ (function (_super) {
    ...
    WidgetBlock.prototype.getContextVarExprs = function (contextVar, ctx) {
        ...
        var contextVarExprs = this.createBlock(widgetDef.blockDef).getSubtreeContextVarExprs(innerContextVar, __assign(__assign({}, ctx), { contextVars: widgetDef.contextVars }));
