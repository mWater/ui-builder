...
var WidgetBlock = /** @class */ (function (_super) {
    ...
    WidgetBlock.prototype.getInitialFilters = function (options) {
        var widgetDef = options.widgetLibrary.widgets[this.blockDef.widgetId];
        if (widgetDef && widgetDef.blockDef) {
            ...
            for (var _i = 0, _a = Object.keys(this.blockDef.contextVarMap); _i < _a.length; _i++) {
                ...
                if (value === options.contextVarId) {
                    return innerBlock.getInitialFilters(__assign(__assign({}, options), { contextVarId: key }));
                }
            }
        }
        return [];
    ...
    WidgetBlock.prototype.getContextVarExprs = function (contextVar, widgetLibrary, actionLibrary) {
        ...
        var contextVarExprs = this.createBlock(widgetDef.blockDef).getSubtreeContextVarExprs({
