...
var WidgetBlock = /** @class */ (function (_super) {
    ...
    WidgetBlock.prototype.renderDesign = function (props) {
        ...
        if (widgetDef && widgetDef.blockDef) {
            ...
            var innerProps = __assign(__assign({}, props), { selectedId: null, contextVars: widgetDef.contextVars, store: new blocks_1.NullBlockStore(), blockPaletteEntries: [], renderChildBlock: function (childProps, childBlockDef) {
                    if (childBlockDef) {
    ...
    WidgetBlock.prototype.renderInstance = function (instanceCtx) {
        ...
        if (widgetDef && widgetDef.blockDef) {
            var innerBlock = instanceCtx.createBlock(widgetDef.blockDef);
            var innerInstanceCtx = __assign(__assign({}, instanceCtx), { 
                ...
                contextVars: widgetDef.contextVars.concat(instanceCtx.globalContextVars || []).concat(instanceCtx.contextVars), contextVarValues: __assign(__assign({}, instanceCtx.contextVarValues), mappedContextVarValues), getContextVarExprValue: function (contextVarId, expr) {
                    // Lookup outer id
