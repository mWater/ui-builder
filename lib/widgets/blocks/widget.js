...
var WidgetBlock = /** @class */ (function (_super) {
        ...
        return exports.mapObjectTree(expr, function (e) {
            if (e.type === "variable") {
                ...
                if (_this.blockDef.contextVarMap[e.variableId]) {
                    return __assign({}, e, { variableId: _this.blockDef.contextVarMap[e.variableId] });
                }
                else {
                    return e;
                }
    ...
    WidgetBlock.prototype.renderInstance = function (props) {
        ...
        if (widgetDef && widgetDef.blockDef) {
            var innerBlock = this.createBlock(widgetDef.blockDef);
            var innerProps = __assign({}, props, { contextVars: props.contextVars.concat(widgetDef.contextVars), contextVarValues: __assign({}, props.contextVarValues, mappedContextVarValues), getContextVarExprValue: function (contextVarId, expr) {
                    // Lookup outer id
    ...
    WidgetBlock.prototype.renderEditor = function (props) {
        ...
        var handleWidgetIdChange = function (widgetId) {
            props.onChange(__assign({}, _this.blockDef, { widgetId: widgetId, contextVarMap: {} }));
        };
