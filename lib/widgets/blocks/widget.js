...
export class WidgetBlock extends LeafBlock {
    ...
    renderEditor(props) {
        ...
        const handleWidgetIdChange = (widgetId) => {
            props.onChange(Object.assign({}, this.blockDef, { widgetId: widgetId, contextVarValues: {} }));
        };
                ...
                React.createElement("tbody", null, widgetDef.contextVars.map(contextVar => {
                    ...
                    return (React.createElement("tr", { key: contextVar.id },
                        ...
                        React.createElement("td", null,
                            React.createElement(ContextVarPropertyEditor, { contextVars: props.contextVars, types: [contextVar.type], table: contextVar.table, value: cvr ? cvr.contextVarId : null, onChange: handleCVChange }))));
                }))));
        };
        return React.createElement("div", null,
