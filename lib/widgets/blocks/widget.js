...
var WidgetBlock = /** @class */ (function (_super) {
    ...
    WidgetBlock.prototype.renderInstance = function (instanceCtx) {
        ...
        if (widgetDef && widgetDef.blockDef) {
            var innerBlock = instanceCtx.createBlock(widgetDef.blockDef);
            var innerInstanceCtx = __assign(__assign({}, instanceCtx), { contextVars: widgetDef.contextVars.concat(instanceCtx.globalContextVars || []), contextVarValues: mappedContextVarValues, getContextVarExprValue: function (contextVarId, expr) {
                    // Lookup outer id
