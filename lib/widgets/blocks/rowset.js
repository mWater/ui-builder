    ...
    renderEditor(props) {
        const handleTableChange = (tableId) => {
            ...
            props.store.replaceBlock((0, immer_1.default)(this.blockDef, (bd) => {
                bd.table = tableId;
                bd.name = bd.name || "List of " + (0, localization_1.localize)(table.name);
            }));
        };
        return (React.createElement("div", null,
            ...
            this.blockDef.table ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Filter" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "filter" }, (value, onChange) => (React.createElement(mwater_expressions_ui_1.FilterExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, table: this.blockDef.table, variables: (0, blocks_1.createExprVariables)(props.contextVars) }))))) : null));
    }
}
