...
var RowsetBlock = /** @class */ (function (_super) {
    ...
    RowsetBlock.prototype.renderInstance = function (props) {
        ...
        return React.createElement(ContextVarsInjector_1.default, { injectedContextVars: [contextVar], injectedContextVarValues: (_a = {}, _a[contextVar.id] = this.blockDef.filter, _a), innerBlock: this.blockDef.content, instanceCtx: props }, function (instanceCtx, loading, refreshing) {
            if (loading) {
            ...
            return (React.createElement("div", { style: { opacity: refreshing ? 0.6 : undefined } }, props.renderChildBlock(instanceCtx, _this.blockDef.content)));
        });
    };
    RowsetBlock.prototype.renderEditor = function (props) {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Name" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "name" }, function (value, onChange) { return React.createElement(bootstrap_1.TextInput, { value: value, onChange: onChange, placeholder: "Unnamed" }); })),
            this.blockDef.table ?
