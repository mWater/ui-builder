    ...
    ValidationBlock.prototype.renderEditor = function (props) {
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Validations" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "validations" }, function (validations, onValidationsChange) {
...
var ValidationEditor = function (props) {
    ...
    return (react_1.default.createElement("div", null,
        ...
        contextVar && contextVar.table ?
            react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Condition that must be true" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: props.validation, onChange: props.onValidationsChange, property: "condition" }, function (value, onChange) {
                    return react_1.default.createElement(mwater_expressions_ui_1.ExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, types: ["boolean"], variables: blocks_1.createExprVariables(props.contextVars), table: contextVar.table });
                }))
            : null,
...
var ValidationBlockInstance = function (props) {
    ...
    return react_1.default.createElement("div", { className: "alert alert-danger" }, errors.map(function (e) { return react_1.default.createElement("div", null,
