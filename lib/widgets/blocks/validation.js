...
var ValidationBlock = /** @class */ (function (_super) {
    ...
    ValidationBlock.prototype.renderInstance = function (props) {
        return React.createElement(ValidationBlockInstance, { renderProps: props, blockDef: this.blockDef });
    };
    ValidationBlock.prototype.renderEditor = function (props) {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Validations" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "validations" }, function (validations, onValidationsChange) {
                    return React.createElement(ListEditor_1.default, { items: validations, onItemsChange: onValidationsChange }, function (validation, onValidationChange) {
                        return React.createElement(ValidationEditor, { validation: validation, onValidationsChange: onValidationChange, contextVars: props.contextVars, schema: props.schema, dataSource: props.dataSource, locale: props.locale });
                    });
                }),
                React.createElement("button", { type: "button", className: "btn btn-link btn-sm", onClick: handleAdd },
...
var ValidationEditor = function (props) {
    ...
    return (React.createElement("div", null,
        React.createElement(propertyEditors_1.LabeledProperty, { label: "Row/Rowset Variable" },
            React.createElement(propertyEditors_1.PropertyEditor, { obj: props.validation, onChange: props.onValidationsChange, property: "contextVarId" }, function (value, onChange) { return React.createElement(propertyEditors_1.ContextVarPropertyEditor, { value: value, onChange: onChange, contextVars: props.contextVars, types: ["row", "rowset"] }); })),
        contextVar && contextVar.table ?
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Condition that must be true" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: props.validation, onChange: props.onValidationsChange, property: "condition" }, function (value, onChange) {
                    return React.createElement(mwater_expressions_ui_1.ExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, types: ["boolean"], variables: blocks_1.createExprVariables(props.contextVars), table: contextVar.table });
                }))
            : null,
        React.createElement(propertyEditors_1.LabeledProperty, { label: "Error Message" },
            React.createElement(propertyEditors_1.PropertyEditor, { obj: props.validation, onChange: props.onValidationsChange, property: "message" }, function (value, onChange) {
...
var ValidationBlockInstance = function (props) {
    // True if validating
    var _a = react_1.useState(false), validating = _a[0], setValidating = _a[1];
    ...
    return React.createElement("div", { className: "alert alert-danger" }, errors.map(function (e) { return React.createElement("div", null,
