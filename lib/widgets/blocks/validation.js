...
const ValidationEditor = (props) => {
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Condition that must be true" },
            react_1.default.createElement(propertyEditors_1.ContextVarAndExprPropertyEditor, { contextVars: props.contextVars, schema: props.schema, dataSource: props.dataSource, aggrStatuses: ["individual", "aggregate", "literal"], types: ["boolean"], contextVarId: props.validation.contextVarId, expr: props.validation.condition, onChange: (contextVarId, condition) => {
                    props.onValidationChange(Object.assign(Object.assign({}, props.validation), { contextVarId, condition }));
                } })),
        react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Error Message", hint: "Shown if condition is *not* true" },
...
const getValidationErrors = (blockDef, renderProps) => {
    ...
    for (const validation of blockDef.validations) {
        ...
        if (value !== true) {
            errors.push((0, localization_1.localize)(validation.message, renderProps.locale));
        }
    }
    return errors;
};
const ValidationBlockInstance = (props) => {
    // True if validating
    const [validating, setValidating] = (0, react_1.useState)(props.blockDef.immediate || false);
