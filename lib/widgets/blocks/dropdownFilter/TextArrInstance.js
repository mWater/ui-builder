...
class TextArrInstance extends react_1.default.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement(async_1.default, { placeholder: (0, localization_1.localize)(this.props.blockDef.placeholder, this.props.locale), value: currentValue, defaultOptions: true, loadOptions: this.getOptions, onChange: this.handleChange, isClearable: true, noOptionsMessage: noOptionsMessage, styles: styles, classNamePrefix: "react-select-short", menuPortalTarget: document.body }));
    }
}
