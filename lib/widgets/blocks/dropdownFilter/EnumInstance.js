...
var EnumInstance = /** @class */ (function (_super) {
    ...
    EnumInstance.prototype.render = function () {
        ...
        var minWidth = Math.min(300, Math.max(enumValue ? getOptionLabel(enumValue).length * 8 + 90 : 0, 150));
        var styles = __assign(__assign({}, dropdownStyles), { control: function (style) { return (__assign(__assign({}, style), { minHeight: 34, height: 34, minWidth: minWidth })); } });
