...
class EnumInstance extends react_1.default.Component {
    render() {
        const enumValues = this.props.blockDef.filterExpr ? new mwater_expressions_1.ExprUtils(this.props.schema, (0, blocks_1.createExprVariables)(this.props.contextVars)).getExprEnumValues(this.props.blockDef.filterExpr) : null;
        ...
        return react_1.default.createElement(react_select_1.default, { value: enumValue, onChange: handleChange, options: enumValues || undefined, placeholder: (0, localization_1.localize)(this.props.blockDef.placeholder, this.props.locale), getOptionLabel: getOptionLabel, getOptionValue: getOptionValue, isClearable: true, styles: styles, closeMenuOnScroll: true, menuPortalTarget: document.body, classNamePrefix: "react-select-short" });
    }
}
