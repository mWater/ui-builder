...
var TextInstance = /** @class */ (function (_super) {
    ...
    TextInstance.prototype.render = function () {
        ...
        var styles = {
            control: function (base) { return (__assign({}, base, { height: 34, minHeight: 34, minWidth: 150 })); }
        };
        // TODO key: JSON.stringify(@props.filters)  # Include to force a change when filters change
        return react_1.default.createElement(Async_1.default, { placeholder: localization_1.localize(this.props.blockDef.placeholder, this.props.locale), value: currentValue, defaultOptions: false, cacheOptions: null, loadOptions: this.getOptions, onChange: this.handleChange, isClearable: true, noOptionsMessage: noOptionsMessage, styles: styles });
        // styles: { 
