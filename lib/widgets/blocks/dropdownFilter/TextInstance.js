...
function TextInstance(props) {
    const getOptions = stabilizingHooks_1.useStabilizeFunction((input) => __awaiter(this, void 0, void 0, function* () {
    ...
    const handleChange = stabilizingHooks_1.useStabilizeFunction((option) => {
    ...
    const noOptionsMessage = react_1.useCallback(() => "Type to search", []);
    ...
    return react_1.default.createElement(MemoAsync, { placeholder: localization_1.localize(props.blockDef.placeholder, props.locale), value: currentValue, defaultOptions: true, loadOptions: getOptions, onChange: handleChange, isClearable: true, noOptionsMessage: noOptionsMessage, styles: styles });
}
exports.default = TextInstance;
const MemoAsync = react_1.memo((props) => {
