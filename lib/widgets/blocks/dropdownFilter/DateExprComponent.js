...
exports.toExpr = function (table, expr, datetime, value) {
    if (!value) {
        return null;
    }
...
var DateExprComponent = /** @class */ (function (_super) {
    ...
    function DateExprComponent(props) {
        ...
        _this.handleStartChange = function (value) {
            // Clear end if after
            if (_.isArray(_this.props.value) && _this.props.value[1] && _this.fromMoment(value) > _this.props.value[1]) {
                _this.props.onChange([_this.fromMoment(value), null]);
            }
            else {
                _this.props.onChange([_this.fromMoment(value), _.isArray(_this.props.value) ? _this.props.value[1] : null]);
            }
        };
        _this.handleEndChange = function (value) {
            ...
            if (_.isArray(_this.props.value) && _this.props.value[0] && _this.fromMoment(value) < _this.props.value[0]) {
                _this.props.onChange([null, _this.fromMoment(value)]);
            }
            else {
                _this.props.onChange([_.isArray(_this.props.value) ? _this.props.value[0] : null, _this.fromMoment(value)]);
            }
            _this.setState({ dropdownOpen: false });
        };
            ...
            react_1.default.createElement("ul", { className: "nav nav-pills nav-stacked" },
                presets.map(function (preset) {
                    return (react_1.default.createElement("li", { key: preset.id },
                        react_1.default.createElement("a", { style: { padding: 5 }, onClick: _this.handlePreset.bind(null, preset) }, preset.name)));
                }),
    ...
    DateExprComponent.prototype.renderCustomDropdown = function () {
        var startDate = this.toMoment(_.isArray(this.props.value) ? this.props.value[0] : null) || undefined;
        var endDate = this.toMoment(_.isArray(this.props.value) ? this.props.value[1] : null) || undefined;
        return (react_1.default.createElement("div", { style: { position: "absolute", top: "100%", left: 0, zIndex: 4000, padding: 5, border: "solid 1px #AAA", backgroundColor: "white", borderRadius: 4 } },
