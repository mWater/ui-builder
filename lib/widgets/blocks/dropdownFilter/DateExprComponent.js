...
class DateExprComponent extends react_1.default.Component {
    ...
    renderPresets() {
        return (react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement("ul", { className: "nav nav-pills nav-justified" },
                presets.map((preset) => {
                    return (react_1.default.createElement("li", { key: preset.id, className: "nav-item" },
                        react_1.default.createElement("a", { className: "nav-link", style: { padding: 5 }, onClick: this.handlePreset.bind(null, preset) }, (0, localization_1.localize)(preset.name, this.props.locale))));
                }),
                react_1.default.createElement("li", { className: "nav-item" },
                    react_1.default.createElement("a", { className: "nav-link", style: { padding: 5 }, onClick: this.handleCustom }, (0, localization_1.localize)({
                        _base: "en",
    ...
    render() {
        return (react_1.default.createElement(react_onclickout_1.default, { onClickOut: this.handleClickOut },
            react_1.default.createElement("div", { style: { display: "inline-block", position: "relative" } },
                react_1.default.createElement("div", { style: { width: 220, height: 34 }, onClick: this.handleOpen }, this.renderSummary()),
