...
var DateExprComponent = /** @class */ (function (_super) {
    ...
    function DateExprComponent(props) {
        ...
        _this.handleStartChange = function (dateValue) {
            var value = moment_1.default(dateValue);
            // Clear end if after
        ...
        _this.handleEndChange = function (dateValue) {
            var value = moment_1.default(dateValue);
    ...
    DateExprComponent.prototype.toDate = function (value) {
        if (!value) {
            return null;
        }
        if (this.props.datetime) {
            return moment_1.default(value, moment_1.default.ISO_8601).toDate();
        }
        else {
            return moment_1.default(value, "YYYY-MM-DD").toDate();
        }
    };
    ...
    DateExprComponent.prototype.renderCustomDropdown = function () {
        var startDate = this.toDate(lodash_1.default.isArray(this.props.value) ? this.props.value[0] : null) || undefined;
        var endDate = this.toDate(lodash_1.default.isArray(this.props.value) ? this.props.value[1] : null) || undefined;
        return (react_1.default.createElement("div", { style: { position: "absolute", top: "100%", left: 0, zIndex: 4000, padding: 5, border: "solid 1px #AAA", backgroundColor: "white", borderRadius: 4 } },
