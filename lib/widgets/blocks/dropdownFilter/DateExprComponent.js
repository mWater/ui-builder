...
exports.createDateFilterExpr = (table, expr, datetime, value) => {
    if (!value) {
        return null;
    }
            ...
            react_1.default.createElement("ul", { className: "nav nav-pills nav-stacked" },
                presets.map(preset => {
                    return (react_1.default.createElement("li", { key: preset.id },
                        react_1.default.createElement("a", { style: { padding: 5 }, onClick: this.handlePreset.bind(null, preset) }, localization_1.localize(preset.name, this.props.locale))));
                }),
