...
var DropdownFilterBlock = /** @class */ (function (_super) {
    ...
    DropdownFilterBlock.prototype.renderDesign = function (props) {
        var styles = {
            control: function (base) { return (__assign({}, base, { height: 34, minHeight: 34 })); }
        };
        ...
        return (React.createElement("div", null,
            ...
            rowsetCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Filter expression" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "filterExpr" }, function (expr, onExprChange) { return (React.createElement(mwater_expressions_ui_1.ExprComponent, { value: expr, schema: props.schema, dataSource: props.dataSource, onChange: onExprChange, table: rowsetCV.table, types: ["enum", "text", "date", "datetime"] })); }))
                : null,
