...
class DropdownFilterBlock extends LeafBlock_1.default {
    validate(options) {
        ...
        const exprUtils = new mwater_expressions_1.ExprUtils(options.schema, blocks_1.createExprVariables(options.contextVars));
    ...
    renderInstance(ctx) {
        ...
        const exprUtils = new mwater_expressions_1.ExprUtils(ctx.schema, blocks_1.createExprVariables(ctx.contextVars));
        const valueType = exprUtils.getExprType(this.blockDef.filterExpr);
        const placeholder = localization_1.localize(this.blockDef.placeholder, ctx.locale);
        let elem;
        switch (valueType) {
            case "enum":
    ...
    renderEditor(ctx) {
        ...
        const handleExprChange = (expr) => {
            ctx.store.replaceBlock(immer_1.default(this.blockDef, (draft) => {
        ...
        return (React.createElement("div", null,
            ...
            rowsetCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Filter expression" },
                    React.createElement(mwater_expressions_ui_1.ExprComponent, { value: this.blockDef.filterExpr, schema: ctx.schema, dataSource: ctx.dataSource, onChange: handleExprChange, table: rowsetCV.table, variables: blocks_1.createExprVariables(ctx.contextVars), types: ["enum", "enumset", "text", "date", "datetime", "id", "text[]"] }))
                : null,
            ...
            isIdType && idMode == "simple" ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Label Expression", key: "idLabelExpr" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: ctx.store.replaceBlock, property: "idLabelExpr" }, (value, onChange) => React.createElement(mwater_expressions_ui_1.ExprComponent, { value: value || null, onChange: onChange, schema: ctx.schema, dataSource: ctx.dataSource, types: ["text"], table: idTableId })))
                : null,
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(propertyEditors_1.LabeledProperty, { label: "Search expressions", key: "idSearchExprs" },
                        React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: ctx.store.replaceBlock, property: "idSearchExprs" }, (value, onItemsChange) => {
                            ...
                            return (React.createElement("div", null,
                                React.createElement(ListEditor_1.default, { items: value || [], onItemsChange: onItemsChange }, (expr, onExprChange) => (React.createElement(mwater_expressions_ui_1.ExprComponent, { value: expr, schema: ctx.schema, dataSource: ctx.dataSource, onChange: onExprChange, table: idTableId, types: ["text", "enum", "enumset"], variables: blocks_1.createExprVariables(ctx.contextVars) }))),
            ...
            isIdType ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Filter expression for id table", key: "idFilterExpr" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: ctx.store.replaceBlock, property: "idFilterExpr" }, (value, onChange) => React.createElement(mwater_expressions_ui_1.FilterExprComponent, { value: value, onChange: onChange, schema: ctx.schema, dataSource: ctx.dataSource, table: idTableId })))
                : null,
                        ...
                        return (React.createElement("div", null,
                            React.createElement(ListEditor_1.default, { items: value || [], onItemsChange: onItemsChange }, (extraFilter, onExtraFilterChange) => {
                                ...
                                return React.createElement("div", null,
                                    ...
                                    extraFilterCV ?
                                        React.createElement(propertyEditors_1.LabeledProperty, { label: "Filter expression" },
                                            React.createElement(propertyEditors_1.PropertyEditor, { obj: extraFilter, onChange: onExtraFilterChange, property: "filterExpr" }, (value, onChange) => React.createElement(mwater_expressions_ui_1.ExprComponent, { value: value, schema: ctx.schema, dataSource: ctx.dataSource, onChange: onChange, table: extraFilterCV.table, types: ["enum", "enumset", "text", "date", "datetime", "id"] })))
                                        : null);
                            }),
