...
var DropdownFilterBlock = /** @class */ (function (_super) {
    ...
    DropdownFilterBlock.prototype.renderDesign = function (props) {
        ...
        var styles = {
            control: function (base) { return (__assign(__assign({}, base), { height: 40, minHeight: 40, minWidth: 150 })); },
        ...
        return (React.createElement("div", null,
            ...
            rowsetCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Filter expression" },
                    React.createElement(mwater_expressions_ui_1.ExprComponent, { value: this.blockDef.filterExpr, schema: props.schema, dataSource: props.dataSource, onChange: handleExprChange, table: rowsetCV.table, types: ["enum", "enumset", "text", "date", "datetime"] }))
                : null,
