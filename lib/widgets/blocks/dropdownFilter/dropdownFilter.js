    ...
    DropdownFilterBlock.prototype.renderDesign = function (props) {
        ...
        if (valueType === "date" || valueType === "datetime") {
            ...
            return (React.createElement("div", { style: { padding: 5 } },
                React.createElement(DateExprComponent_1.default, { table: table, datetime: valueType === "datetime", value: this.blockDef.defaultValue, onChange: handleSetDefault, placeholder: placeholder })));
        }
        return React.createElement("div", { style: { padding: 5 } },
