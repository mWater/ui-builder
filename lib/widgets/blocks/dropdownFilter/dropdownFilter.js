        ...
        return (React.createElement("div", null,
            ...
            rowsetCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Filter expression" },
                    React.createElement(mwater_expressions_ui_1.ExprComponent, { value: this.blockDef.filterExpr, schema: ctx.schema, dataSource: ctx.dataSource, onChange: handleExprChange, table: rowsetCV.table, variables: (0, blocks_1.createExprVariables)(ctx.contextVars), types: ["enum", "enumset", "text", "date", "datetime", "id", "text[]"] }))
                : null,
