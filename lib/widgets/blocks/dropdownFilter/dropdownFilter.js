...
export class DropdownFilterBlock extends LeafBlock {
    ...
    renderDesign(props) {
        ...
        return React.createElement(ReactSelect, { styles: styles });
    }
    renderInstance(props) {
        ...
        switch (valueType) {
            case "enum":
                return React.createElement(EnumInstance, { blockDef: this.blockDef, schema: props.schema, contextVars: props.contextVars, value: value, onChange: handleChange, locale: props.locale });
            case "text":
                return React.createElement(TextInstance, { blockDef: this.blockDef, schema: props.schema, contextVars: props.contextVars, value: value, database: props.database, onChange: handleChange, locale: props.locale });
        }
