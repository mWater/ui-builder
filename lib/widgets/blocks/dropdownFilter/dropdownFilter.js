    ...
    renderDesign(props) {
        ...
        if (valueType === "date" || valueType === "datetime") {
            ...
            return (React.createElement("div", { style: { padding: 5 } },
                React.createElement(DateExprComponent, { table: "", datetime: valueType === "datetime", value: null, onChange: doNothing, placeholder: placeholder })));
        }
        return React.createElement("div", { style: { padding: 5 } },
    ...
    renderInstance(props) {
        ...
        switch (valueType) {
            ...
            case "text":
                ...
                break;
            case "date":
                elem = React.createElement(DateExprComponent, { datetime: false, table: contextVar.table, value: value, onChange: handleChange, placeholder: placeholder });
                break;
            case "datetime":
                elem = React.createElement(DateExprComponent, { datetime: true, table: contextVar.table, value: value, onChange: handleChange, placeholder: placeholder });
                break;
            default:
        ...
        return (React.createElement("div", null,
            ...
            rowsetCV ?
                React.createElement(LabeledProperty, { label: "Filter expression" },
                    React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "filterExpr" }, (expr, onExprChange) => (React.createElement(ExprComponent, { value: expr, schema: props.schema, dataSource: props.dataSource, onChange: onExprChange, table: rowsetCV.table, types: ["enum", "text", "date", "datetime"] }))))
                : null,
