...
var DropdownFilterBlock = /** @class */ (function (_super) {
    ...
    DropdownFilterBlock.prototype.createFilter = function (rowsetContextVarId, filterExpr, schema, contextVars, value) {
        ...
        switch (valueType) {
            ...
            case "date":
                return {
                    id: this.blockDef.id,
                    expr: DateExprComponent_1.toExpr(table, filterExpr, false, value),
                    memo: value
                };
            case "datetime":
                return {
                    id: this.blockDef.id,
                    expr: DateExprComponent_1.toExpr(table, filterExpr, true, value),
                    memo: value
                };
            case "id":
                return {
    ...
    DropdownFilterBlock.prototype.renderDesign = function (props) {
        ...
        return React.createElement("div", { style: { padding: 5 } },
            React.createElement(react_select_1.default, { styles: styles, placeholder: placeholder }));
    };
    ...
    DropdownFilterBlock.prototype.renderEditor = function (ctx) {
        ...
        var isIdType = rowsetCV ? rowsetCV.type == "rowset" : false;
        var idMode = this.blockDef.idMode || "simple";
