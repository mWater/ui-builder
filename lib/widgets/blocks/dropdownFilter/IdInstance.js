...
exports.IdInstance = (props) => {
    ...
    const contextVars = stabilizingHooks_1.useStabilizeValue(props.ctx.contextVars);
    const contextVarValues = stabilizingHooks_1.useStabilizeValue(props.ctx.contextVarValues);
