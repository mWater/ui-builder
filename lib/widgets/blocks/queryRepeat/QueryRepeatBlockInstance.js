...
var QueryRepeatBlockInstance = /** @class */ (function (_super) {
    ...
    QueryRepeatBlockInstance.prototype.renderRow = function (row, rowIndex) {
        var orientation = this.props.block.blockDef.orientation || "vertical";
        var horizontalSpacing = this.props.block.blockDef.horizontalSpacing != null ? this.props.block.blockDef.horizontalSpacing : 5;
