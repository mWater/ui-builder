...
var QueryRepeatBlockInstance = /** @class */ (function (_super) {
    ...
    QueryRepeatBlockInstance.prototype.createRowRenderInstanceProps = function (rowIndex) {
        var _a;
        var _this = this;
        var rips = this.props.renderInstanceProps;
    ...
    QueryRepeatBlockInstance.prototype.renderRows = function () {
        ...
        if (this.state.rows.length === 0 && this.props.block.blockDef.noRowsMessage) {
            return React.createElement("div", { style: { fontStyle: "italic" } }, localization_1.localize(this.props.block.blockDef.noRowsMessage, this.props.renderInstanceProps.locale));
        }
