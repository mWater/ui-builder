...
var qtb = new queryRepeat_1.QueryRepeatBlock(qrbd, createBlock);
var rips;
var database;
beforeEach(function () {
...
test("creates query", function () {
    ...
    var inst = enzyme_1.mount(React.createElement(QueryRepeatBlockInstance_1.default, { block: qtb, instanceCtx: rips }));
...
test("adds filters, orderBy and where", function () {
    ...
    var qtb = createBlock(__assign(__assign({}, qrbd), { where: { type: "literal", valueType: "boolean", value: false }, orderBy: [
...
test("injects context variables", function () {
    ...
    var rowRips = inst.instance().createRowInstanceCtx(0);
