...
test("creates query", () => {
    ...
    const inst = enzyme_1.mount(React.createElement(QueryRepeatBlockInstance_1.default, { block: qtb, instanceCtx: rips }));
...
test("adds filters, orderBy and where", () => {
    ...
    const qtb = createBlock(Object.assign(Object.assign({}, qrbd), { where: { type: "literal", valueType: "boolean", value: false }, orderBy: [
