...
var QueryRepeatBlock = /** @class */ (function (_super) {
    ...
    QueryRepeatBlock.prototype.getRowExprs = function (contextVars, widgetLibrary, actionLibrary) {
        var _this = this;
        ...
        if (this.blockDef.content) {
            exprs = exprs.concat(this.createBlock(this.blockDef.content).getSubtreeContextVarExprs({
    ...
    QueryRepeatBlock.prototype.getContextVarExprs = function (contextVar, widgetLibrary, actionLibrary) {
        return [];
    };
    /**
    ...
    QueryRepeatBlock.prototype.renderInstance = function (props) {
        return React.createElement(QueryRepeatBlockInstance_1.default, { block: this, renderInstanceProps: props });
    };
    QueryRepeatBlock.prototype.renderEditor = function (props) {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Separator" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "separator" }, function (value, onChange) { return React.createElement(bootstrap_1.Select, { value: value, onChange: onChange, options: separatorOptions }); })),
            rowsetCV ?
