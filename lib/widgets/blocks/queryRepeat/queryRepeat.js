    ...
    renderEditor(props) {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Repeat direction" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "orientation" }, (value, onChange) => (React.createElement(bootstrap_1.Toggle, { value: value || "vertical", onChange: onChange, options: [
                        { value: "vertical", label: "Vertical" },
                        { value: "horizontal", label: "Horizontal" }
                    ] })))),
            (this.blockDef.orientation || "vertical") == "vertical" ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Separator" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "separator" }, (value, onChange) => React.createElement(bootstrap_1.Select, { value: value, onChange: onChange, options: separatorOptions })))) : (React.createElement(propertyEditors_1.LabeledProperty, { label: "Spacing" },
