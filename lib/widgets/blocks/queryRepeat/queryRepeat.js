...
var QueryRepeatBlock = /** @class */ (function (_super) {
    ...
    QueryRepeatBlock.prototype.getRowExprs = function (contextVars, ctx) {
        ...
        if (this.blockDef.content) {
            exprs = exprs.concat(ctx.createBlock(this.blockDef.content).getSubtreeContextVarExprs(rowCV, __assign(__assign({}, ctx), { contextVars: contextVars.concat([rowCV]) })));
        }
        return exprs;
    };
    ...
    QueryRepeatBlock.prototype.renderEditor = function (props) {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Repeat direction" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "orientation" }, function (value, onChange) { return React.createElement(bootstrap_1.Toggle, { value: value || "vertical", onChange: onChange, options: [{ value: "vertical", label: "Vertical" }, { value: "horizontal", label: "Horizontal" }] }); })),
            (this.blockDef.orientation || "vertical") == "vertical" ?
                ...
                :
                    React.createElement(propertyEditors_1.LabeledProperty, { label: "Spacing" },
                        React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "horizontalSpacing" }, function (value, onChange) { return React.createElement(bootstrap_1.Select, { value: value != null ? value : 5, onChange: onChange, options: horizontalSpacingOptions }); })),
            rowsetCV ?
