...
var AddRowBlock = /** @class */ (function (_super) {
    ...
    AddRowBlock.prototype.renderDesign = function (props) {
        ...
        if (contextVar) {
            contentProps = __assign({}, contentProps, { contextVars: props.contextVars.concat([contextVar]) });
        }
    ...
    AddRowBlock.prototype.renderEditor = function (props) {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Table" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "table" }, function (value, onChange) {
            ...
            this.blockDef.table ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Column Values" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "columnValues" }, function (value, onChange) {
...
var AddRowInstance = /** @class */ (function (_super) {
    ...
    AddRowInstance.prototype.performAdd = function () {
        return __awaiter(this, void 0, void 0, function () {
            var row, _i, _a, columnId, contextVarExpr, txn, addedRowId;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        txn = this.props.database.transaction();
    ...
    AddRowInstance.prototype.render = function () {
        ...
        return React.createElement(ContextVarsInjector_1.default, { injectedContextVars: [this.props.contextVar], injectedContextVarValues: (_a = {}, _a[this.props.contextVar.id] = this.state.addedRowId, _a), createBlock: this.props.createBlock, database: this.props.database, innerBlock: this.props.blockDef.content, renderInstanceProps: this.props.renderInstanceProps, schema: this.props.schema }, function (renderInstanceProps, loading, refreshing) {
            if (loading) {
                return React.createElement("div", { style: { color: "#AAA", fontSize: 18, textAlign: "center" } },
                    React.createElement("i", { className: "fa fa-circle-o-notch fa-spin" }));
            }
            return (React.createElement("div", { style: { opacity: refreshing ? 0.6 : undefined } }, _this.props.renderInstanceProps.renderChildBlock(renderInstanceProps, _this.props.blockDef.content)));
        });
    };
