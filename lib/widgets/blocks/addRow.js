            ...
            this.blockDef.table ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Mode" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "existingContextVarId" }, (value, onChange) => React.createElement("div", null,
                        ...
                        props.contextVars.filter(cv => cv.table == this.blockDef.table && cv.type == "row").map(cv => (React.createElement(bootstrap_1.Radio, { key: cv.id, radioValue: cv.id, value: value, onChange: onChange },
                            "Use ",
    ...
    render() {
        if (this.doesNeedAdd()) {
            ...
            return React.createElement(ContextVarsInjector_1.default, { injectedContextVars: injectedContextVars, injectedContextVarValues: injectedContextVarValues, innerBlock: this.props.blockDef.content, instanceCtx: this.props.instanceCtx }, (instanceCtx, loading, refreshing) => {
                ...
                return (React.createElement("div", { style: { opacity: refreshing ? 0.6 : undefined } }, this.props.instanceCtx.renderChildBlock(instanceCtx, this.props.blockDef.content)));
            });
        }
        else {
