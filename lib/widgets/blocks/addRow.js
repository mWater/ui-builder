...
var AddRowInstance = /** @class */ (function (_super) {
    ...
    AddRowInstance.prototype.render = function () {
        ...
        if (this.doesNeedAdd()) {
            ...
            // Re-inject all context variables if reusing, as a variable value may have changed (if the row was added)
            ...
            var injectedContextVars = [];
            var injectedContextVarValues = {};
            if (this.props.blockDef.existingContextVarId) {
                injectedContextVars = this.props.instanceCtx.contextVars;
                injectedContextVarValues = __assign(__assign({}, this.props.instanceCtx.contextVarValues), (_a = {}, _a[this.props.contextVar.id] = this.state.addedRowId, _a));
            }
            else {
            ...
            return React.createElement(ContextVarsInjector_1.default, { injectedContextVars: injectedContextVars, injectedContextVarValues: injectedContextVarValues, innerBlock: this.props.blockDef.content, instanceCtx: this.props.instanceCtx }, function (instanceCtx, loading, refreshing) {
                if (loading) {
                    return React.createElement("div", { style: { color: "#AAA", textAlign: "center" } },
                        React.createElement("i", { className: "fa fa-circle-o-notch fa-spin" }));
                }
