...
const ExecutePrintInstance = (props) => {
    ...
    const pendingQueriesRef = (0, react_1.useRef)(0);
    /** Keep track of number of total queries */
    const totalQueriesRef = (0, react_1.useRef)(0);
    /** Query status string */
    const [statusString, setStatusString] = (0, react_1.useState)("");
    /** Create tracking database and data source to make context that tracks query requests */
    const printCtx = (0, react_1.useMemo)(() => {
        const onStartQuery = () => {
        ...
        return Object.assign(Object.assign({}, props.ctx), { database: new TrackingDatabase(props.ctx.database, onStartQuery, onEndQuery), dataSource: props.ctx.dataSource ? new TrackingDataSource(props.ctx.dataSource, onStartQuery, onEndQuery) : undefined });
    }, []);
    // Create printable element
    const printElem = (0, react_1.useMemo)(() => {
            ...
            React.createElement("div", { style: { fontSize: 30, width: "50%" } },
                React.createElement("div", { className: "progress" },
                    React.createElement("div", { className: "progress-bar progress-bar-striped active", role: "progressbar", style: { width: "100%" } },
                        ...
                        "\u00A0\u00A0",
                        statusString)))));
    return (0, react_dom_1.createPortal)(printFragment, document.body);
};
