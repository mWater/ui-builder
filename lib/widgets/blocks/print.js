...
const ExecutePrintInstance = (props) => {
    ...
    const printCtx = (0, react_1.useMemo)(() => {
        ...
        return Object.assign(Object.assign({}, props.ctx), { database: new TrackingDatabase(props.ctx.database, onStartQuery, onEndQuery), dataSource: props.ctx.dataSource
                ? new TrackingDataSource(props.ctx.dataSource, onStartQuery, onEndQuery)
                : undefined });
    }, []);
