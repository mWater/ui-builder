...
test("creates query", function () {
    ...
    var inst = enzyme_1.mount(React.createElement(QueryTableBlockInstance_1.default, { block: qtbSingle, instanceCtx: rips }));
...
test("adds filters, orderBy and where", function () {
    ...
    var inst = enzyme_1.mount(React.createElement(QueryTableBlockInstance_1.default, { block: qtb, instanceCtx: rips }));
    var queryOptions = database.query.mock.calls[0][0];
    expect(queryOptions).toEqual({
        select: {
            id: { type: "id", table: "t1" },
