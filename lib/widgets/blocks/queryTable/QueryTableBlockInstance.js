...
export default class QueryTableBlockInstance extends React.Component {
    ...
    renderRows() {
        ...
        if (this.state.rows.length === 0 && this.props.block.blockDef.noRowsMessage) {
            return (React.createElement("tr", null,
                React.createElement("td", { colSpan: this.props.block.blockDef.contents.length, style: { fontStyle: "italic" } }, localize(this.props.block.blockDef.noRowsMessage, this.props.renderInstanceProps.locale))));
        }
