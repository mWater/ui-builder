...
class QueryTableBlockInstance extends React.Component {
    ...
    performQuery() {
        ...
        this.props.instanceCtx.database.query(queryOptions, this.props.instanceCtx.contextVars, contexts_1.getFilteredContextVarValues(this.props.instanceCtx)).then(rows => {
    ...
    createRowInstanceCtx(rowIndex) {
        ...
        const cvvalue = this.props.block.getRowContextVarValue(this.state.rows[rowIndex], rowExprs, this.props.instanceCtx.schema, rowsetCV, innerContextVars, contexts_1.getFilteredContextVarValues(this.props.instanceCtx)[rowsetCV.id]);
            ...
            React.createElement("table", { className: className, style: tableStyle },
                ...
                !blockDef.hideHeaders ?
                    React.createElement("thead", null,
                        React.createElement("tr", { key: "header" }, blockDef.headers.map((b, index) => this.renderHeader(b, index))))
                    : null,
                ...
                blockDef.footers ?
                    React.createElement("tfoot", null,
                        React.createElement("tr", null, blockDef.footers.map((b, index) => React.createElement("td", { key: index }, this.props.instanceCtx.renderChildBlock(this.props.instanceCtx, b)))))
                    : null)));
    }
}
