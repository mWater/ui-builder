...
class QueryTableBlockInstance extends React.Component {
    ...
    performQuery() {
        ...
        this.props.instanceCtx.database.query(queryOptions, this.props.instanceCtx.contextVars, (0, contexts_1.getFilteredContextVarValues)(this.props.instanceCtx)).then(rows => {
