...
var QueryTableBlockInstance = /** @class */ (function (_super) {
    ...
    QueryTableBlockInstance.prototype.createRowRenderInstanceProps = function (rowIndex) {
        ...
        return __assign({}, rips, { contextVars: innerContextVars, contextVarValues: __assign({}, rips.contextVarValues, (_a = {}, _a[rowcv.id] = cvvalue, _a)), getContextVarExprValue: function (cvid, expr) {
                if (cvid !== rowcv.id) {
    ...
    QueryTableBlockInstance.prototype.renderRow = function (row, rowIndex) {
        ...
        return (React.createElement("tr", { key: rowIndex }, this.props.block.blockDef.contents.map(function (b, colIndex) {
    ...
    QueryTableBlockInstance.prototype.render = function () {
        ...
        return (React.createElement("table", { className: className, style: style },
            React.createElement("thead", null,
                React.createElement("tr", null, this.props.block.blockDef.headers.map(function (b, index) {
