...
var QueryTableBlockInstance = /** @class */ (function (_super) {
    ...
    QueryTableBlockInstance.prototype.renderRows = function () {
        ...
        if (this.state.rows.length === 0 && this.props.block.blockDef.noRowsMessage) {
            return (React.createElement("tr", null,
                React.createElement("td", { colSpan: this.props.block.blockDef.contents.length, style: { fontStyle: "italic" } }, localization_1.localize(this.props.block.blockDef.noRowsMessage, this.props.instanceCtx.locale))));
        }
        ...
        return (React.createElement("table", { className: className, style: style },
            !blockDef.hideHeaders ?
                React.createElement("thead", null,
                    React.createElement("tr", null, blockDef.headers.map(function (b, index) { return _this.renderHeader(b, index); })))
                : null,
