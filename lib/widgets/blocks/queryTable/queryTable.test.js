...
test("gets multiple row cv value", () => {
    ...
    expect(qtbMultiple.getRowContextVarValue({ e0: "xyz", e1: 4 }, exprs, schema, rowsetCV, contextVars, {
        type: "literal",
        valueType: "boolean",
        value: false
    })).toEqual({
...
test("gets row expressions", () => {
    ...
    const qtbd = Object.assign(Object.assign({}, qtbdSingle), { contents: [{ type: "expression", id: "re1", contextVarId: "123_row", expr: expr }] });
