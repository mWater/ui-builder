...
test("gets row expressions", function () {
    ...
    var qtbd = __assign({}, qtbdSingle, { contents: [{ type: "expression", id: "re1", contextVarId: "123_row", expr: expr }] });
...
test("gets action expressions", function () {
    ...
    var expr = { type: "field", table: "t1", column: "text" };
    var qtbd = __assign({}, qtbdSingle, { rowClickAction: { type: "addRow", table: "t1", columnValues: { text: { contextVarId: "123_row", expr: expr } } } });
    var qtb = new queryTable_1.QueryTableBlock(qtbd, createBlock);
