...
export class QueryTableBlock extends CompoundBlock {
     ...
     */
    getRowContextVarValue(row, rowExprs, schema, rowsetCV) {
        switch (this.blockDef.mode) {
            case "singleRow":
                return row.id;
            case "multiRow":
        ...
        return (React.createElement("div", null,
            ...
            rowsetCV ?
                React.createElement(LabeledProperty, { label: "Filter" },
                    React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "where" }, (value, onChange) => (React.createElement(ExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, types: ["boolean"], table: rowsetCV.table }))))
                : null,
            rowCV ?
                React.createElement(LabeledProperty, { label: "Ordering" },
                    React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "orderBy" }, (value, onChange) => React.createElement(OrderByArrayEditor, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, table: rowsetCV.table })))
                : null,
