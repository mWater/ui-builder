...
exports.QueryTableBlock = void 0;
...
var QueryTableBlock = /** @class */ (function (_super) {
    ...
    QueryTableBlock.prototype.renderEditor = function (props) {
        ...
        return (React.createElement("div", null,
            ...
            rowCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Column Sort Icons", hint: "Allow dynamic sorting if present" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "columnInfos" }, function (value, onChange) { return React.createElement(ColumnOrderExprsEditor, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, table: rowCV.table, numColumns: _this.blockDef.contents.length }); }))
                : null,
...
var ColumnOrderExprsEditor = function (props) {
    ...
    return React.createElement("div", null, _.map(_.range(props.numColumns), function (colIndex) { return (React.createElement("div", { key: colIndex }, "#" + (colIndex + 1) + ":",
