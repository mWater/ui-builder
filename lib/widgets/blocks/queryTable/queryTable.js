        ...
        return (React.createElement("div", null,
            ...
            rowCV ?
                React.createElement(LabeledProperty, { label: "When row clicked" },
                    React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "rowClickAction" }, (value, onChange) => (React.createElement(ActionDefEditor, { value: value, onChange: onChange, locale: props.locale, schema: props.schema, dataSource: props.dataSource, actionLibrary: props.actionLibrary, widgetLibrary: props.widgetLibrary, contextVars: props.contextVars.concat(rowCV) }))))
                : null,
            React.createElement(LabeledProperty, { label: "Message to display when no rows" },
                React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "noRowsMessage" }, (value, onChange) => React.createElement(LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale }))),
