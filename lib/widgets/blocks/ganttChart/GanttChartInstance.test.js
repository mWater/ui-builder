...
test("sorts simple list", () => {
    ...
    const chartRows = GanttChartInstance_1.createChartRows({ queryRows, getColor: () => "red", prefixNumber: false });
...
test("sorts nested list", () => {
    ...
    const chartRows = GanttChartInstance_1.createChartRows({ queryRows, getColor: () => "red", prefixNumber: true });
