...
class GanttChartBlock extends LeafBlock_1.default {
    validate(designCtx) {
        ...
        const exprValidator = new mwater_expressions_1.ExprValidator(designCtx.schema, blocks_1.createExprVariables(designCtx.contextVars));
        let error;
        // Validate filter
        ...
        return (React.createElement("div", null,
            ...
            rowsetCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Label" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "rowLabelExpr" }, (value, onChange) => (React.createElement(mwater_expressions_ui_1.ExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, types: ["text"], variables: blocks_1.createExprVariables(props.contextVars), table: rowsetCV.table }))))
                : null,
            rowsetCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Start Date of Rows" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "rowStartDateExpr" }, (value, onChange) => (React.createElement(mwater_expressions_ui_1.ExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, types: ["date", "datetime"], variables: blocks_1.createExprVariables(props.contextVars), table: rowsetCV.table }))))
                : null,
            rowsetCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "End Date of Rows" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "rowEndDateExpr" }, (value, onChange) => (React.createElement(mwater_expressions_ui_1.ExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, types: ["date", "datetime"], variables: blocks_1.createExprVariables(props.contextVars), table: rowsetCV.table }))))
                : null,
            rowsetCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Filter" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "filter" }, (value, onChange) => (React.createElement(mwater_expressions_ui_1.ExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, types: ["boolean"], variables: blocks_1.createExprVariables(props.contextVars), table: rowsetCV.table }))))
                : null,
            rowsetCV ?
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Override Start Date" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "startDate" }, (value, onChange) => (React.createElement(react_datepicker_1.default, { selected: value ? moment_1.default(value, "YYYY-MM-DD") : null, onChange: (momentDate) => { onChange(momentDate.format("YYYY-MM-DD")); }, dateFormat: "ll", isClearable: true, className: "form-control" })))),
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Override End Date" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "endDate" }, (value, onChange) => (React.createElement(react_datepicker_1.default, { selected: value ? moment_1.default(value, "YYYY-MM-DD") : null, onChange: (momentDate) => { onChange(momentDate.format("YYYY-MM-DD")); }, dateFormat: "ll", isClearable: true, className: "form-control" })))),
            ...
            rowCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "When row clicked" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "rowClickAction" }, (value, onChange) => (React.createElement(propertyEditors_1.ActionDefEditor, { value: value, onChange: onChange, designCtx: { ...props, contextVars: props.contextVars.concat(rowCV) } }))))
                : null,
            rowCV && rowsetCV ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "When row added" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "addRowAction" }, (value, onChange) => (React.createElement(propertyEditors_1.ActionDefEditor, { value: value, onChange: onChange, designCtx: { ...props, contextVars: props.contextVars.concat([this.createAddRowOrderContextVar(rowsetCV), this.createAddRowParentContextVar(rowsetCV)]) } }))))
                : null,
