...
class GanttChartBlock extends LeafBlock_1.default {
    ...
    renderEditor(props) {
        ...
        return (React.createElement("div", null,
            ...
            rowsetCV ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Label" },
            ...
            rowsetCV ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Start Date of Rows" },
            ...
            rowsetCV ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "End Date of Rows" },
            ...
            rowsetCV ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Order By Column" },
            ...
            rowsetCV ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Parent Column", hint: "Optional column to make hierarchical" },
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Override Start Date" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "startDate" }, (value, onChange) => (React.createElement(react_datepicker_1.default, { selected: value ? (0, moment_1.default)(value, "YYYY-MM-DD") : null, onChange: (momentDate) => {
                        onChange(momentDate.format("YYYY-MM-DD"));
                    }, dateFormat: "ll", isClearable: true, className: "form-control" })))),
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Override End Date" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "endDate" }, (value, onChange) => (React.createElement(react_datepicker_1.default, { selected: value ? (0, moment_1.default)(value, "YYYY-MM-DD") : null, onChange: (momentDate) => {
                        onChange(momentDate.format("YYYY-MM-DD"));
                    }, dateFormat: "ll", isClearable: true, className: "form-control" })))),
            ...
            rowCV && rowsetCV ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "When row added" },
            ...
            this.blockDef.addRowAction ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Add row link text" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "addRowLabel" }, (value, onChange) => (React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale }))))) : null,
            ...
            this.blockDef.allowRemove ? (React.createElement(propertyEditors_1.LabeledProperty, { label: "Remove confirm message" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "removeConfirmMessage" }, (value, onChange) => (React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale }))))) : null));
    }
}
