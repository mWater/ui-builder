...
function GanttChartInstance(props) {
    ...
    return react_2.default.createElement(GanttChart_1.GanttChart, { rows: chartRows, startDate: startDate, endDate: endDate, onMoveRowDown: isOrdered ? handleMoveRowDown : undefined, onMoveRowUp: isOrdered ? handleMoveRowUp : undefined, onMoveRowLeft: isOrdered && isHierarchical ? handleMoveRowLeft : undefined, onMoveRowRight: isOrdered && isHierarchical ? handleMoveRowRight : undefined, onInsertChildRow: isOrdered && isHierarchical ? handleInsertChildRow : undefined, onRowClick: blockDef.rowClickAction ? handleRowClick : undefined, onAddRow: blockDef.addRowAction ? handleAppendRow : undefined, addRowLabel: blockDef.addRowLabel ? [react_2.default.createElement("i", { className: "fa fa-plus" }), " ", localization_1.localize(blockDef.addRowLabel, ctx.locale)] : undefined, T: ctx.T });
}
