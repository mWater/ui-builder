...
class PanelBlock extends blocks_1.Block {
    ...
    renderEditor(props) {
        const showHeader = () => { props.store.replaceBlock(Object.assign(Object.assign({}, this.blockDef), { headerContent: null })); };
        const hideHeader = () => { props.store.replaceBlock(Object.assign(Object.assign({}, this.blockDef), { headerContent: undefined })); };
        const showFooter = () => { props.store.replaceBlock(Object.assign(Object.assign({}, this.blockDef), { footerContent: null })); };
        const hideFooter = () => { props.store.replaceBlock(Object.assign(Object.assign({}, this.blockDef), { footerContent: undefined })); };
