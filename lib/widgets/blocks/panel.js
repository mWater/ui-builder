...
const PanelComponent = (props) => {
    return (React.createElement("div", { className: "panel panel-default" },
        props.header ? React.createElement("div", { className: "panel-heading" }, props.header) : null,
        React.createElement("div", { className: "panel-body" }, props.main),
        props.footer ? React.createElement("div", { className: "panel-footer" }, props.footer) : null));
};
