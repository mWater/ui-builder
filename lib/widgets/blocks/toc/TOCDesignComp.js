    ...
    var renderRight = function () {
        ...
        return (react_1.default.createElement("div", { style: { padding: 10 } },
            ...
            react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Page title (optional)" },
                react_1.default.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: selectedItem.title || null, onChange: handleTitleChange, locale: props.renderProps.locale })),
