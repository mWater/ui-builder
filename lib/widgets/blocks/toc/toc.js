...
class TOCBlock extends blocks_1.Block {
    ...
    getContextVarExprs(contextVar, ctx) {
        return _.compact((0, exports.iterateItems)(this.blockDef.items).map(item => item.condition && item.condition.contextVarId == contextVar.id ? item.condition.expr : null));
    }
