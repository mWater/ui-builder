...
var TOCBlock = /** @class */ (function (_super) {
    ...
    TOCBlock.prototype.validateItem = function (designCtx, tocItem) {
        if (!tocItem.widgetId) {
            return null;
        }
        ...
        // Validate children
        for (var _b = 0, _c = tocItem.children; _b < _c.length; _b++) {
            var child = _c[_b];
            var error = this.validateItem(designCtx, child);
            if (error) {
                return error;
            }
        }
    ...
    TOCBlock.prototype.validate = function (designCtx) {
        ...
        for (var _i = 0, _a = exports.iterateItems(this.blockDef.items); _i < _a.length; _i++) {
            var tocItem = _a[_i];
            var error = this.validateItem(designCtx, tocItem);
            if (error) {
                return error;
            }
        }
