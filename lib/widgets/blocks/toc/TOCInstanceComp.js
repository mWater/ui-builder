...
function TOCInstanceComp(props) {
    ...
    var renderRight = function () {
        ...
        var page = {
            ...
            type: "normal",
            title: selectedItem.title ? localization_1.localize(selectedItem.title, renderProps.locale) : undefined,
            widgetId: selectedWidgetId
        };
        // Create page stack
        return react_2.default.createElement(PageStackDisplay_1.PageStackDisplay, { key: selectedId, baseCtx: props.renderProps, initialPage: page, ref: pageStackRef });
    };
