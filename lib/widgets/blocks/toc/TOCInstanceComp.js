...
function TOCInstanceComp(props) {
    ...
    function renderRight(noTitle) {
        ...
        const page = {
            ...
            type: "normal",
            title: !noTitle && selectedItem.title ? localization_1.localize(selectedItem.title, instanceCtx.locale) : undefined,
    ...
    if (blockDef.collapseWidth != null && pageWidth <= blockDef.collapseWidth) {
        ...
        const title = selectedItem.title ? localization_1.localize(selectedItem.title, instanceCtx.locale) : undefined;
    ...
    return react_2.default.createElement(SplitPane_1.default, { left: renderLeft(), right: renderRight(false), removePadding: blockDef.removePadding || false, theme: blockDef.theme || "light" });
}
