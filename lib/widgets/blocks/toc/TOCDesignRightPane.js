...
function TOCDesignRightPane(props) {
    ...
    return (react_1.default.createElement("div", { style: { padding: 10 } },
        ...
        react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Conditional display (optional)" },
            react_1.default.createElement(propertyEditors_1.ContextVarAndExprPropertyEditor, { schema: renderProps.schema, dataSource: renderProps.dataSource, contextVars: renderProps.contextVars, contextVarId: item.condition ? item.condition.contextVarId : null, expr: item.condition ? item.condition.expr : null, onChange: (contextVarId, expr) => { handleConditionChange({ contextVarId, expr }); }, types: ["boolean"] }))));
}
