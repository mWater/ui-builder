            ...
            contextVar && contextVar.table
                ?
                    React.createElement(LabeledProperty, { label: "Expression" },
                        React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "expr" }, (value, onChange) => (React.createElement(ExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, aggrStatuses: ["individual", "aggregate", "literal"], table: contextVar.table }))))
                : null,
            exprType === "number" ?
