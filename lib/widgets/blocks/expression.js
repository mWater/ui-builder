...
var ExpressionBlock = /** @class */ (function (_super) {
    ...
    ExpressionBlock.prototype.renderEditor = function (props) {
        var _this = this;
        var contextVar = this.blockDef.contextVarId ? props.contextVars.find(function (cv) { return cv.id === _this.blockDef.contextVarId; }) || null : null;
        var exprType = new mwater_expressions_1.ExprUtils(props.schema, blocks_1.createExprVariables(props.contextVars)).getExprType(this.blockDef.expr);
        return (React.createElement("div", null,
            ...
            exprType === "boolean" ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Display True As" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "trueLabel" }, function (value, onChange) { return (React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale, placeholder: "True" })); }))
                : null,
            exprType === "boolean" ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Display False As" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "falseLabel" }, function (value, onChange) { return (React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale, placeholder: "False" })); }))
                : null,
