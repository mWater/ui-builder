...
class ExpressionBlock extends textual_1.TextualBlock {
    ...
    renderDesign(props) {
        let summary = new mwater_expressions_1.ExprUtils(props.schema, blocks_1.createExprVariables(props.contextVars)).summarizeExpr(this.blockDef.expr, props.locale);
    ...
    renderInstance(props) {
        ...
        if (value == null) {
            ...
            if (exprType === "number") {
                ...
                if (value == true) {
                    str = this.blockDef.trueLabel ? localization_1.localize(this.blockDef.trueLabel, props.locale) : "True";
                }
                else if (value == false) {
                    str = this.blockDef.falseLabel ? localization_1.localize(this.blockDef.falseLabel, props.locale) : "False";
                }
                else {
                    str = "";
                }
        ...
        return (React.createElement("div", null,
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Expression" },
                React.createElement(propertyEditors_1.ContextVarExprPropertyEditor, { contextVars: props.contextVars, schema: props.schema, dataSource: props.dataSource, aggrStatuses: contextVar && contextVar.type == "row" ? ["individual", "literal"] : ["individual", "aggregate", "literal"], contextVarId: this.blockDef.contextVarId, expr: this.blockDef.expr, onChange: (contextVarId, expr) => {
                        props.store.replaceBlock({ ...this.blockDef, contextVarId, expr });
                    } })),
            exprType === "number" ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Number Format" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "format" }, (value, onChange) => (React.createElement(propertyEditors_1.NumberFormatEditor, { value: value, onChange: onChange }))))
                : null,
            exprType === "date" ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Date Format" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "format" }, (value, onChange) => (React.createElement(propertyEditors_1.DateFormatEditor, { value: value, onChange: onChange }))))
                : null,
            exprType === "datetime" ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Date/time Format" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "format" }, (value, onChange) => (React.createElement(propertyEditors_1.DatetimeFormatEditor, { value: value, onChange: onChange }))))
                : null,
            exprType === "boolean" ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Display True As" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "trueLabel" }, (value, onChange) => (React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale, placeholder: "True" }))))
                : null,
            exprType === "boolean" ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Display False As" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "falseLabel" }, (value, onChange) => (React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale, placeholder: "False" }))))
                : null,
