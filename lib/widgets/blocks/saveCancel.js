        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "save-cancel-footer" },
                this.blockDef.deleteContextVarId ?
                    React.createElement("button", { type: "button", className: "btn btn-default", style: { float: "left" } },
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "save-cancel-footer" },
                this.props.blockDef.deleteContextVarId && this.props.instanceCtx.contextVarValues[this.props.blockDef.deleteContextVarId] ?
                    React.createElement("button", { type: "button", className: "btn btn-default", onClick: this.handleDelete, style: { float: "left" } },
                        React.createElement("span", { className: "text-danger" },
                            React.createElement("i", { className: "fa fa-remove" }),
                            " ",
                            deleteLabelText))
