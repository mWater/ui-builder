    ...
    renderDesign(props) {
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("div", { className: "save-cancel-footer" },
                this.blockDef.deleteContextVarId ? (react_1.default.createElement("button", { type: "button", className: "btn btn-danger", style: { float: "left" } },
...
class SaveCancelInstance extends react_1.default.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("div", { className: "save-cancel-footer" },
                canDelete ? (react_1.default.createElement("button", { type: "button", className: "btn btn-danger", onClick: this.handleDelete, style: { float: "left" } },
                    react_1.default.createElement("i", { className: "fa fa-remove" }),
                    " ",
                    deleteLabelText)) : null,
