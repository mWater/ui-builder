...
class SaveCancelBlock extends blocks_1.Block {
    ...
    renderDesign(props) {
        ...
        const deleteLabelText = localization_1.localize(this.blockDef.deleteLabel, props.locale);
        ...
        return (react_1.default.createElement("div", null,
            ...
            this.blockDef.deleteContextVarId ?
                react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Delete Label" },
                    react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "deleteLabel" }, (value, onChange) => react_1.default.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale })))
                : null,
            this.blockDef.deleteContextVarId ?
                react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Optional Confirm Delete Message" },
                    react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "confirmDeleteMessage" }, (value, onChange) => react_1.default.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale })))
                : null,
            this.blockDef.deleteContextVarId ?
...
class SaveCancelInstance extends react_1.default.Component {
    constructor(props) {
        ...
        this.validate = () => {
            ...
            if (this.state.virtualDatabase.mutations.length > 0) {
                if (!confirm(localization_1.localize(this.props.blockDef.confirmDiscardMessage, this.props.instanceCtx.locale))) {
        ...
        this.handleDelete = async () => {
            ...
            const deleteRow = async (tx, contextVarId) => {
    ...
    render() {
        ...
        const saveLabelText = localization_1.localize(this.props.blockDef.saveLabel, this.props.instanceCtx.locale);
        const cancelLabelText = localization_1.localize(this.props.blockDef.cancelLabel, this.props.instanceCtx.locale);
        const deleteLabelText = localization_1.localize(this.props.blockDef.deleteLabel, this.props.instanceCtx.locale);
        ...
        return (react_1.default.createElement("div", null,
            react_1.default.createElement(ContextVarsInjector_1.default, { injectedContextVars: instanceCtx.contextVars, injectedContextVarValues: instanceCtx.contextVarValues, innerBlock: this.props.blockDef.child, instanceCtx: { ...instanceCtx, database: this.state.virtualDatabase } }, (innerInstanceCtx, loading, refreshing) => {
                if (loading) {
