    ...
    renderEditor(props) {
        return (react_1.default.createElement("div", null,
            ...
            this.blockDef.deleteContextVarId ?
                ...
                : null,
            this.blockDef.deleteContextVarId ?
                react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Delete condition", hint: "optional expression that must be true to show delete button" },
                    react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "deleteCondition" }, (value, onChange) => react_1.default.createElement(propertyEditors_1.ContextVarAndExprPropertyEditor, { schema: props.schema, dataSource: props.dataSource, contextVars: props.contextVars, contextVarId: value ? value.contextVarId : null, expr: value ? value.expr : null, onChange: (contextVarId, expr) => { onChange({ contextVarId, expr }); }, types: ["boolean"] })))
                : null,
            this.blockDef.deleteContextVarId ?
...
class SaveCancelInstance extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleDelete = () => __awaiter(this, void 0, void 0, function* () {
            ...
            // Confirm deletion
            if (blockDef.confirmDeleteMessage && !confirm((0, localization_1.localize)(blockDef.confirmDeleteMessage, this.props.instanceCtx.locale))) {
                return;
            }
            // Do actual deletion
