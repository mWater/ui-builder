...
var SaveCancelBlock = /** @class */ (function (_super) {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "save-cancel-footer" },
                this.blockDef.deleteContextVarId ?
                    React.createElement("button", { type: "button", className: "btn btn-danger", style: { float: "left" } }, deleteLabelText)
                    : null,
    ...
    SaveCancelBlock.prototype.getSubtreeContextVarExprs = function (options) {
        return [];
    };
    ...
    SaveCancelBlock.prototype.renderEditor = function (props) {
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Optional Delete Target" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "deleteContextVarId" }, function (value, onChange) { return React.createElement(propertyEditors_1.ContextVarPropertyEditor, { value: value, onChange: onChange, contextVars: props.contextVars, types: ["row"] }); })),
            this.blockDef.deleteContextVarId ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Delete Label" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "deleteLabel" }, function (value, onChange) { return React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale }); }))
                : null,
            this.blockDef.deleteContextVarId ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Optional Confirm Delete Message" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "confirmDeleteMessage" }, function (value, onChange) { return React.createElement(propertyEditors_1.LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale }); }))
                : null));
    };
...
var SaveCancelInstance = /** @class */ (function (_super) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        for (_i = 0, _a = Object.keys(this.validationRegistrations); _i < _a.length; _i++) {
                            key = _a[_i];
                            msg = this.validationRegistrations[key]();
                            if (msg != null) {
        ...
        _this.handleDelete = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // Confirm deletion
                        if (this.props.blockDef.confirmDeleteMessage && !confirm(localization_1.localize(this.props.blockDef.confirmDeleteMessage, this.props.renderInstanceProps.locale))) {
                            return [2 /*return*/];
                        }
                        db = this.props.renderInstanceProps.database;
                        deleteCV = this.props.renderInstanceProps.contextVars.find(function (cv) { return cv.id == _this.props.blockDef.deleteContextVarId; });
                        if (!deleteCV) {
                            throw new Error("Missing delete CV");
                        }
                        rowId = this.props.renderInstanceProps.contextVarValues[deleteCV.id];
                        if (!rowId) {
    ...
    SaveCancelInstance.prototype.render = function () {
        ...
        var deleteLabelText = localization_1.localize(this.props.blockDef.deleteLabel, this.props.renderInstanceProps.locale);
        // Replace renderChildBlock with function that keeps all instances for validation
        var renderInstanceProps = __assign(__assign({}, this.props.renderInstanceProps), { registerForValidation: this.registerChildForValidation });
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "save-cancel-footer" },
                this.props.blockDef.deleteContextVarId && this.props.renderInstanceProps.contextVarValues[this.props.blockDef.deleteContextVarId] ?
                    React.createElement("button", { type: "button", className: "btn btn-danger", onClick: this.handleDelete, style: { float: "left" } }, deleteLabelText)
                    : null,
