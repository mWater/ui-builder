...
describe("getContextVarExprs", () => {
    ...
    test("gathers from inner widget and maps variables too", () => {
        ...
        const widgetLibrary2 = immer_1.default(widgetLibrary, (draft) => {
...
describe("renderInstance", () => {
    ...
    beforeEach((done) => {
        ...
        const x = enzyme_1.shallow(widgetBlock.renderInstance(instanceCtx));
    });
    test("contextVars", () => {
...
describe("mapObjectTree", () => {
    test("deep mapping", () => {
        ...
        expect(widget_1.mapObjectTree(obj, (input) => {
