...
describe("getContextVarExprs", () => {
    test("gathers from inner widget and maps", () => {
        ...
        const widgetBlock = new widget_1.WidgetBlock(blockDef);
        // Get expressions
        const exprs = widgetBlock.getContextVarExprs(contextVars[0], { widgetLibrary: widgetLibrary, createBlock: createBlock });
    ...
    test("gathers from inner widget and maps variables too", () => {
        ...
        const widgetLibrary2 = (0, immer_1.default)(widgetLibrary, (draft) => {
            (draft.widgets.w1.blockDef).expr = { type: "variable", variableId: "b1" };
        });
        const createBlock = new BlockFactory_1.default().createBlock;
        const widgetBlock = new widget_1.WidgetBlock(blockDef);
        // Get expressions
        const exprs = widgetBlock.getContextVarExprs(contextVars[0], { widgetLibrary: widgetLibrary2, createBlock: createBlock });
        expect(exprs).toEqual([
...
describe("getInitialFilters", () => {
    test("translates", () => {
        ...
        const filters = widgetBlock.getInitialFilters("a1", { widgetLibrary: widgetLibrary, contextVars: [], createBlock: createBlock });
...
describe("renderInstance", () => {
    ...
    beforeEach((done) => {
        ...
        const x = (0, enzyme_1.shallow)(widgetBlock.renderInstance(instanceCtx));
    });
    test("contextVars", () => {
    ...
    test("getContextVarExprValue maps variables", () => {
        ...
        const innerExpr = { type: "variable", variableId: "b1" };
...
describe("mapObjectTree", () => {
    test("deep mapping", () => {
        ...
        expect((0, widget_1.mapObjectTree)(obj, (input) => {
