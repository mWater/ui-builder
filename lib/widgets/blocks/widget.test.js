...
describe("getContextVarExprs", function () {
    test("gathers from inner widget and maps", function () {
        ...
        // Get expressions
        var exprs = widgetBlock.getContextVarExprs(contextVars[0], { widgetLibrary: widgetLibrary });
    ...
    test("gathers from inner widget and maps variables too", function () {
        ...
        var widgetBlock = new widget_1.WidgetBlock(blockDef, createBlock);
        // Get expressions
        var exprs = widgetBlock.getContextVarExprs(contextVars[0], { widgetLibrary: widgetLibrary2 });
        expect(exprs).toEqual([
...
describe("getInitialFilters", function () {
    test("translates", function () {
        ...
        var filters = widgetBlock.getInitialFilters("a1", { widgetLibrary: widgetLibrary, contextVars: [] });
