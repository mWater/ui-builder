...
describe("getInitialFilters", () => {
    test("translates", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        innerBlock.getInitialFilters.mockReturnValue(Promise.resolve([{ id: "f1", memo: "m", expr: {} }]));
        const filters = yield widgetBlock.getInitialFilters("a1", {
            widgetLibrary: widgetLibrary,
            contextVars: [],
            createBlock: createBlock
        });
