...
test("save writes to database", () => __awaiter(this, void 0, void 0, function* () {
    const saveCancelBlock = new saveCancel_1.SaveCancelBlock(saveCancelBlockDef, createBlock);
    // Add row to database
...
test("prevent save if required blank", () => __awaiter(this, void 0, void 0, function* () {
    const saveCancelBlock = new saveCancel_1.SaveCancelBlock(saveCancelBlockDef, createBlock);
    // Add row to database
    const txn = database.transaction();
