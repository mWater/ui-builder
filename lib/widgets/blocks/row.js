...
class RowBlock extends blocks_1.Block {
    ...
    renderEditor(props) {
        ...
        return (react_1.default.createElement("div", null,
            ...
            this.blockDef.table && mode == "filter" ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Filter" },
            ...
            this.blockDef.table && mode == "id" ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "ID of row" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "idContextVarExpr" }, (value, onChange) => (react_1.default.createElement(propertyEditors_1.ContextVarAndExprPropertyEditor, { contextVars: props.contextVars, contextVarId: value ? value.contextVarId : null, expr: value ? value.expr : null, onChange: (contextVarId, expr) => {
                        onChange({ contextVarId, expr });
                    }, schema: props.schema, dataSource: props.dataSource, idTable: this.blockDef.table, types: ["id"] }))))) : null));
    }
}
...
const RowInstance = (props) => {
    ...
    const refreshTrigger = (0, Database_1.useDatabaseChangeListener)(database);
    (0, react_2.useEffect)(() => {
        if (mode == "filter") {
            // Query to get match
            database.query({
