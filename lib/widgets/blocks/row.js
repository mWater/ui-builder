...
var RowBlock = /** @class */ (function (_super) {
    ...
    RowBlock.prototype.renderInstance = function (props) {
        var contextVar = this.createContextVar();
        return React.createElement(RowInstance, { contextVar: contextVar, blockDef: this.blockDef, instanceProps: props, createBlock: this.createBlock });
    };
...
var RowInstance = function (props) {
    var _a;
    var blockDef = props.blockDef, instanceProps = props.instanceProps, contextVar = props.contextVar, createBlock = props.createBlock;
    ...
    return React.createElement(ContextVarsInjector_1.default, { injectedContextVars: [contextVar], injectedContextVarValues: (_a = {}, _a[contextVar.id] = id, _a), createBlock: createBlock, database: instanceProps.database, innerBlock: blockDef.content, renderInstanceProps: instanceProps, schema: instanceProps.schema }, function (renderInstanceProps, loading, refreshing) {
        if (loading) {
            return React.createElement("div", { style: { color: "#AAA", fontSize: 18, textAlign: "center" } },
                React.createElement("i", { className: "fa fa-circle-o-notch fa-spin" }));
        }
        return (React.createElement("div", { style: { opacity: refreshing ? 0.6 : undefined } }, instanceProps.renderChildBlock(renderInstanceProps, blockDef.content)));
    });
};
