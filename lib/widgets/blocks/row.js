...
var RowBlock = /** @class */ (function (_super) {
    ...
    RowBlock.prototype.validate = function (options) {
        ...
        if (mode == "filter") {
            ...
            // Validate orderBy
            for (var _i = 0, _a = this.blockDef.filterOrderBy || []; _i < _a.length; _i++) {
                var orderBy = _a[_i];
    ...
    RowBlock.prototype.renderEditor = function (props) {
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Name" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "name" }, function (value, onChange) { return react_1.default.createElement(bootstrap_1.TextInput, { value: value || null, onChange: onChange, placeholder: "Unnamed" }); })),
            react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Mode", key: "mode" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "mode" }, function (value, onChange) {
                    return react_1.default.createElement(bootstrap_1.Toggle, { value: value || "filter", onChange: onChange, options: [
            ...
            this.blockDef.table && mode == "filter" ?
                react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Filter" },
                    react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "filter" }, function (value, onChange) {
                        return react_1.default.createElement(mwater_expressions_ui_1.FilterExprComponent, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, table: _this.blockDef.table, variables: blocks_1.createExprVariables(props.contextVars) });
                    }))
                : null,
            react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Filter Order", key: "filterOrderBy", hint: "If filter matches more than one row, first one is taken" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "filterOrderBy" }, function (value, onChange) {
                    return react_1.default.createElement(propertyEditors_1.OrderByArrayEditor, { value: value || [], onChange: onChange, schema: props.schema, dataSource: props.dataSource, contextVars: props.contextVars, table: _this.blockDef.table });
                })),
            this.blockDef.table && mode == "id" ?
                react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "ID of row" },
                    react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "idContextVarExpr" }, function (value, onChange) {
                        return react_1.default.createElement(propertyEditors_1.ContextVarExprPropertyEditor, { contextVars: props.contextVars, contextVarId: value ? value.contextVarId : null, expr: value ? value.expr : null, onChange: function (contextVarId, expr) {
...
var RowInstance = function (props) {
    ...
    var _b = react_2.useState(null), error = _b[0], setError = _b[1];
    var _c = react_2.useState(true), loading = _c[0], setLoading = _c[1];
    var _d = react_2.useState(), id = _d[0], setId = _d[1];
    ...
    if (!id) {
        return react_1.default.createElement("div", { className: "alert alert-warning" }, "Not found");
    }
    // Inject context variable
    return react_1.default.createElement(ContextVarsInjector_1.default, { injectedContextVars: [contextVar], injectedContextVarValues: (_a = {}, _a[contextVar.id] = id, _a), innerBlock: blockDef.content, instanceCtx: instanceProps }, function (instanceCtx, loading, refreshing) {
        if (loading) {
            return react_1.default.createElement("div", { style: { color: "#AAA", textAlign: "center" } },
                react_1.default.createElement("i", { className: "fa fa-circle-o-notch fa-spin" }));
        }
        return (react_1.default.createElement("div", { style: { opacity: refreshing ? 0.6 : undefined } }, instanceProps.renderChildBlock(instanceCtx, blockDef.content)));
    });
};
