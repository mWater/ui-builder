...
class LabeledBlock extends blocks_1.Block {
    ...
    renderDesign(props) {
        ...
        return this.blockDef.layout == "horizontal" ? (React.createElement(HorizLabeledControl, { designMode: true, labelText: labelText || "Label", hintText: hintText, helpText: helpText, requiredStar: this.blockDef.requiredStar, labelBold: (_a = this.blockDef.labelBold) !== null && _a !== void 0 ? _a : true, labelMuted: (_b = this.blockDef.labelMuted) !== null && _b !== void 0 ? _b : false }, props.renderChildBlock(props, this.blockDef.child, handleAdd))) : (React.createElement(StackedLabeledControl, { labelText: labelText || "Label", hintText: hintText, helpText: helpText, labelBold: (_c = this.blockDef.labelBold) !== null && _c !== void 0 ? _c : true, labelMuted: (_d = this.blockDef.labelMuted) !== null && _d !== void 0 ? _d : false, requiredStar: this.blockDef.requiredStar }, props.renderChildBlock(props, this.blockDef.child, handleAdd)));
    }
    renderInstance(props) {
        ...
        const hintText = (0, localization_1.localize)(this.blockDef.hint, props.locale);
        const helpText = (0, localization_1.localize)(this.blockDef.help, props.locale);
        return this.blockDef.layout == "horizontal" ? (React.createElement(HorizLabeledControl, { labelText: labelText || "Label", hintText: hintText, helpText: helpText, labelBold: (_a = this.blockDef.labelBold) !== null && _a !== void 0 ? _a : true, labelMuted: (_b = this.blockDef.labelMuted) !== null && _b !== void 0 ? _b : false, requiredStar: this.blockDef.requiredStar }, props.renderChildBlock(props, this.blockDef.child))) : (React.createElement(StackedLabeledControl, { labelText: labelText, hintText: hintText, helpText: helpText, labelBold: (_c = this.blockDef.labelBold) !== null && _c !== void 0 ? _c : true, labelMuted: (_d = this.blockDef.labelMuted) !== null && _d !== void 0 ? _d : false, requiredStar: this.blockDef.requiredStar }, props.renderChildBlock(props, this.blockDef.child)));
    }
    renderEditor(props) {
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "labelBold" }, (value, onChange) => (React.createElement(bootstrap_1.Checkbox, { value: value !== null && value !== void 0 ? value : true, onChange: onChange }, "Label Bold"))),
            React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "labelMuted" }, (value, onChange) => (React.createElement(bootstrap_1.Checkbox, { value: value !== null && value !== void 0 ? value : false, onChange: onChange }, "Label Muted"))),
...
function StackedLabeledControl(props) {
    return (React.createElement("div", { style: { paddingTop: 5, paddingBottom: 5 } },
        React.createElement("div", { key: "label" },
            React.createElement("span", { key: "label", style: { fontWeight: props.labelBold ? "bold" : undefined }, className: props.labelMuted ? "text-muted" : undefined }, props.labelText),
            props.requiredStar ? React.createElement("span", { style: { color: "red", paddingLeft: 2 } }, "*") : null,
            props.hintText ? (React.createElement("span", { key: "hint", className: "text-muted" },
                " ",
                "- ",
                props.hintText)) : null),
        props.children,
        props.helpText ? (React.createElement("div", { className: "form-text text-muted", style: { marginLeft: 5 } }, props.helpText)) : null));
}
function HorizLabeledControl(props) {
    return (React.createElement("div", { style: {
        ...
        props.helpText || props.hintText ? React.createElement("div", { key: "blank" }) : null,
        props.helpText || props.hintText ? (React.createElement("div", { key: "help", style: { marginLeft: 5 } },
            React.createElement("span", { key: "hint", className: "text-muted", style: { marginLeft: 5 } }, props.hintText),
            React.createElement("span", { key: "help", style: { marginLeft: 5 } }, props.helpText))) : null));
}
