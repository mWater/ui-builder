...
var ButtonBlock = /** @class */ (function (_super) {
    ...
    ButtonBlock.prototype.renderButton = function (label, onClick) {
        var icon = this.blockDef.icon ? react_1.default.createElement("i", { className: "fa fa-" + this.blockDef.icon }) : null;
        ...
        if (this.blockDef.style == "plainlink") {
            return react_1.default.createElement("a", { onClick: handleClick, style: { cursor: "pointer" } },
                icon,
                icon && label ? "\u00A0" : null,
                label);
        }
        ...
        return (react_1.default.createElement("button", { type: "button", className: className, onClick: handleClick, style: style },
            icon,
            icon && label ? "\u00A0" : null,
            label));
    };
