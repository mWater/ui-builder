    ...
    renderEditor(props) {
        return (React.createElement("div", null,
            ...
            React.createElement(LabeledProperty, { label: "When button clicked" },
                React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "actionDef" }, (value, onChange) => (React.createElement(ActionDefEditor, { value: value, onChange: onChange, locale: props.locale, schema: props.schema, dataSource: props.dataSource, actionLibrary: props.actionLibrary, widgetLibrary: props.widgetLibrary, contextVars: props.contextVars })))),
            React.createElement(LabeledProperty, { label: "Confirm message" },
                React.createElement(PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "confirmMessage" }, (value, onChange) => React.createElement(LocalizedTextPropertyEditor, { value: value, onChange: onChange, locale: props.locale })))));
    }
}
