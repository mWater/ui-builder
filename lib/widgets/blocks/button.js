...
var ButtonBlock = /** @class */ (function (_super) {
    ...
    ButtonBlock.prototype.renderButton = function (locale, onClick) {
        ...
        return (React.createElement("button", { type: "button", className: className, onClick: onClick, style: { margin: 5 } },
            icon,
            icon && label ? "\u00A0" : null,
            label));
    };
    ...
    ButtonBlock.prototype.renderEditor = function (props) {
        return (React.createElement("div", null,
            ...
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Icon" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "icon" }, function (value, onChange) {
            ...
            React.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.onChange, property: "block" }, function (value, onChange) { return React.createElement(bootstrap_1.Checkbox, { value: value, onChange: onChange }, "Block-style"); }),
