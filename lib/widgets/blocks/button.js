...
class ButtonBlock extends LeafBlock_1.default {
    ...
    renderEditor(props) {
        return (react_1.default.createElement("div", null,
            ...
            this.blockDef.style != "plainlink" ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Size" },
            ...
            this.blockDef.style != "plainlink" ? (react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.blockDef, onChange: props.store.replaceBlock, property: "block" }, (value, onChange) => (react_1.default.createElement(bootstrap_1.Checkbox, { value: value, onChange: onChange }, "Block-style")))) : null,
...
function ButtonComponent(props) {
    ...
    if (blockDef.style == "plainlink") {
        return (react_1.default.createElement("div", null,
            react_1.default.createElement("a", { className: "link-plain", onClick: props.onClick },
                icon,
                icon && label ? "\u00A0" : null,
                label)));
    }
    ...
    return (react_1.default.createElement("div", { style: style },
        react_1.default.createElement("button", { type: "button", className: className, onClick: props.onClick, disabled: props.busy },
