...
const DateInjectInstance = (props) => {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: { paddingTop: 5, paddingBottom: 5 } },
            React.createElement(react_datepicker_1.default, { selected: (0, moment_1.default)(date, "YYYY-MM-DD"), onChange: (momentDate) => { setDate(momentDate.format("YYYY-MM-DD")); }, dateFormat: "ll", isClearable: false, className: "form-control" })),
