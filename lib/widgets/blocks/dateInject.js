...
class DateInjectBlock extends blocks_1.Block {
    ...
    renderDesign(designCtx) {
        const handleSetContent = (blockDef) => {
            designCtx.store.alterBlock(this.id, immer_1.default((b) => {
                b.content = blockDef;
                return b;
            }), blockDef.id);
        };
        ...
        return (React.createElement("div", null,
            React.createElement("div", null,
                React.createElement(react_datepicker_1.default, { selected: moment_1.default(), onChange: () => { }, dateFormat: "ll", className: "form-control" })),
            contentNode));
    }
...
const DateInjectInstance = (props) => {
    const [date, setDate] = react_1.useState(moment_1.default().format("YYYY-MM-DD"));
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: { paddingTop: 5, paddingBottom: 5 } },
            React.createElement(react_datepicker_1.default, { selected: moment_1.default(date, "YYYY-MM-DD"), onChange: (momentDate) => { setDate(momentDate.format("YYYY-MM-DD")); }, dateFormat: "ll", isClearable: false, className: "form-control" })),
