    ...
    DateInjectBlock.prototype.renderDesign = function (designCtx) {
        ...
        return (React.createElement("div", null,
            React.createElement("div", null,
                React.createElement(react_datepicker_1.default, { selected: new Date(), onChange: function () { }, dateFormat: "PPP", className: "form-control" })),
            contentNode));
    };
...
var DateInjectInstance = function (props) {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: { paddingTop: 5, paddingBottom: 5 } },
            React.createElement(react_datepicker_1.default, { selected: moment_1.default(date, "YYYY-MM-DD").toDate(), onChange: function (d) { setDate(moment_1.default(d).format("YYYY-MM-DD")); }, dateFormat: "PPP", isClearable: false, className: "form-control" })),
