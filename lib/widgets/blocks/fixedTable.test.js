...
test("adds rows", () => {
    ...
    const newBlockDef = (0, fixedTable_1.setNumRows)(blockDef, 2);
...
test("removes rows", () => {
    ...
    const newBlockDef = (0, fixedTable_1.setNumRows)(blockDef, 1);
...
test("adds columns", () => {
    ...
    const newBlockDef = (0, fixedTable_1.setNumColumns)(blockDef, 2);
    expect(newBlockDef.numRows).toBe(1);
...
test("removes columns", () => {
    ...
    const newBlockDef = (0, fixedTable_1.setNumColumns)(blockDef, 1);
    expect(newBlockDef.numRows).toBe(1);
    expect(newBlockDef.numColumns).toBe(1);
    expect(newBlockDef.rows).toEqual([{ cells: [{ content: { id: "b11", type: "none" } }] }]);
});
