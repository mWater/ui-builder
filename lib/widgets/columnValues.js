        ...
        return React.createElement("tr", null,
            ...
            React.createElement("td", null,
                ...
                React.createElement(LabeledProperty, { label: "Expression" },
                    React.createElement(ExprComponent, { schema: this.props.schema, dataSource: this.props.dataSource, idTable: column.idTable || (column.type === "join" ? column.join.toTable : undefined), enumValues: column.enumValues, table: contextVar ? contextVar.table : null, value: contextVarExpr.expr, types: [columnType], onChange: this.handleExprChange.bind(null, columnId) }))),
            React.createElement("td", null,
