...
var ColumnValuesEditor = /** @class */ (function (_super) {
    ...
    ColumnValuesEditor.prototype.render = function () {
        var _this = this;
        var options = _.sortBy(this.props.schema.getColumns(this.props.table).map(function (column) { return ({ value: column.id, label: localization_1.localize(column.name, _this.props.locale) }); }), "label");
