...
class ColumnValuesEditor extends react_1.default.Component {
    ...
    render() {
        ...
        const options = lodash_1.default.sortBy(columns.map(column => ({ value: column.id, label: localization_1.localize(column.name, this.props.locale) })), "label");
        ...
        return react_1.default.createElement("div", null,
            ...
            react_1.default.createElement(react_select_1.default, { value: null, options: options, onChange: this.handleAdd, menuPortalTarget: document.body, styles: { menuPortal: style => ({ ...style, zIndex: 2000 }) } }));
    }
}
