...
class ColumnValuesEditor extends react_1.default.Component {
    ...
    renderColumn(columnId) {
        ...
        const contextVar = contextVarExpr.contextVarId
            ? this.props.contextVars.find((cv) => cv.id == contextVarExpr.contextVarId)
            : null;
    ...
    render() {
        ...
        const columns = this.props.schema
            .getColumns(this.props.table)
            .filter((column) => !column.expr && (column.type != "join" || column.join.type == "1-1" || column.join.type == "n-1"));
        ...
        return (react_1.default.createElement("div", null,
            react_1.default.createElement("table", { className: "table table-bordered table-sm" },
                react_1.default.createElement("tbody", null, Object.keys(this.props.value)
                    .sort()
                    .map((columnId) => this.renderColumn(columnId)))),
