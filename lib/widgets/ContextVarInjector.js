...
class ContextVarInjector extends React.Component {
    ...
    performQueries() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const variableValues = contexts_1.getFilteredContextVarValues(innerProps);
            ...
            if (this.props.injectedContextVar.type === "rowset") {
                ...
                try {
                    ...
                    const aggrRows = yield this.props.instanceCtx.database.query(queryAggrOptions, innerProps.contextVars, contexts_1.getFilteredContextVarValues(innerProps));
                    ...
                    for (const individualExpression of individualExpressions) {
                        ...
                        const individualRows = yield this.props.instanceCtx.database.query(queryIndividualOptions, innerProps.contextVars, contexts_1.getFilteredContextVarValues(innerProps));
