...
export default class ContextVarInjector extends React.Component {
    ...
    createInnerProps() {
        ...
        // Create inner props
        const innerProps = Object.assign({}, outer, { contextVars: outer.contextVars.concat(this.props.injectedContextVar), contextVarValues: Object.assign({}, outer.contextVarValues, { [this.props.injectedContextVar.id]: this.props.value }), getContextVarExprValue: (contextVarId, expr) => {
