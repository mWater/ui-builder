    ...
    async performQueries() {
        ...
        if (this.props.injectedContextVar.type === "rowset") {
            ...
            try {
                ...
                const aggrRows = await this.props.instanceCtx.database.query(queryAggrOptions, innerProps.contextVars, contexts_1.getFilteredContextVarValues(innerProps));
                ...
                for (const individualExpression of individualExpressions) {
                    ...
                    const individualRows = await this.props.instanceCtx.database.query(queryIndividualOptions, innerProps.contextVars, contexts_1.getFilteredContextVarValues(innerProps));
