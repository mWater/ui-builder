...
var ContextVarInjector = /** @class */ (function (_super) {
    ...
    ContextVarInjector.prototype.performQueries = function () {
        return __awaiter(this, void 0, void 0, function () {
            var innerProps, variables, variableValues, table, queryOptions, rows, exprValues, i, table, queryOptions, rows, exprUtils_1, nonAggrExpressions, exprValues, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.props.injectedContextVar.type === "row" && this.props.contextVarExprs.length > 0)) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(this.props.injectedContextVar.type === "rowset" && this.props.contextVarExprs.length > 0)) return [3 /*break*/, 4];
                        this.setState({ refreshing: true });
                        table = this.props.injectedContextVar.table;
    ...
    ContextVarInjector.prototype.createInnerProps = function () {
        ...
        if (this.props.injectedContextVar.type === "rowset" && this.state.filters.length > 0) {
            value = { type: "op", op: "and", table: this.props.injectedContextVar.table, exprs: _.compact([value].concat(this.state.filters.map(function (f) { return f.expr; }))) };
        }
        // Create inner props
        var innerProps = __assign({}, outer, { database: this.props.database, contextVars: outer.contextVars.concat(this.props.injectedContextVar), contextVarValues: __assign({}, outer.contextVarValues, (_a = {}, _a[this.props.injectedContextVar.id] = value, _a)), getContextVarExprValue: function (contextVarId, expr) {
