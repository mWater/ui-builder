...
var ContextVarInjector = /** @class */ (function (_super) {
    ...
    ContextVarInjector.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        if (!lodash_1.default.isEqual(prevProps.value, this.props.value)
            ...
            || !lodash_1.default.isEqual(this.props.instanceCtx.contextVarValues, this.state.contextVarValues)) {
            this.performQueries();
        }
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.props.instanceCtx.database.query(queryOptions, innerProps.contextVars, innerProps.contextVarValues)
                    ...
                    case 2:
                        ...
                        if (!lodash_1.default.isEqual(variableValues, this.createInnerProps().contextVarValues)) {
                            return [2 /*return*/];
                        }
                        // Ignore if unmounted
                        if (this.unmounted) {
                    ...
                    case 6:
                        rows = _a.sent();
                        // Ignore if query options out of date
                        if (!lodash_1.default.isEqual(queryOptions, this.createRowsetQueryOptions(table, variables))) {
                            return [2 /*return*/];
                        }
                        // Ignore if variable values out of date
                        if (!lodash_1.default.isEqual(variableValues, this.createInnerProps().contextVarValues)) {
    ...
    ContextVarInjector.prototype.createInnerProps = function () {
        ...
        // Create inner props
        var innerProps = __assign(__assign({}, outer), { database: this.props.instanceCtx.database, contextVars: outer.contextVars.concat(this.props.injectedContextVar), contextVarValues: __assign(__assign({}, outer.contextVarValues), (_a = {}, _a[this.props.injectedContextVar.id] = value, _a)), getContextVarExprValue: function (contextVarId, expr) {
