    ...
    GotoUrlAction.prototype.renderEditor = function (props) {
        ...
        return (react_1.default.createElement("div", null,
            react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "URL" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.actionDef, onChange: onChange, property: "url" }, function (value, onChange) {
                    return react_1.default.createElement(bootstrap_1.TextInput, { value: value || null, onChange: onChange });
                })),
            react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "URL embedded expressions", help: "Reference in text as {0}, {1}, etc." },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.actionDef, onChange: onChange, property: "urlEmbeddedExprs" }, function (value, onChange) { return (react_1.default.createElement(propertyEditors_1.EmbeddedExprsEditor, { value: value, onChange: onChange, schema: props.schema, dataSource: props.dataSource, contextVars: props.contextVars })); })),
            react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.actionDef, onChange: onChange, property: "newTab" }, function (value, onChange) { return react_1.default.createElement(bootstrap_1.Checkbox, { value: value, onChange: onChange }, "Open in new tab"); })));
    };
    GotoUrlAction.prototype.performAction = function (instanceCtx) {
        return __awaiter(this, void 0, void 0, function () {
            var url, exprValues, _loop_1, _i, _a, ee;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _i = 0, _a = this.actionDef.urlEmbeddedExprs || [];
                        _b.label = 1;
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 4];
                        ee = _a[_i];
                        return [5 /*yield**/, _loop_1(ee)];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3:
