    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, action.performAction({
                        locale: "en",
                        database: database,
                        schema: {},
                        pageStack: {},
                        ...
                        getContextVarExprValue: function (cvid, expr) { return 123; }
                    })];
            case 1:
                _a.sent();
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, action.performAction({
                        ...
                        contextVars: [{ id: "cv1", table: "t2", name: "Cv1", type: "row" }],
                        contextVarValues: { cv1: "123" },
                        getContextVarExprValue: function (cvid, expr) { throw new Error("Not used"); }
                    })];
            case 1:
                _a.sent();
                expect(database.mutations.length).toBe(1);
