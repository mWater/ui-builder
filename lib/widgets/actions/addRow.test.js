...
test("performs non-literal action", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const instanceCtx = Object.assign(Object.assign({}, mockInstanceCtx_1.default()), { database: database, contextVars: [{ id: "cv1", table: "t2", name: "Cv1", type: "row" }], contextVarValues: { cv1: "123" }, getContextVarExprValue: () => { throw new Error("Not implemented"); } });
...
test("performs literal action", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const schema = schema_1.default();
    const database = new VirtualDatabase_1.default(new Database_1.NullDatabase(), schema, "en");
    const instanceCtx = Object.assign(Object.assign({}, mockInstanceCtx_1.default()), { database: database, contextVars: [{ id: "cv1", table: "t2", name: "Cv1", type: "row" }], contextVarValues: { cv1: "123" }, getContextVarExprValue: () => { throw new Error("Not implemented"); }, getFilters: () => [] });
    const action = new addRow_1.AddRowAction(ad);
    yield action.performAction(instanceCtx);
    expect(database.mutations.length).toBe(1);
    expect(database.mutations[0].values).toEqual({
