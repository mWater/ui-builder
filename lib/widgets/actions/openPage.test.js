...
test("performs action", async () => {
    ...
    const instanceCtx = { ...mockInstanceCtx_1.default(),
        database: database,
        schema: schema,
        pageStack: pageStack, contextVars: [{ id: "outercv1", table: "t2", name: "Cv1", type: "rowset" }], contextVarValues: { outercv1: { type: "literal", valueType: "boolean", value: true } },
        getContextVarExprValue: () => { throw new Error("Not implemented"); }, getFilters: (cvid) => {
