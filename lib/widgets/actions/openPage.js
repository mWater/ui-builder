        ...
        var renderContextVarValue = function (contextVar) {
            ...
            return (react_1.default.createElement("tr", { key: contextVar.id },
                ...
                react_1.default.createElement("td", { key: "value" },
                    react_1.default.createElement(bootstrap_1.Select, { options: options, value: cvr && cvr.type == "literal" ? { type: "literal", value: null } : cvr, onChange: handleCVRChange, nullLabel: "Select..." }),
                    !cvr ? react_1.default.createElement("span", { className: "text-warning" }, "Value not set") : null,
                    cvr && cvr.type == "literal" ?
                        react_1.default.createElement(contextVarValues_1.ContextVarValueEditor, { schema: props.schema, dataSource: props.dataSource, contextVar: contextVar, contextVarValue: cvr.value, availContextVars: props.contextVars, onContextVarValueChange: function (value) { handleCVRChange(__assign(__assign({}, cvr), { value: value })); } })
                        : null)));
        };
