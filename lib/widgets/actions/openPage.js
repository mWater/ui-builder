...
export class OpenPageAction extends Action {
    ...
    renderEditor(props) {
        ...
        const actionDef = props.actionDef;
        ...
        return (React.createElement("div", null,
            React.createElement(LabeledProperty, { label: "Page Type" },
                React.createElement(PropertyEditor, { obj: props.actionDef, onChange: props.onChange, property: "pageType" }, (value, onChange) => React.createElement(Select, { value: value, onChange: onChange, options: [{ value: "normal", label: "Normal" }, { value: "modal", label: "Modal" }] }))),
