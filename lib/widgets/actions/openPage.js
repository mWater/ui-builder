...
class OpenPageAction extends actions_1.Action {
    ...
    renderEditor(props) {
        ...
        const widgetOptions = lodash_1.default.sortByAll(Object.values(props.widgetLibrary.widgets), "group", "name").map((w) => ({
        ...
        const renderContextVarValue = (contextVar) => {
            ...
            function renderContextVarValueEditor() {
                ...
                if (cvv.type == "literal") {
                    ...
                    return (react_1.default.createElement(contextVarValues_1.ContextVarValueEditor, { schema: props.schema, dataSource: props.dataSource, contextVar: contextVar, contextVarValue: cvv.value, availContextVars: [], onContextVarValueChange: (value) => {
                            handleCVVChange(Object.assign(Object.assign({}, cvv), { value }));
                        } }));
                }
                if (cvv.type == "ref") {
                    ...
                    return (react_1.default.createElement(bootstrap_1.Select, { options: refOptions, value: cvv.contextVarId, onChange: (value) => {
                            handleCVVChange(Object.assign(Object.assign({}, cvv), { contextVarId: value }));
                        }, nullLabel: "Select Variable..." }));
                }
                if (cvv.type == "contextVarExpr") {
                    return (react_1.default.createElement(propertyEditors_1.ContextVarAndExprPropertyEditor, { contextVarId: cvv.contextVarId, contextVars: props.contextVars, dataSource: props.dataSource, expr: cvv.expr, schema: props.schema, types: [contextVar.type == "row" ? "id" : contextVar.type], idTable: contextVar.type == "row" ? contextVar.table : contextVar.idTable, enumValues: contextVar.enumValues, onChange: (contextVarId, expr) => {
                            handleCVVChange(Object.assign(Object.assign({}, cvv), { expr, contextVarId }));
                        } }));
                }
        ...
        return (react_1.default.createElement("div", null,
            react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Page Type" },
                react_1.default.createElement(propertyEditors_1.PropertyEditor, { obj: this.actionDef, onChange: onChange, property: "pageType" }, (value, onChange) => (react_1.default.createElement(bootstrap_1.Toggle, { value: value, onChange: onChange, options: [
                        { value: "normal", label: "Normal" },
                        { value: "modal", label: "Modal" }
                    ] })))),
            this.actionDef.pageType == "modal" ? (react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Modal Size" },
            ...
            react_1.default.createElement(propertyEditors_1.LabeledProperty, { label: "Page Title", hint: "Deprecated. Prefer Page Header widget" },
