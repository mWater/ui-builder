...
var OpenPageAction = /** @class */ (function (_super) {
    ...
    OpenPageAction.prototype.performAction = function (instanceCtx) {
        return __awaiter(this, void 0, void 0, function () {
            var contextVarValues, widget, _loop_2, this_2, _i, _a, cvid, _b, _c, globalContextVar, title, exprValues, _loop_3, _d, _e, ee, page;
                ...
                switch (_f.label) {
                    case 0:
                        ...
                        _loop_2 = function (cvid) {
                            var contextVarValue, outerCV, outerCVValue, widgetCV, contextVar, value;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        contextVarValue = this_2.actionDef.contextVarValues[cvid];
                                    ...
                                    case 3:
                                        ...
                                        widgetCV = widget.contextVars.find(function (cv) { return cv.id == cvid; });
                                    ...
                                    case 4:
                                        value = _a.sent();
                                        // Wrap in literal expression if not row
                                        contextVarValues[cvid] = widgetCV.type == "row" ? value : { type: "literal", valueType: widgetCV.type, idTable: widgetCV.idTable, value: value };
                                        _a.label = 5;
                        ...
                        this_2 = this;
                        _i = 0, _a = Object.keys(this.actionDef.contextVarValues);
                        _f.label = 1;
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 4];
                        cvid = _a[_i];
                        return [5 /*yield**/, _loop_2(cvid)];
                    case 2:
                        _f.sent();
                        _f.label = 3;
                    case 3:
