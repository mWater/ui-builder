...
var AddRowAction = /** @class */ (function (_super) {
    ...
    AddRowAction.prototype.performAction = function (options) {
    ...
    AddRowAction.prototype.validate = function (options) {
        ...
        for (var _i = 0, _a = Object.keys(this.actionDef.columnValues); _i < _a.length; _i++) {
            var columnId = _a[_i];
            var error = this.validateColumnValue(options, columnId);
            if (error) {
                return error;
            }
        }
    ...
    AddRowAction.prototype.validateColumnValue = function (options, columnId) {
        // Check that column exists
        var column = options.schema.getColumn(this.actionDef.table, columnId);
        if (!column) {
    ...
    AddRowAction.prototype.renderEditor = function (props) {
        ...
        return (React.createElement("div", null,
            React.createElement(propertyEditors_1.LabeledProperty, { label: "Table" },
                React.createElement(propertyEditors_1.PropertyEditor, { obj: this.actionDef, onChange: props.onChange, property: "table" }, function (value, onChange) {
            ...
            this.actionDef.table ?
                React.createElement(propertyEditors_1.LabeledProperty, { label: "Column Values" },
                    React.createElement(propertyEditors_1.PropertyEditor, { obj: this.actionDef, onChange: props.onChange, property: "columnValues" }, function (value, onChange) {
