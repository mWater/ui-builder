...
var ContextVarPropertyEditor = /** @class */ (function (_super) {
    ...
    ContextVarPropertyEditor.prototype.render = function () {
        ...
        return React.createElement(bootstrap_1.Select, { value: this.props.value, onChange: this.props.onChange, nullLabel: this.props.allowNone ? "None" : "Select...", options: contextVars.map(function (cv) { return ({ label: cv.name, value: cv.id }); }) });
    };
...
var ActionDefEditor = /** @class */ (function (_super) {
    ...
    function ActionDefEditor() {
        ...
        _this.handleChangeAction = function (type) {
            if (type) {
                _this.props.onChange(_this.props.actionLibrary.createNewActionDef(type));
            }
            else {
                _this.props.onChange(null);
            }
    ...
    ActionDefEditor.prototype.render = function () {
        var action = this.props.value ? this.props.actionLibrary.createAction(this.props.value) : null;
        return (React.createElement("div", null,
            React.createElement(bootstrap_1.Select, { nullLabel: "No Action", onChange: this.handleChangeAction, value: this.props.value ? this.props.value.type : null, options: this.props.actionLibrary.getActionTypes().map(function (at) { return ({ label: at.name, value: at.type }); }) }),
            action
                ? action.renderEditor({
...
var TableSelect = /** @class */ (function (_super) {
    ...
    TableSelect.prototype.render = function () {
        ...
        var tables = _.sortBy(this.props.schema.getTables(), function (table) { return localization_1.localize(table.name, _this.props.locale); });
...
exports.EnumArrayEditor = function (props) {
    ...
    var value = null;
    if (props.value) {
        value = _.compact((props.value || []).map(function (v) { return props.enumValues.find(function (ev) { return ev.id === v; }); }));
    }
...
exports.EmbeddedExprsEditor = function (props) {
    ...
    return (React.createElement("div", null,
        React.createElement(ListEditor_1.default, { items: value || [], onItemsChange: onChange }, function (item, onItemChange) {
            return React.createElement(EmbeddedExprEditor, { value: item, onChange: onItemChange, schema: schema, dataSource: dataSource, contextVars: contextVars });
        }),
    ...
    EmbeddedExprEditor.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(LabeledProperty, { label: "Row/Rowset Variable" },
                React.createElement(PropertyEditor, { obj: this.props.value, onChange: this.props.onChange, property: "contextVarId" }, function (value, onChange) { return React.createElement(ContextVarPropertyEditor, { value: value, onChange: onChange, contextVars: _this.props.contextVars, types: ["row", "rowset"] }); })),
            ...
            exprType === "number" ?
                React.createElement(LabeledProperty, { label: "Number Format" },
                    React.createElement(PropertyEditor, { obj: this.props.value, onChange: this.props.onChange, property: "format" }, function (value, onChange) { return (React.createElement(NumberFormatEditor, { value: value, onChange: onChange })); }))
                : null,
            exprType === "date" ?
                React.createElement(LabeledProperty, { label: "Date Format" },
                    React.createElement(PropertyEditor, { obj: this.props.value, onChange: this.props.onChange, property: "format" }, function (value, onChange) { return (React.createElement(DateFormatEditor, { value: value, onChange: onChange })); }))
                : null,
            exprType === "datetime" ?
                React.createElement(LabeledProperty, { label: "Date/time Format" },
                    React.createElement(PropertyEditor, { obj: this.props.value, onChange: this.props.onChange, property: "format" }, function (value, onChange) { return (React.createElement(DatetimeFormatEditor, { value: value, onChange: onChange })); }))
                : null));
    };
