...
const ContextVarExprPropertyEditor = (props) => {
    ...
    return React.createElement("div", { style: { border: "solid 1px #DDD", borderRadius: 5, padding: 10 } },
        ...
        React.createElement("div", { style: { paddingTop: 10 } },
            React.createElement(mwater_expressions_ui_1.ExprComponent, { value: props.expr, onChange: expr => { props.onChange(props.contextVarId, expr); }, schema: props.schema, dataSource: props.dataSource, aggrStatuses: props.aggrStatuses, types: props.types, variables: (0, blocks_1.createExprVariables)(availContextVars), table: contextVar ? contextVar.table || undefined : undefined, enumValues: props.enumValues, idTable: props.idTable })));
};
