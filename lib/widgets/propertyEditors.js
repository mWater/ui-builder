...
function ContextVarExprPropertyEditor(props) {
    ...
    return React.createElement("div", { style: { border: "solid 1px #DDD", borderRadius: 5, padding: 10 } },
        React.createElement(ContextVarPropertyEditor, { value: props.contextVarExpr ? props.contextVarExpr.contextVarId : null, onChange: cv => { props.onChange({ contextVarId: cv, expr: null }); }, nullLabel: "No Row/Rowset", contextVars: props.contextVars, types: ["row", "rowset"] }),
        React.createElement("div", { style: { paddingTop: 10 } },
            React.createElement(mwater_expressions_ui_1.ExprComponent, { value: props.contextVarExpr ? props.contextVarExpr.expr : null, onChange: expr => { props.onChange({ contextVarId: contextVar ? contextVar.id : null, expr }); }, schema: props.schema, dataSource: props.dataSource, aggrStatuses: props.aggrStatuses, types: props.types, variables: (0, blocks_1.createExprVariables)(availContextVars), table: contextVar ? contextVar.table || undefined : undefined, enumValues: props.enumValues, idTable: props.idTable })));
}
...
function ContextVarAndExprPropertyEditor(props) {
    return React.createElement(ContextVarExprPropertyEditor, { schema: props.schema, dataSource: props.dataSource, contextVars: props.contextVars, contextVarExpr: { contextVarId: props.contextVarId, expr: props.expr }, onChange: cve => { props.onChange(cve.contextVarId, cve.expr); }, aggrStatuses: props.aggrStatuses, types: props.types, enumValues: props.enumValues, idTable: props.idTable });
}
        ...
        return (React.createElement("div", null,
            ...
            action ?
                React.createElement(collapsible_1.CollapsibleComponent, { label: "Details" },
                    React.createElement("div", { style: { paddingLeft: 10 } }, action.renderEditor(Object.assign(Object.assign({}, this.props.designCtx), { onChange: this.props.onChange }))))
                : null));
    }
}
