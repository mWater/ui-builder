...
/** Labeled group */
exports.LabeledProperty = function (props) {
        ...
        return (React.createElement("div", null,
            ...
            action ?
                React.createElement(collapsible_1.CollapsibleComponent, { label: "Details" },
                    React.createElement("div", { style: { paddingLeft: 10 } }, action.renderEditor(__assign(__assign({}, this.props.designCtx), { onChange: this.props.onChange }))))
                : null));
    };
...
var TableSelect = /** @class */ (function (_super) {
    ...
    TableSelect.prototype.render = function () {
        ...
        return React.createElement(react_select_1.default, { value: tables.find(function (t) { return t.id === _this.props.value; }) || null, options: tables, onChange: this.handleTableChange, getOptionLabel: this.getOptionLabel, getOptionValue: this.getOptionValue, menuPortalTarget: document.body, styles: { menuPortal: function (style) { return (__assign(__assign({}, style), { zIndex: 2000 })); } } });
    };
...
exports.EmbeddedExprsEditor = function (props) {
    ...
    var handleAddEmbeddedExpr = function () {
        var defaultContextVar = props.contextVars.find(function (cv) { return cv.type === "rowset" || cv.type === "row"; });
        onChange((value || []).concat([{ contextVarId: defaultContextVar ? defaultContextVar.id : null, expr: null, format: null }]));
    };
    return (React.createElement("div", null,
        React.createElement(ListEditor_1.default, { items: value || [], onItemsChange: onChange }, function (item, onItemChange, index) {
            return React.createElement(exports.EmbeddedExprEditor, { value: item, onChange: onItemChange, schema: schema, dataSource: dataSource, contextVars: contextVars, index: index });
        }),
...
exports.TableColumnWidthEditor = function (props) {
