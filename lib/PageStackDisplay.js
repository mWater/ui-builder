    ...
    function PageStackDisplay(props) {
        ...
        _this.renderChildBlock = function (page, pageIndex, props, childBlockDef, instanceId) {
            ...
            if (childBlockDef) {
                ...
                var refedElem = React.cloneElement(elem, __assign({}, elem.props, { ref: _this.refHandler.bind(null, key) }));
                return refedElem;
            }
            else {
                return null;
...
var ModalPage = /** @class */ (function (_super) {
    ...
    ModalPage.prototype.render = function () {
        return (React.createElement(ModalPopupComponent_1.default, { onClose: this.props.onClose }, this.props.children));
    };
    return ModalPage;
}(React.Component));
