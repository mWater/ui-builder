...
class PageStackDisplay extends react_1.default.Component {
    ...
    renderPageContents(page, pageIndex) {
        ...
        const injectedContextVarValues = {
            ...
            ...(lodash_1.default.pick(widgetDef.privateContextVarValues || {}, (widgetDef.privateContextVars || []).map(cv => cv.id)))
        };
        // Wrap in context var injector
        return react_1.default.createElement(ContextVarsInjector_1.default, { injectedContextVars: injectedContextVars, innerBlock: widgetDef.blockDef, injectedContextVarValues: injectedContextVarValues, instanceCtx: { ...outerInstanceCtx, database: page.database } }, (innerInstanceCtx, loading, refreshing) => {
            if (loading) {
