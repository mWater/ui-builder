...
class ModalPage extends react_1.default.Component {
    render() {
        ...
        return (react_1.default.createElement(ModalPopupComponent_1.default, { onClose: this.props.onClose, size: size, header: this.props.title, showCloseX: !!this.props.title }, this.props.children));
    }
}
