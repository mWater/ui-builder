...
var PageStackDisplay = /** @class */ (function (_super) {
    ...
    PageStackDisplay.prototype.renderPageContents = function (page, pageIndex) {
        ...
        return react_1.default.createElement(ContextVarsInjector_1.default, { injectedContextVars: injectedContextVars, innerBlock: widgetDef.blockDef, injectedContextVarValues: injectedContextVarValues, instanceCtx: __assign(__assign({}, outerInstanceCtx), { database: page.database }) }, function (innerInstanceCtx, loading, refreshing) {
            ...
            return (react_1.default.createElement("div", { style: { opacity: refreshing ? 0.6 : undefined } }, _this.renderChildBlock(innerInstanceCtx, widgetDef.blockDef)));
        });
    };
        ...
        switch (page.type) {
            case "normal":
                return (react_1.default.createElement("div", { style: { display: invisible ? "none" : "block" }, key: index },
                    react_1.default.createElement(NormalPage, { isFirst: index === 0, onClose: this.handleClose, key: index, title: page.title }, contents)));
            case "modal":
                return (react_1.default.createElement("div", { style: { display: invisible ? "none" : "block" }, key: index },
    ...
    NormalPage.prototype.render = function () {
        return (react_1.default.createElement("div", { className: "normal-page" },
            !this.props.isFirst || this.props.title ?
                react_1.default.createElement("div", { className: "normal-page-header", key: "header" },
                    react_1.default.createElement("h4", null,
                        !this.props.isFirst ?
                            react_1.default.createElement("i", { className: "normal-page-header-back fa fa-arrow-left fa-fw", onClick: this.props.onClose })
                            : null,
                        this.props.title))
                : null,
...
var ModalPage = /** @class */ (function (_super) {
    ...
    ModalPage.prototype.render = function () {
        return (react_1.default.createElement(ModalPopupComponent_1.default, { onClose: this.props.onClose, size: this.props.size, header: this.props.title }, this.props.children));
    };
    return ModalPage;
}(react_1.default.Component));
