...
const formatEmbeddedExprString = (options) => {
    ...
    for (let i = 0; i < options.exprValues.length; i++) {
        ...
        if (value == null) {
            ...
            if (exprType === "number" && value != null) {
                ...
                str = (0, moment_1.default)(value, moment_1.default.ISO_8601).format(format || "ll");
            }
            else if (exprType === "datetime" && value != null) {
                str = (0, moment_1.default)(value, moment_1.default.ISO_8601).format(format || "lll");
            }
            else {
                str = new mwater_expressions_1.ExprUtils(options.schema, (0, blocks_1.createExprVariables)(options.contextVars)).stringifyExprLiteral(expr, value, options.locale);
            }
        }
...
const validateEmbeddedExprs = (options) => {
