...
var widgetLibrary_1 = __importDefault(require("./designer/widgetLibrary"));
...
var dataSource = new MWaterDataSource_1.default("https://api.mwater.co/v3/", null, { localCaching: false, serverCaching: false });
...
var Demo = /** @class */ (function (_super) {
    ...
    Demo.prototype.componentDidMount = function () {
        var _this = this;
        fetch("https://api.mwater.co/v3/schema").then(function (req) { return req.json(); }).then(function (json) {
