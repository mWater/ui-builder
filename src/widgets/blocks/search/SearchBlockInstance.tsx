...
export default class SearchBlockInstance extends React.Component<Props, State> {
  ...
  createFilter(searchText: string) {
    ...
    // Get table
    const table = this.props.renderInstanceProps.contextVars.find(cv => cv.id === blockDef.rowset)!.table!
  ...
  handleChange = (ev: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Set filter 
    this.props.renderInstanceProps.setFilter(blockDef.rowset!, this.createFilter(searchText))
  }
