...
import { BlockDef, ContextVar, ChildBlock, createExprVariables, Block } from "../blocks"
import * as _ from "lodash"
import { ExprValidator, Expr, ExprUtils, LiteralType } from "mwater-expressions"
...
class AddRowInstance extends React.Component<Props, State> {
  ...
  async performAdd() {
    ...
    try {
      ...
      await txn.addRow(this.props.blockDef.table!, row)
      const addedRowId = (await txn.commit())[0]
