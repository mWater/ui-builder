...
import { DragDropContext, Draggable, DraggableProvidedDraggableProps, DraggableProvidedDragHandleProps, Droppable, DropResult } from "react-beautiful-dnd";
...
export function ReorderableList<T>(props: {
  ...
  renderItem: (
    ...
    dragHandleProps?: DraggableProvidedDragHandleProps) => ReactElement
