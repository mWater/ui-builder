...
// WidgetComp (widget component) is named and has a single widget with a set of context variables
export interface WidgetCompDef {
  id: string     // Unique id (globally)
  name: string   // Name of the widget component
  description: string   // Description of the widget component
  widgetDef: WidgetDef  // Widget that it displays
  contextVars: ContextVar[] // Context variables that will be passed to inner widget
}
...
export interface WidgetInstance extends React.Component {
...
export abstract class Widget {
  ...
  // Render a live instance of the widget. ref will be called with the widget instance
  abstract renderInstance(props: RenderInstanceProps, ref: (widgetInstance: WidgetInstance | null) => void): React.ReactElement<any>
  ...
  // Get initial filters generated by this widget
